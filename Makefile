...
security:
	...
	uv run safety check --ignore 90553,89824,SFTY-20260318-30374,89826,SFTY-20260416-63613,93697,93686,94066,SFTY-20260415-68235 || (echo "❌ Safety security check failed" && exit 1)
