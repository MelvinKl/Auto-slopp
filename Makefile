...
security:
	...
	uv run safety check --ignore 90553,89824,SFTY-20260318-30374,89826,SFTY-20260322-35073,90749,92337,SFTY-20260416-63613 || (echo "❌ Safety security check failed" && exit 1)
