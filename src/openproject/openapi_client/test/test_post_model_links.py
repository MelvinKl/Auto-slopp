...
class TestPostModelLinks(unittest.TestCase):
    """PostModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostModelLinks:
        """Test PostModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostModelLinks`
        """
        model = PostModelLinks()
        if include_optional:
