...
class TestRootModelLinks(unittest.TestCase):
    """RootModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RootModelLinks:
        """Test RootModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RootModelLinks`
        """
        model = RootModelLinks()
        if include_optional:
            return RootModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                configuration = {href=/api/v3/work_packages, method=POST},
                memberships = {href=/api/v3/work_packages, method=POST},
                priorities = {href=/api/v3/work_packages, method=POST},
                relations = {href=/api/v3/work_packages, method=POST},
                statuses = {href=/api/v3/work_packages, method=POST},
                ...
                user_preferences = {href=/api/v3/work_packages, method=POST},
