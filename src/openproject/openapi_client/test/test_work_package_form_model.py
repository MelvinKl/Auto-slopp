    ...
    def make_instance(self, include_optional) -> WorkPackageFormModel:
        ...
        if include_optional:
            return WorkPackageFormModel(
                type = 'Form',
                embedded = openproject_client.models.work_package_form_model__embedded.WorkPackageFormModel__embedded(
                    ...
                    schema = openproject_client.models.work_package_schema_model.WorkPackageSchemaModel(
                        _type = 'Schema', 
                        _dependencies = [
                            ''
                            ], 
                ...
                links = openproject_client.models.work_package_form_model__links.WorkPackageFormModel__links(
                    self = null, 
                    validate = null, 
                    preview_markup = null, 
                    custom_fields = null, 
