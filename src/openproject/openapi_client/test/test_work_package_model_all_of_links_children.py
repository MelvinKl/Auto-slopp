...
class TestWorkPackageModelAllOfLinksChildren(unittest.TestCase):
    """WorkPackageModelAllOfLinksChildren unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageModelAllOfLinksChildren:
        """Test WorkPackageModelAllOfLinksChildren
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageModelAllOfLinksChildren`
        """
        model = WorkPackageModelAllOfLinksChildren()
        if include_optional:
            return WorkPackageModelAllOfLinksChildren(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testWorkPackageModelAllOfLinksChildren(self):
        """Test WorkPackageModelAllOfLinksChildren"""
