...
class TestShowOrValidateFormRequest(unittest.TestCase):
    """ShowOrValidateFormRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowOrValidateFormRequest:
        """Test ShowOrValidateFormRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowOrValidateFormRequest`
        """
        model = ShowOrValidateFormRequest()
        if include_optional:
    ...
    def testShowOrValidateFormRequest(self):
        """Test ShowOrValidateFormRequest"""
