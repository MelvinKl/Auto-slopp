    ...
    def make_instance(self, include_optional) -> DayCollectionModel:
        ...
        if include_optional:
            return DayCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.day_collection_model_all_of__links.DayCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.day_collection_model_all_of__embedded.DayCollectionModel_allOf__embedded(
                    elements = [
