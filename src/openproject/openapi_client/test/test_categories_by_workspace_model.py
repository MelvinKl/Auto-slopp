    ...
    def make_instance(self, include_optional) -> CategoriesByWorkspaceModel:
        ...
        if include_optional:
            return CategoriesByWorkspaceModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.categories_by_workspace_model_all_of__links.Categories_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.categories_by_workspace_model_all_of__embedded.Categories_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
