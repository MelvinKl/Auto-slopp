...
class TestProjectStorageModelLinks(unittest.TestCase):
    """ProjectStorageModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectStorageModelLinks:
        """Test ProjectStorageModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectStorageModelLinks`
        """
        model = ProjectStorageModelLinks()
        if include_optional:
            return ProjectStorageModelLinks(
                ...
                project_folder = {href=/api/v3/work_packages, method=POST},
                open = {href=/api/v3/work_packages, method=POST},
                open_with_connection_ensured = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return ProjectStorageModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testProjectStorageModelLinks(self):
        """Test ProjectStorageModelLinks"""
