...
class TestWorkspacesSchemaModelAttributeGroupsInner(unittest.TestCase):
    """WorkspacesSchemaModelAttributeGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspacesSchemaModelAttributeGroupsInner:
        """Test WorkspacesSchemaModelAttributeGroupsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspacesSchemaModelAttributeGroupsInner`
        """
        model = WorkspacesSchemaModelAttributeGroupsInner()
        if include_optional:
            return WorkspacesSchemaModelAttributeGroupsInner(
                type = 'ProjectFormCustomFieldSection',
                id = 56,
                name = '',
                attributes = [
                    ''
    ...
    def testWorkspacesSchemaModelAttributeGroupsInner(self):
        """Test WorkspacesSchemaModelAttributeGroupsInner"""
