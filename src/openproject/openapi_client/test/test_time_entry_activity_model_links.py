...
class TestTimeEntryActivityModelLinks(unittest.TestCase):
    """TimeEntryActivityModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryActivityModelLinks:
        """Test TimeEntryActivityModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryActivityModelLinks`
        """
        model = TimeEntryActivityModelLinks()
        if include_optional:
    ...
    def testTimeEntryActivityModelLinks(self):
        """Test TimeEntryActivityModelLinks"""
