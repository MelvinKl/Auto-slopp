...
class TestWorkspaceCollectionModelAllOfLinks(unittest.TestCase):
    """WorkspaceCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCollectionModelAllOfLinks:
        """Test WorkspaceCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCollectionModelAllOfLinks`
        """
        model = WorkspaceCollectionModelAllOfLinks()
        if include_optional:
            return WorkspaceCollectionModelAllOfLinks(
    ...
    def testWorkspaceCollectionModelAllOfLinks(self):
        """Test WorkspaceCollectionModelAllOfLinks"""
