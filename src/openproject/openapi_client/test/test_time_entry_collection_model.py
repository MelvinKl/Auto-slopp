    ...
    def make_instance(self, include_optional) -> TimeEntryCollectionModel:
        ...
        if include_optional:
            return TimeEntryCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.time_entry_collection_model_all_of__links.TimeEntryCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.time_entry_collection_model_all_of__embedded.TimeEntryCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
