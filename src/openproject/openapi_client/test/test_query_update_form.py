...
class TestQueryUpdateForm(unittest.TestCase):
    """QueryUpdateForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryUpdateForm:
        """Test QueryUpdateForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryUpdateForm`
        """
        model = QueryUpdateForm()
        if include_optional:
