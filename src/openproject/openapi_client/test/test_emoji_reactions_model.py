...
class TestEmojiReactionsModel(unittest.TestCase):
    """EmojiReactionsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiReactionsModel:
        """Test EmojiReactionsModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiReactionsModel`
        """
        model = EmojiReactionsModel()
        if include_optional:
            return EmojiReactionsModel(
                type = 'Collection',
                total = 0,
                count = 0,
                embedded = openproject_client.models.emoji_reactions_model__embedded.EmojiReactions_Model__embedded(
                    elements = [
                        {_type=EmojiReaction, id=1-thumbs_up, reaction=thumbs_up, emoji=👍, reactionsCount=3, firstReactionAt=2024-04-08T15:37:19.275Z, _links={self={href=/api/v3/emoji_reactions/1-thumbs_up}, reactable={href=/api/v3/activities/1}, reactingUsers=[{href=/api/v3/users/435, title=John Doe}, {href=/api/v3/users/436, title=Jane Smith}, {href=/api/v3/users/437, title=Bob Johnson}]}}
                        ], ),
                links = openproject_client.models.emoji_reactions_model__links.EmojiReactions_Model__links(
                    self = null, )
            )
        else:
            return EmojiReactionsModel(
    ...
    def testEmojiReactionsModel(self):
        """Test EmojiReactionsModel"""
