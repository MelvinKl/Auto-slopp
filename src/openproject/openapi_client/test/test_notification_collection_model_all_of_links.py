...
class TestNotificationCollectionModelAllOfLinks(unittest.TestCase):
    """NotificationCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationCollectionModelAllOfLinks:
        """Test NotificationCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationCollectionModelAllOfLinks`
        """
        model = NotificationCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testNotificationCollectionModelAllOfLinks(self):
        """Test NotificationCollectionModelAllOfLinks"""
