...
class TestUserModelAllOfLinks(unittest.TestCase):
    """UserModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserModelAllOfLinks:
        """Test UserModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserModelAllOfLinks`
        """
        model = UserModelAllOfLinks()
        if include_optional:
            return UserModelAllOfLinks(
                show_user = {href=/api/v3/work_packages, method=POST},
                update_immediately = {href=/api/v3/work_packages, method=POST},
                lock = {href=/api/v3/work_packages, method=POST},
                unlock = {href=/api/v3/work_packages, method=POST},
                delete = {href=/api/v3/work_packages, method=POST},
                auth_source = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return UserModelAllOfLinks(
        )
    ...
    def testUserModelAllOfLinks(self):
        """Test UserModelAllOfLinks"""
