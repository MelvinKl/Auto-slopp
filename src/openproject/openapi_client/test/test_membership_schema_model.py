    ...
    def make_instance(self, include_optional) -> MembershipSchemaModel:
        ...
        if include_optional:
            return MembershipSchemaModel(
                ...
                links = openproject_client.models.schema_model__links.SchemaModel__links(
                    self = null, ),
                ...
                updated_at = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                notification_message = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                project = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                principal = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                roles = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
