...
class TestMembershipReadModel(unittest.TestCase):
    """MembershipReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipReadModel:
        """Test MembershipReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipReadModel`
        """
        model = MembershipReadModel()
        if include_optional:
            return MembershipReadModel(
                ...
                embedded = openproject_client.models.membership_read_model__embedded.MembershipReadModel__embedded(
                    project = null, 
                    principal = null, 
                    roles = [
                        {_type=Role, id=3, name=Manager, _links={self={href=/api/v3/roles/3, title=Manager}}}
                        ], ),
                links = openproject_client.models.membership_read_model__links.MembershipReadModel__links(
                    self = null, 
                    schema = null, 
                    update = null, 
    ...
    def testMembershipReadModel(self):
        """Test MembershipReadModel"""
