    ...
    def make_instance(self, include_optional) -> StorageCollectionModel:
        ...
        if include_optional:
            return StorageCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.storage_collection_model_all_of__links.StorageCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.storage_collection_model_all_of__embedded.StorageCollectionModel_allOf__embedded(
                    elements = [
                        openproject_client.models.storage_read_model.StorageReadModel(
                            id = 56, 
                            _type = 'Storage', 
                            name = '', 
                            storage_audience = '', 
