...
class TestProgramModelAllOfLinksStorages(unittest.TestCase):
    """ProgramModelAllOfLinksStorages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramModelAllOfLinksStorages:
        """Test ProgramModelAllOfLinksStorages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramModelAllOfLinksStorages`
        """
        model = ProgramModelAllOfLinksStorages()
        if include_optional:
            return ProgramModelAllOfLinksStorages(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testProgramModelAllOfLinksStorages(self):
        """Test ProgramModelAllOfLinksStorages"""
