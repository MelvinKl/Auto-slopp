    ...
    def make_instance(self, include_optional) -> PriorityCollectionModel:
        ...
        if include_optional:
            return PriorityCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.priority_collection_model_all_of__links.PriorityCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.priority_collection_model_all_of__embedded.PriorityCollectionModel_allOf__embedded(
                    elements = [
