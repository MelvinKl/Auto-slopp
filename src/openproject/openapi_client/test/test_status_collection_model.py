    ...
    def make_instance(self, include_optional) -> StatusCollectionModel:
        ...
        if include_optional:
            return StatusCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.collection_links.CollectionLinks(
                    self = null, ),
                embedded = openproject_client.models.status_collection_model_all_of__embedded.StatusCollectionModel_allOf__embedded(
                    elements = [
