    ...
    def make_instance(self, include_optional) -> UserCollectionModel:
        ...
        if include_optional:
            return UserCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.user_collection_model_all_of__links.UserCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.user_collection_model_all_of__embedded.UserCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
