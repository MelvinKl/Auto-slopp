...
class TestStorageFileUploadLinkModel(unittest.TestCase):
    """StorageFileUploadLinkModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFileUploadLinkModel:
        """Test StorageFileUploadLinkModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFileUploadLinkModel`
        """
        model = StorageFileUploadLinkModel()
        if include_optional:
            return StorageFileUploadLinkModel(
                type = 'UploadLink',
                links = openproject_client.models.storage_file_upload_link_model__links.StorageFileUploadLinkModel__links(
                    self = null, 
                    destination = null, )
            )
        else:
    ...
    def testStorageFileUploadLinkModel(self):
        """Test StorageFileUploadLinkModel"""
