...
class TestPlaceholderUserModelAllOfLinks(unittest.TestCase):
    """PlaceholderUserModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserModelAllOfLinks:
        """Test PlaceholderUserModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserModelAllOfLinks`
        """
        model = PlaceholderUserModelAllOfLinks()
        if include_optional:
    ...
    def testPlaceholderUserModelAllOfLinks(self):
        """Test PlaceholderUserModelAllOfLinks"""
