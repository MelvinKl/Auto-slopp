...
class TestListAvailableParentProjectCandidatesModelAllOfEmbeddedElements(unittest.TestCase):
    """ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements:
        """Test ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements`
        """
        model = ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements()
        if include_optional:
            return ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements(
                ...
                active = True,
                favorited = True,
                status_explanation = {format=markdown, raw=I am formatted!, html=I am formatted!},
                public = True,
                description = {format=markdown, raw=I am formatted!, html=I am formatted!},
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = openproject_client.models.portfolio_model_all_of__links.PortfolioModel_allOf__links(
                    update = null, 
                    update_immediately = null, 
                    delete = null, 
                    favor = null, 
                    disfavor = null, 
                    create_work_package = null, 
                    create_work_package_immediately = null, 
                    self = null, 
                    categories = null, 
                    types = null, 
                    versions = null, 
    ...
    def testListAvailableParentProjectCandidatesModelAllOfEmbeddedElements(self):
        """Test ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements"""
