...
class TestVersionWriteModel(unittest.TestCase):
    """VersionWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionWriteModel:
        """Test VersionWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionWriteModel`
        """
        model = VersionWriteModel()
        if include_optional:
            return VersionWriteModel(
                name = '',
    ...
    def testVersionWriteModel(self):
        """Test VersionWriteModel"""
