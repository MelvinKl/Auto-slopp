...
class TestDayCollectionModelAllOfEmbedded(unittest.TestCase):
    """DayCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayCollectionModelAllOfEmbedded:
        """Test DayCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayCollectionModelAllOfEmbedded`
        """
        model = DayCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testDayCollectionModelAllOfEmbedded(self):
        """Test DayCollectionModelAllOfEmbedded"""
