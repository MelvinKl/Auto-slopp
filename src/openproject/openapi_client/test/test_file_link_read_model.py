    ...
    def make_instance(self, include_optional) -> FileLinkReadModel:
        ...
        if include_optional:
            return FileLinkReadModel(
                ...
                origin_data = openproject_client.models.file_link_origin_data_model.FileLinkOriginDataModel(
                    id = '', 
                    name = '', 
                    mime_type = '', 
                    size = 0, 
                ...
                embedded = openproject_client.models.file_link_read_model__embedded.FileLinkReadModel__embedded(
                    storage = openproject_client.models.storage_read_model.StorageReadModel(
                        id = 56, 
                        _type = 'Storage', 
                        name = '', 
                        storage_audience = '', 
                        ...
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        configured = True, 
                        _embedded = openproject_client.models.storage_read_model__embedded.StorageReadModel__embedded(
                        ...
                        _links = openproject_client.models.storage_read_model__links.StorageReadModel__links(
                            self = null, 
                            type = null, 
                            ...
                            authorize = null, ), ), ),
                links = openproject_client.models.file_link_read_model__links.FileLinkReadModel__links(
                    self = null, 
                    storage = null, 
                    container = null, 
                    creator = null, 
