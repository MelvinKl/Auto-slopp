...
class TestWeekDayModel(unittest.TestCase):
    """WeekDayModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayModel:
        """Test WeekDayModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayModel`
        """
        model = WeekDayModel()
        if include_optional:
            return WeekDayModel(
