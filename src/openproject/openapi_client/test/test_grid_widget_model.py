...
class TestGridWidgetModel(unittest.TestCase):
    """GridWidgetModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridWidgetModel:
        """Test GridWidgetModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridWidgetModel`
        """
