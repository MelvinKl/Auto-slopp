...
class TestOffsetPaginatedCollectionModel(unittest.TestCase):
    """OffsetPaginatedCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OffsetPaginatedCollectionModel:
        """Test OffsetPaginatedCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OffsetPaginatedCollectionModel`
        """
        model = OffsetPaginatedCollectionModel()
        if include_optional:
            return OffsetPaginatedCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = None,
    ...
    def testOffsetPaginatedCollectionModel(self):
        """Test OffsetPaginatedCollectionModel"""
