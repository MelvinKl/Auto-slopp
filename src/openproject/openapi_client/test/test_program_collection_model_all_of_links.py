...
class TestProgramCollectionModelAllOfLinks(unittest.TestCase):
    """ProgramCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramCollectionModelAllOfLinks:
        """Test ProgramCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramCollectionModelAllOfLinks`
        """
        model = ProgramCollectionModelAllOfLinks()
        if include_optional:
            return ProgramCollectionModelAllOfLinks(
    ...
    def testProgramCollectionModelAllOfLinks(self):
        """Test ProgramCollectionModelAllOfLinks"""
