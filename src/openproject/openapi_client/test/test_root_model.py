...
class TestRootModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RootModel:
        """Test RootModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RootModel`
        """
        model = RootModel()
        if include_optional:
            return RootModel(
                ...
                instance_name = '',
                core_version = '',
                links = openproject_client.models.root_model__links.RootModel__links(
                    self = null, 
                    configuration = null, 
                    memberships = null, 
                    priorities = null, 
