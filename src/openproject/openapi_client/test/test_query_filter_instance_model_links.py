...
class TestQueryFilterInstanceModelLinks(unittest.TestCase):
    """QueryFilterInstanceModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFilterInstanceModelLinks:
        """Test QueryFilterInstanceModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFilterInstanceModelLinks`
        """
        model = QueryFilterInstanceModelLinks()
        if include_optional:
            return QueryFilterInstanceModelLinks(
    ...
    def testQueryFilterInstanceModelLinks(self):
        """Test QueryFilterInstanceModelLinks"""
