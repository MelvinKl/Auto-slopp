...
class TestGroupModelAllOfLinksMembers(unittest.TestCase):
    """GroupModelAllOfLinksMembers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupModelAllOfLinksMembers:
        """Test GroupModelAllOfLinksMembers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupModelAllOfLinksMembers`
        """
        model = GroupModelAllOfLinksMembers()
        if include_optional:
    ...
    def testGroupModelAllOfLinksMembers(self):
        """Test GroupModelAllOfLinksMembers"""
