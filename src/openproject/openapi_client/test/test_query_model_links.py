...
class TestQueryModelLinks(unittest.TestCase):
    """QueryModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryModelLinks:
        """Test QueryModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryModelLinks`
        """
        model = QueryModelLinks()
        if include_optional:
            return QueryModelLinks(
                star = {href=/api/v3/work_packages, method=POST},
                unstar = {href=/api/v3/work_packages, method=POST},
