    ...
    def make_instance(self, include_optional) -> FileLinkCollectionReadModel:
        ...
        if include_optional:
            return FileLinkCollectionReadModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.file_link_collection_read_model_all_of__links.FileLinkCollectionReadModel_allOf__links(
                    self = null, ),
                page_size = 0,
                offset = 1,
                embedded = openproject_client.models.file_link_collection_read_model_all_of__embedded.FileLinkCollectionReadModel_allOf__embedded(
                    elements = [
