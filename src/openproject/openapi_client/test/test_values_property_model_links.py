...
class TestValuesPropertyModelLinks(unittest.TestCase):
    """ValuesPropertyModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuesPropertyModelLinks:
        """Test ValuesPropertyModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuesPropertyModelLinks`
        """
        model = ValuesPropertyModelLinks()
        if include_optional:
    ...
    def testValuesPropertyModelLinks(self):
        """Test ValuesPropertyModelLinks"""
