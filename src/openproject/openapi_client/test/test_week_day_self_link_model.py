...
class TestWeekDaySelfLinkModel(unittest.TestCase):
    """WeekDaySelfLinkModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDaySelfLinkModel:
        """Test WeekDaySelfLinkModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDaySelfLinkModel`
        """
        model = WeekDaySelfLinkModel()
        if include_optional:
    ...
    def testWeekDaySelfLinkModel(self):
        """Test WeekDaySelfLinkModel"""
