    ...
    def make_instance(self, include_optional) -> PlaceholderUserCollectionModel:
        ...
        if include_optional:
            return PlaceholderUserCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.placeholder_user_collection_model_all_of__links.PlaceholderUserCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.placeholder_user_collection_model_all_of__embedded.PlaceholderUserCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
