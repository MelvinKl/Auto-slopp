...
class TestMembershipFormModelLinks(unittest.TestCase):
    """MembershipFormModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipFormModelLinks:
        """Test MembershipFormModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipFormModelLinks`
        """
        model = MembershipFormModelLinks()
        if include_optional:
            return MembershipFormModelLinks(
                ...
                commit = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return MembershipFormModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testMembershipFormModelLinks(self):
        """Test MembershipFormModelLinks"""
