...
class TestHelpTextModel(unittest.TestCase):
    """HelpTextModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelpTextModel:
        """Test HelpTextModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelpTextModel`
        """
        model = HelpTextModel()
        if include_optional:
            return HelpTextModel(
                ...
                attribute = '',
                scope = 'WorkPackage',
                help_text = {format=markdown, raw=I am formatted!, html=I am formatted!},
                links = openproject_client.models.help_text_model__links.HelpTextModel__links(
                    self = null, 
                    edit_text = null, 
                    attachments = null, 
                    add_attachment = null, )
