...
class TestQueryColumnModel(unittest.TestCase):
    """QueryColumnModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryColumnModel:
        """Test QueryColumnModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryColumnModel`
        """
        model = QueryColumnModel()
        if include_optional:
