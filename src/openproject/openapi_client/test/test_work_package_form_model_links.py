...
class TestWorkPackageFormModelLinks(unittest.TestCase):
    """WorkPackageFormModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageFormModelLinks:
        """Test WorkPackageFormModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageFormModelLinks`
        """
        model = WorkPackageFormModelLinks()
        if include_optional:
            return WorkPackageFormModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                validate = {href=/api/v3/work_packages, method=POST},
                preview_markup = {href=/api/v3/work_packages, method=POST},
                custom_fields = {href=/api/v3/work_packages, method=POST},
                configure_form = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return WorkPackageFormModelLinks(
        )
    ...
    def testWorkPackageFormModelLinks(self):
        """Test WorkPackageFormModelLinks"""
