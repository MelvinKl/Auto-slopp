    ...
    def make_instance(self, include_optional) -> WorkPackageFormModelEmbedded:
        ...
        if include_optional:
            return WorkPackageFormModelEmbedded(
                payload = openproject_client.models.work_package_write_model.WorkPackageWriteModel(
                    subject = '', 
                    description = null, 
                    ...
                    _links = openproject_client.models.work_package_write_model__links.WorkPackageWriteModel__links(
                        category = null, 
                        type = null, 
                        priority = null, 
                        project = null, 
                        ...
                        version = null, 
                        parent = null, ), 
                    _meta = openproject_client.models.work_package_write_model__meta.WorkPackageWriteModel__meta(
                        validate_custom_fields = True, ), ),
                var_schema = openproject_client.models.work_package_schema_model.WorkPackageSchemaModel(
                    _type = 'Schema', 
                    _dependencies = [
                        ''
                        ], 
                    ...
                    version = , 
                    priority = , 
                    _links = openproject_client.models.work_package_schema_model__links.WorkPackageSchemaModel__links(
                        self = null, ), ),
                validation_errors = openproject_client.models.validation_errors.validationErrors()
            )
        else:
            return WorkPackageFormModelEmbedded(
        )
