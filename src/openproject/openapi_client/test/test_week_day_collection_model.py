    ...
    def make_instance(self, include_optional) -> WeekDayCollectionModel:
        ...
        if include_optional:
            return WeekDayCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.week_day_collection_model_all_of__links.WeekDayCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.week_day_collection_model_all_of__embedded.WeekDayCollectionModel_allOf__embedded(
                    elements = [
