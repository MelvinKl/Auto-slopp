...
class TestMembershipWriteModel(unittest.TestCase):
    """MembershipWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipWriteModel:
        """Test MembershipWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipWriteModel`
        """
        model = MembershipWriteModel()
        if include_optional:
            return MembershipWriteModel(
                links = openproject_client.models.membership_write_model__links.MembershipWriteModel__links(
                    principal = null, 
                    roles = [
                        null
                        ], 
                    project = null, ),
                meta = openproject_client.models.membership_write_model__meta.MembershipWriteModel__meta(
    ...
    def testMembershipWriteModel(self):
        """Test MembershipWriteModel"""
