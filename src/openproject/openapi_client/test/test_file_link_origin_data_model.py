...
class TestFileLinkOriginDataModel(unittest.TestCase):
    """FileLinkOriginDataModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkOriginDataModel:
        """Test FileLinkOriginDataModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkOriginDataModel`
        """
        model = FileLinkOriginDataModel()
        if include_optional:
    ...
    def testFileLinkOriginDataModel(self):
        """Test FileLinkOriginDataModel"""
