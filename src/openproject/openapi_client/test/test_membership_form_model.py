    ...
    def make_instance(self, include_optional) -> MembershipFormModel:
        ...
        if include_optional:
            return MembershipFormModel(
                type = 'Form',
                embedded = openproject_client.models.membership_form_model__embedded.MembershipFormModel__embedded(
                    payload = openproject_client.models.membership_write_model.MembershipWriteModel(
                        _links = openproject_client.models.membership_write_model__links.MembershipWriteModel__links(
                            principal = null, 
                            roles = [
                                null
                                ], 
                            project = null, ), 
                        _meta = openproject_client.models.membership_write_model__meta.MembershipWriteModel__meta(
                            notification_message = null, 
                            send_notification = True, ), ), 
                    schema = null, 
                    validation_error = openproject_client.models.membership_form_model__embedded_validation_error.MembershipFormModel__embedded_validationError(
                        base = openproject_client.models.error_response.ErrorResponse(
                            _embedded = openproject_client.models.error_response__embedded.ErrorResponse__embedded(
                                details = openproject_client.models.error_response__embedded_details.ErrorResponse__embedded_details(
                                    attribute = 'project', ), ), 
                            _type = 'Error', 
                            error_identifier = 'urn:openproject-org:api:v3:errors:PropertyConstraintViolation', 
                            message = 'Project can't be blank.', ), 
                        principal = openproject_client.models.error_response.ErrorResponse(
                            _type = 'Error', 
                            error_identifier = 'urn:openproject-org:api:v3:errors:PropertyConstraintViolation', 
                            message = 'Project can't be blank.', ), ), ),
                links = openproject_client.models.membership_form_model__links.MembershipFormModel__links(
                    self = null, 
                    validate = [
                        null
                        ], 
