...
class TestStorageReadModel(unittest.TestCase):
    """StorageReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageReadModel:
        """Test StorageReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageReadModel`
        """
        model = StorageReadModel()
        if include_optional:
            return StorageReadModel(
                ...
                configured = True,
                embedded = openproject_client.models.storage_read_model__embedded.StorageReadModel__embedded(
                ...
                links = openproject_client.models.storage_read_model__links.StorageReadModel__links(
                    self = null, 
                    type = null, 
