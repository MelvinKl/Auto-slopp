...
class TestNewsModelLinks(unittest.TestCase):
    """NewsModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewsModelLinks:
        """Test NewsModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewsModelLinks`
        """
        model = NewsModelLinks()
        if include_optional:
