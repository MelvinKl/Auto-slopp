...
class TestProjectModelAllOfLinksStorages(unittest.TestCase):
    """ProjectModelAllOfLinksStorages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectModelAllOfLinksStorages:
        """Test ProjectModelAllOfLinksStorages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectModelAllOfLinksStorages`
        """
        model = ProjectModelAllOfLinksStorages()
        if include_optional:
            return ProjectModelAllOfLinksStorages(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testProjectModelAllOfLinksStorages(self):
        """Test ProjectModelAllOfLinksStorages"""
