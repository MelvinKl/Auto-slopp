    ...
    def make_instance(self, include_optional) -> ActivityModel:
        ...
        if include_optional:
            return ActivityModel(
                ...
                embedded = openproject_client.models.activity_model__embedded.ActivityModel__embedded(
                    attachments = null, 
                    work_package = null, 
                    emoji_reactions = null, ),
                links = openproject_client.models.activity_model__links.ActivityModel__links(
                    self = null, 
                    work_package = null, 
                    user = null, 
                    update = null, 
