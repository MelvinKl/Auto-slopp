...
class TestWeekDayCollectionWriteModelEmbeddedElementsInner(unittest.TestCase):
    """WeekDayCollectionWriteModelEmbeddedElementsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionWriteModelEmbeddedElementsInner:
        """Test WeekDayCollectionWriteModelEmbeddedElementsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionWriteModelEmbeddedElementsInner`
        """
        model = WeekDayCollectionWriteModelEmbeddedElementsInner()
        if include_optional:
            return WeekDayCollectionWriteModelEmbeddedElementsInner(
                type = 'WeekDay',
                working = True,
                links = {self={href=/api/v3/days/week/3, title=Wednesday}}
            )
        else:
            return WeekDayCollectionWriteModelEmbeddedElementsInner(
                type = 'WeekDay',
    ...
    def testWeekDayCollectionWriteModelEmbeddedElementsInner(self):
        """Test WeekDayCollectionWriteModelEmbeddedElementsInner"""
