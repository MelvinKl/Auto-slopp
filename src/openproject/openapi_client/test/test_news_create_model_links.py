...
class TestNewsCreateModelLinks(unittest.TestCase):
    """NewsCreateModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewsCreateModelLinks:
        """Test NewsCreateModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewsCreateModelLinks`
        """
        model = NewsCreateModelLinks()
        if include_optional:
            return NewsCreateModelLinks(
    ...
    def testNewsCreateModelLinks(self):
        """Test NewsCreateModelLinks"""
