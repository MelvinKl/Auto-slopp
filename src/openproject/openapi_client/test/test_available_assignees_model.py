    ...
    def make_instance(self, include_optional) -> AvailableAssigneesModel:
        ...
        if include_optional:
            return AvailableAssigneesModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.available_assignees_model_all_of__links.Available_AssigneesModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.available_assignees_model_all_of__embedded.Available_AssigneesModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
