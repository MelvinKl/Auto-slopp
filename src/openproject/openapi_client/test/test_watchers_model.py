    ...
    def make_instance(self, include_optional) -> WatchersModel:
        ...
        if include_optional:
            return WatchersModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.watchers_model_all_of__links.WatchersModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.watchers_model_all_of__embedded.WatchersModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
