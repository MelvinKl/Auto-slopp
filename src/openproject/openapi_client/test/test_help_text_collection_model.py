    ...
    def make_instance(self, include_optional) -> HelpTextCollectionModel:
        ...
        if include_optional:
            return HelpTextCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.help_text_collection_model_all_of__links.HelpTextCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.help_text_collection_model_all_of__embedded.HelpTextCollectionModel_allOf__embedded(
                    elements = [
