    ...
    def make_instance(self, include_optional) -> AttachmentsModelAllOfEmbeddedElements:
        ...
        if include_optional:
            return AttachmentsModelAllOfEmbeddedElements(
                ...
                status = 'uploaded',
                content_type = '',
                digest = openproject_client.models.attachment_model_digest.AttachmentModel_digest(
                    algorithm = '', 
                    hash = '', ),
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = openproject_client.models.attachment_model__links.AttachmentModel__links(
                    delete = null, 
                    self = null, 
                    container = null, 
                    author = null, 
