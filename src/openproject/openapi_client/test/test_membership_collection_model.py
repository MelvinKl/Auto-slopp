    ...
    def make_instance(self, include_optional) -> MembershipCollectionModel:
        ...
        if include_optional:
            return MembershipCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.paginated_collection_model_all_of__links.PaginatedCollectionModel_allOf__links(
                    jump_to = null, 
                    change_size = null, ),
                page_size = 0,
                offset = 1,
                embedded = openproject_client.models.membership_collection_model_all_of__embedded.MembershipCollectionModel_allOf__embedded(
                    elements = [
                        openproject_client.models.membership_read_model.MembershipReadModel(
                            _type = 'Membership', 
                            id = 1, 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            _embedded = openproject_client.models.membership_read_model__embedded.MembershipReadModel__embedded(
                                project = null, 
                                principal = null, 
                                roles = [
                                    {_type=Role, id=3, name=Manager, _links={self={href=/api/v3/roles/3, title=Manager}}}
                                    ], ), 
                            _links = openproject_client.models.membership_read_model__links.MembershipReadModel__links(
                                self = null, 
                                schema = null, 
                                update = null, 
