    ...
    def make_instance(self, include_optional) -> AttachmentsModel:
        ...
        if include_optional:
            return AttachmentsModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.attachments_model_all_of__links.Attachments_Model_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.attachments_model_all_of__embedded.Attachments_Model_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
