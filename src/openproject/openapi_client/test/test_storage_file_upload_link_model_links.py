...
class TestStorageFileUploadLinkModelLinks(unittest.TestCase):
    """StorageFileUploadLinkModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFileUploadLinkModelLinks:
        """Test StorageFileUploadLinkModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFileUploadLinkModelLinks`
        """
        model = StorageFileUploadLinkModelLinks()
        if include_optional:
            return StorageFileUploadLinkModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                destination = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return StorageFileUploadLinkModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testStorageFileUploadLinkModelLinks(self):
        """Test StorageFileUploadLinkModelLinks"""
