...
class TestRevisionModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RevisionModel:
        """Test RevisionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionModel`
        """
        model = RevisionModel()
        if include_optional:
            return RevisionModel(
                ...
                author_name = '',
                message = {format=markdown, raw=I am formatted!, html=I am formatted!},
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = openproject_client.models.revision_model__links.RevisionModel__links(
                    self = null, 
                    project = null, 
                    author = null, 
                    show_revision = null, )
