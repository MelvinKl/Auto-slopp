...
class TestProgramModelAllOfLinksAncestors(unittest.TestCase):
    """ProgramModelAllOfLinksAncestors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramModelAllOfLinksAncestors:
        """Test ProgramModelAllOfLinksAncestors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramModelAllOfLinksAncestors`
        """
        model = ProgramModelAllOfLinksAncestors()
        if include_optional:
            return ProgramModelAllOfLinksAncestors(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testProgramModelAllOfLinksAncestors(self):
        """Test ProgramModelAllOfLinksAncestors"""
