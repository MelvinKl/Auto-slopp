...
class TestMembershipReadModelEmbeddedProject(unittest.TestCase):
    """MembershipReadModelEmbeddedProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipReadModelEmbeddedProject:
        """Test MembershipReadModelEmbeddedProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipReadModelEmbeddedProject`
        """
        model = MembershipReadModelEmbeddedProject()
        if include_optional:
            return MembershipReadModelEmbeddedProject(
                type = 'Portfolio',
                id = 1,
                identifier = '',
                name = '',
    ...
    def testMembershipReadModelEmbeddedProject(self):
        """Test MembershipReadModelEmbeddedProject"""
