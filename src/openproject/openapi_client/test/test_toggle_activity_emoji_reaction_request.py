...
class TestToggleActivityEmojiReactionRequest(unittest.TestCase):
    """ToggleActivityEmojiReactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToggleActivityEmojiReactionRequest:
        """Test ToggleActivityEmojiReactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToggleActivityEmojiReactionRequest`
        """
        model = ToggleActivityEmojiReactionRequest()
        if include_optional:
            return ToggleActivityEmojiReactionRequest(
                reaction = 'thumbs_up'
            )
        else:
            return ToggleActivityEmojiReactionRequest(
    ...
    def testToggleActivityEmojiReactionRequest(self):
        """Test ToggleActivityEmojiReactionRequest"""
