...
class TestOAuthApplicationReadModel(unittest.TestCase):
    """OAuthApplicationReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthApplicationReadModel:
        """Test OAuthApplicationReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthApplicationReadModel`
        """
        model = OAuthApplicationReadModel()
        if include_optional:
            return OAuthApplicationReadModel(
                ...
                links = openproject_client.models.o_auth_application_read_model__links.OAuthApplicationReadModel__links(
                    self = null, 
                    owner = null, 
                    integration = null, 
                    redirect_uri = [
    ...
    def testOAuthApplicationReadModel(self):
        """Test OAuthApplicationReadModel"""
