...
class TestMeetingModelLinks(unittest.TestCase):
    """MeetingModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingModelLinks:
        """Test MeetingModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingModelLinks`
        """
        model = MeetingModelLinks()
        if include_optional:
    ...
    def testMeetingModelLinks(self):
        """Test MeetingModelLinks"""
