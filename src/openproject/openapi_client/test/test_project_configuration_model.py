...
class TestProjectConfigurationModel(unittest.TestCase):
    """ProjectConfigurationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectConfigurationModel:
        """Test ProjectConfigurationModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectConfigurationModel`
        """
        model = ProjectConfigurationModel()
        if include_optional:
            return ProjectConfigurationModel(
                maximum_attachment_file_size = 56,
                host_name = '',
                per_page_options = [
                    56
                    ],
                ...
                enabled_internal_comments = True
            )
        else:
            return ProjectConfigurationModel(
        )
    ...
    def testProjectConfigurationModel(self):
        """Test ProjectConfigurationModel"""
