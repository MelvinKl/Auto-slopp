...
class TestPortfolioCollectionModel(unittest.TestCase):
    """PortfolioCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioCollectionModel:
        """Test PortfolioCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioCollectionModel`
        """
        model = PortfolioCollectionModel()
        if include_optional:
            return PortfolioCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = None,
                page_size = 0,
                offset = 0,
                embedded = openproject_client.models.portfolio_collection_model_all_of__embedded.PortfolioCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testPortfolioCollectionModel(self):
        """Test PortfolioCollectionModel"""
