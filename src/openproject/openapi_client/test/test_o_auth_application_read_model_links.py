...
class TestOAuthApplicationReadModelLinks(unittest.TestCase):
    """OAuthApplicationReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthApplicationReadModelLinks:
        """Test OAuthApplicationReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthApplicationReadModelLinks`
        """
        model = OAuthApplicationReadModelLinks()
        if include_optional:
            return OAuthApplicationReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                owner = {href=/api/v3/work_packages, method=POST},
    ...
    def testOAuthApplicationReadModelLinks(self):
        """Test OAuthApplicationReadModelLinks"""
