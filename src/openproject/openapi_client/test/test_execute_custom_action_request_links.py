...
class TestExecuteCustomActionRequestLinks(unittest.TestCase):
    """ExecuteCustomActionRequestLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteCustomActionRequestLinks:
        """Test ExecuteCustomActionRequestLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteCustomActionRequestLinks`
        """
        model = ExecuteCustomActionRequestLinks()
        if include_optional:
            return ExecuteCustomActionRequestLinks(
                work_package = openproject_client.models.execute_custom_action_request__links_work_package.Execute_custom_action_request__links_workPackage(
                    href = '', )
            )
        else:
            return ExecuteCustomActionRequestLinks(
    ...
    def testExecuteCustomActionRequestLinks(self):
        """Test ExecuteCustomActionRequestLinks"""
