...
class TestGroupModelAllOfLinks(unittest.TestCase):
    """GroupModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupModelAllOfLinks:
        """Test GroupModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupModelAllOfLinks`
        """
        model = GroupModelAllOfLinks()
        if include_optional:
    ...
    def testGroupModelAllOfLinks(self):
        """Test GroupModelAllOfLinks"""
