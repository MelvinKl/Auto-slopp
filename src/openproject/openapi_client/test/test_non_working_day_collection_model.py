    ...
    def make_instance(self, include_optional) -> NonWorkingDayCollectionModel:
        ...
        if include_optional:
            return NonWorkingDayCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.non_working_day_collection_model_all_of__links.NonWorkingDayCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.non_working_day_collection_model_all_of__embedded.NonWorkingDayCollectionModel_allOf__embedded(
                    elements = [
