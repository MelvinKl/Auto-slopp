...
class TestAvailableAssigneesModelAllOfEmbeddedElements(unittest.TestCase):
    """AvailableAssigneesModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableAssigneesModelAllOfEmbeddedElements:
        """Test AvailableAssigneesModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableAssigneesModelAllOfEmbeddedElements`
        """
        model = AvailableAssigneesModelAllOfEmbeddedElements()
        if include_optional:
            return AvailableAssigneesModelAllOfEmbeddedElements(
                ...
                links = openproject_client.models.user_model_all_of__links.UserModel_allOf__links(
                    show_user = null, 
    ...
    def testAvailableAssigneesModelAllOfEmbeddedElements(self):
        """Test AvailableAssigneesModelAllOfEmbeddedElements"""
