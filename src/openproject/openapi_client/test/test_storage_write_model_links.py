...
class TestStorageWriteModelLinks(unittest.TestCase):
    """StorageWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageWriteModelLinks:
        """Test StorageWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageWriteModelLinks`
        """
        model = StorageWriteModelLinks()
        if include_optional:
    ...
    def testStorageWriteModelLinks(self):
        """Test StorageWriteModelLinks"""
