...
class TestQueryModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryModel:
        """Test QueryModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryModel`
        """
        model = QueryModel()
        if include_optional:
            return QueryModel(
                ...
                name = '',
                filters = [
                    openproject_client.models.query_filter_instance_model.Query_Filter_Instance_Model(
                        _links = openproject_client.models.query_filter_instance_model__links.Query_Filter_Instance_Model__links(
                ...
                links = openproject_client.models.query_model__links.QueryModel__links(
                    star = null, 
                    unstar = null, 
                    update = null, 
