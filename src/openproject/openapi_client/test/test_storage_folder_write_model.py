...
class TestStorageFolderWriteModel(unittest.TestCase):
    """StorageFolderWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFolderWriteModel:
        """Test StorageFolderWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFolderWriteModel`
        """
        model = StorageFolderWriteModel()
        if include_optional:
            return StorageFolderWriteModel(
                name = '',
                parent_id = ''
            )
        else:
    ...
    def testStorageFolderWriteModel(self):
        """Test StorageFolderWriteModel"""
