    ...
    def make_instance(self, include_optional) -> ProjectStorageCollectionModel:
        ...
        if include_optional:
            return ProjectStorageCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.project_storage_collection_model_all_of__links.ProjectStorageCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.project_storage_collection_model_all_of__embedded.ProjectStorageCollectionModel_allOf__embedded(
                    elements = [
