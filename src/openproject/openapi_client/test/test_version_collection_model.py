...
class TestVersionCollectionModel(unittest.TestCase):
    """VersionCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionCollectionModel:
        """Test VersionCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionCollectionModel`
        """
        model = VersionCollectionModel()
        if include_optional:
            return VersionCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = openproject_client.models.version_collection_model_all_of__links.VersionCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.version_collection_model_all_of__embedded.VersionCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testVersionCollectionModel(self):
        """Test VersionCollectionModel"""
