...
class TestPrincipalCollectionModelAllOfEmbeddedElements(unittest.TestCase):
    """PrincipalCollectionModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrincipalCollectionModelAllOfEmbeddedElements:
        """Test PrincipalCollectionModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrincipalCollectionModelAllOfEmbeddedElements`
        """
        model = PrincipalCollectionModelAllOfEmbeddedElements()
        if include_optional:
            return PrincipalCollectionModelAllOfEmbeddedElements(
                ...
                links = openproject_client.models.group_model_all_of__links.GroupModel_allOf__links(
                    self = null, 
                    members = [
                        null
                        ], 
                ...
                language = '',
                identity_url = '',
                embedded = openproject_client.models.group_model_all_of__embedded.GroupModel_allOf__embedded(
                    members = [
                        null
                        ], )
            )
    ...
    def testPrincipalCollectionModelAllOfEmbeddedElements(self):
        """Test PrincipalCollectionModelAllOfEmbeddedElements"""
