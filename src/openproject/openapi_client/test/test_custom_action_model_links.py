...
class TestCustomActionModelLinks(unittest.TestCase):
    """CustomActionModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionModelLinks:
        """Test CustomActionModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionModelLinks`
        """
        model = CustomActionModelLinks()
        if include_optional:
            return CustomActionModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                execute_immediately = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return CustomActionModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testCustomActionModelLinks(self):
        """Test CustomActionModelLinks"""
