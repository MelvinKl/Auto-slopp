...
class TestPortfolioModelAllOfLinksStorages(unittest.TestCase):
    """PortfolioModelAllOfLinksStorages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioModelAllOfLinksStorages:
        """Test PortfolioModelAllOfLinksStorages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioModelAllOfLinksStorages`
        """
        model = PortfolioModelAllOfLinksStorages()
        if include_optional:
            return PortfolioModelAllOfLinksStorages(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testPortfolioModelAllOfLinksStorages(self):
        """Test PortfolioModelAllOfLinksStorages"""
