...
class TestWorkPackageModelAllOfLinks(unittest.TestCase):
    """WorkPackageModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageModelAllOfLinks:
        """Test WorkPackageModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageModelAllOfLinks`
        """
        model = WorkPackageModelAllOfLinks()
        if include_optional:
            return WorkPackageModelAllOfLinks(
                add_comment = {href=/api/v3/work_packages, method=POST},
                add_relation = {href=/api/v3/work_packages, method=POST},
                add_watcher = {href=/api/v3/work_packages, method=POST},
                custom_actions = [
                    null
                    ],
                preview_markup = {href=/api/v3/work_packages, method=POST},
                remove_watcher = {href=/api/v3/work_packages, method=POST},
                delete = {href=/api/v3/work_packages, method=POST},
                log_time = {href=/api/v3/work_packages, method=POST},
                move = {href=/api/v3/work_packages, method=POST},
                copy = {href=/api/v3/work_packages, method=POST},
                unwatch = {href=/api/v3/work_packages, method=POST},
                update = {href=/api/v3/work_packages, method=POST},
                update_immediately = {href=/api/v3/work_packages, method=POST},
                watch = {href=/api/v3/work_packages, method=POST},
                var_self = {href=/api/v3/work_packages, method=POST},
                var_schema = {href=/api/v3/work_packages, method=POST},
                ancestors = [
                    null
                    ],
                attachments = {href=/api/v3/work_packages, method=POST},
                add_attachment = {href=/api/v3/work_packages, method=POST},
                prepare_attachment = {href=/api/v3/work_packages, method=POST},
                author = {href=/api/v3/work_packages, method=POST},
                assignee = {href=/api/v3/work_packages, method=POST},
                available_watchers = {href=/api/v3/work_packages, method=POST},
                budget = {href=/api/v3/work_packages, method=POST},
                category = {href=/api/v3/work_packages, method=POST},
                children = [
                    null
                    ],
                add_file_link = {href=/api/v3/work_packages, method=POST},
                file_links = {href=/api/v3/work_packages, method=POST},
                parent = {href=/api/v3/work_packages, method=POST},
                priority = {href=/api/v3/work_packages, method=POST},
                project = {href=/api/v3/work_packages, method=POST},
                project_phase = {href=/api/v3/work_packages, method=POST},
                project_phase_definition = {href=/api/v3/work_packages, method=POST},
                responsible = {href=/api/v3/work_packages, method=POST},
                relations = {href=/api/v3/work_packages, method=POST},
                revisions = {href=/api/v3/work_packages, method=POST},
                status = {href=/api/v3/work_packages, method=POST},
                time_entries = {href=/api/v3/work_packages, method=POST},
                type = {href=/api/v3/work_packages, method=POST},
                version = {href=/api/v3/work_packages, method=POST},
                watchers = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return WorkPackageModelAllOfLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testWorkPackageModelAllOfLinks(self):
        """Test WorkPackageModelAllOfLinks"""
