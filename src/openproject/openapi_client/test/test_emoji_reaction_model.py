...
class TestEmojiReactionModel(unittest.TestCase):
    """EmojiReactionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiReactionModel:
        """Test EmojiReactionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiReactionModel`
        """
        model = EmojiReactionModel()
        if include_optional:
            return EmojiReactionModel(
                ...
                emoji = '👍',
                reactions_count = 3,
                first_reaction_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = openproject_client.models.emoji_reaction_model__links.EmojiReactionModel__links(
                    self = null, 
                    reactable = null, 
                    reacting_users = [
                        null
    ...
    def testEmojiReactionModel(self):
        """Test EmojiReactionModel"""
