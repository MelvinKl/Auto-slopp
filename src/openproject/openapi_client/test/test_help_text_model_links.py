...
class TestHelpTextModelLinks(unittest.TestCase):
    """HelpTextModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelpTextModelLinks:
        """Test HelpTextModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelpTextModelLinks`
        """
        model = HelpTextModelLinks()
        if include_optional:
            return HelpTextModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                edit_text = {href=/api/v3/work_packages, method=POST},
    ...
    def testHelpTextModelLinks(self):
        """Test HelpTextModelLinks"""
