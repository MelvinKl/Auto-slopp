    ...
    def make_instance(self, include_optional) -> TypesByWorkspaceModel:
        ...
        if include_optional:
            return TypesByWorkspaceModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.types_by_workspace_model_all_of__links.Types_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.types_by_workspace_model_all_of__embedded.Types_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
