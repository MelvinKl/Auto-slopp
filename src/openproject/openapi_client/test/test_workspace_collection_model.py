...
class TestWorkspaceCollectionModel(unittest.TestCase):
    """WorkspaceCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCollectionModel:
        """Test WorkspaceCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCollectionModel`
        """
        model = WorkspaceCollectionModel()
        if include_optional:
            return WorkspaceCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = None,
                page_size = 0,
                offset = 0,
                embedded = openproject_client.models.workspace_collection_model_all_of__embedded.WorkspaceCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testWorkspaceCollectionModel(self):
        """Test WorkspaceCollectionModel"""
