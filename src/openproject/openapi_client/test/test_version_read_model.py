...
class TestVersionReadModel(unittest.TestCase):
    """VersionReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionReadModel:
        """Test VersionReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionReadModel`
        """
        model = VersionReadModel()
        if include_optional:
