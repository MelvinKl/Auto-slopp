...
class TestOAuthClientCredentialsReadModelLinks(unittest.TestCase):
    """OAuthClientCredentialsReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthClientCredentialsReadModelLinks:
        """Test OAuthClientCredentialsReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthClientCredentialsReadModelLinks`
        """
        model = OAuthClientCredentialsReadModelLinks()
        if include_optional:
            return OAuthClientCredentialsReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                integration = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return OAuthClientCredentialsReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testOAuthClientCredentialsReadModelLinks(self):
        """Test OAuthClientCredentialsReadModelLinks"""
