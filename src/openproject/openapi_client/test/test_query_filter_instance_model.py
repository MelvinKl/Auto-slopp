...
class TestQueryFilterInstanceModel(unittest.TestCase):
    """QueryFilterInstanceModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFilterInstanceModel:
        """Test QueryFilterInstanceModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFilterInstanceModel`
        """
        model = QueryFilterInstanceModel()
        if include_optional:
            return QueryFilterInstanceModel(
                links = openproject_client.models.query_filter_instance_model__links.Query_Filter_Instance_Model__links(
                    filter = {href=/api/v3/work_packages, method=POST}, 
                    schema = {href=/api/v3/work_packages, method=POST}, 
                    operator = {href=/api/v3/work_packages, method=POST}, ),
                type = '',
                name = ''
            )
        else:
    ...
    def testQueryFilterInstanceModel(self):
        """Test QueryFilterInstanceModel"""
