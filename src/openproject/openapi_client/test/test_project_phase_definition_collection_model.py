    ...
    def make_instance(self, include_optional) -> ProjectPhaseDefinitionCollectionModel:
        ...
        if include_optional:
            return ProjectPhaseDefinitionCollectionModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.project_phase_definition_collection_model_all_of__links.ProjectPhaseDefinitionCollectionModel_allOf__links(
                    self = null, ),
                page_size = 0,
                offset = 0,
                embedded = openproject_client.models.project_phase_definition_collection_model_all_of__embedded.ProjectPhaseDefinitionCollectionModel_allOf__embedded(
                    elements = [
