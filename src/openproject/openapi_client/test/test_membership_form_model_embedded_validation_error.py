...
class TestMembershipFormModelEmbeddedValidationError(unittest.TestCase):
    """MembershipFormModelEmbeddedValidationError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipFormModelEmbeddedValidationError:
        """Test MembershipFormModelEmbeddedValidationError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipFormModelEmbeddedValidationError`
        """
        model = MembershipFormModelEmbeddedValidationError()
        if include_optional:
            return MembershipFormModelEmbeddedValidationError(
                ...
                principal = openproject_client.models.error_response.ErrorResponse(
                    ...
                    error_identifier = 'urn:openproject-org:api:v3:errors:PropertyConstraintViolation', 
                    message = 'Project can't be blank.', ),
                roles = openproject_client.models.error_response.ErrorResponse(
                    _embedded = openproject_client.models.error_response__embedded.ErrorResponse__embedded(
                        details = openproject_client.models.error_response__embedded_details.ErrorResponse__embedded_details(
                            attribute = 'project', ), ), 
                    _type = 'Error', 
    ...
    def testMembershipFormModelEmbeddedValidationError(self):
        """Test MembershipFormModelEmbeddedValidationError"""
