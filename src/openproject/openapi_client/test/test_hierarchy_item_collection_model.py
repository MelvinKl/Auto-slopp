...
class TestHierarchyItemCollectionModel(unittest.TestCase):
    """HierarchyItemCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyItemCollectionModel:
        """Test HierarchyItemCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyItemCollectionModel`
        """
        model = HierarchyItemCollectionModel()
        if include_optional:
            return HierarchyItemCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = openproject_client.models.hierarchy_item_collection_model_all_of__links.HierarchyItemCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.hierarchy_item_collection_model_all_of__embedded.HierarchyItemCollectionModel_allOf__embedded(
                    elements = [
                        openproject_client.models.hierarchy_item_read_model.HierarchyItemReadModel(
                            _type = 'HierarchyItem', 
                            id = 56, 
                            label = '', 
                            short = '', 
                            ...
                            formatted_weight = '', 
                            depth = 56, 
                            _links = openproject_client.models.hierarchy_item_read_model__links.HierarchyItemReadModel__links(
                                self = null, 
                                parent = null, 
                                children = [
                                    null
    ...
    def testHierarchyItemCollectionModel(self):
        """Test HierarchyItemCollectionModel"""
