    ...
    def make_instance(self, include_optional) -> WorkspacesSchemaModel:
        ...
        if include_optional:
            return WorkspacesSchemaModel(
                ...
                attribute_groups = [
                    openproject_client.models.workspaces_schema_model__attribute_groups_inner.Workspaces_schemaModel__attributeGroups_inner(
                ...
                name = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                identifier = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                description = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                public = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                active = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                status = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                status_explanation = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                updated_at = openproject_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = openproject_client.models._links._links(), ),
                links = openproject_client.models.workspaces_schema_model__links.Workspaces_schemaModel__links(
                    self = openproject_client.models.workspaces_schema_model__links_self.Workspaces_schemaModel__links_self(
