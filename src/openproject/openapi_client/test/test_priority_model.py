...
class TestPriorityModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PriorityModel:
        """Test PriorityModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityModel`
        """
        model = PriorityModel()
        if include_optional:
            return PriorityModel(
                ...
                is_default = True,
                is_active = True,
                links = openproject_client.models.priority_model__links.PriorityModel__links(
                    self = null, )
            )
        else:
            return PriorityModel(
