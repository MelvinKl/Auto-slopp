...
class TestFileLinkReadModelLinks(unittest.TestCase):
    """FileLinkReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkReadModelLinks:
        """Test FileLinkReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkReadModelLinks`
        """
        model = FileLinkReadModelLinks()
        if include_optional:
            return FileLinkReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                storage = {href=/api/v3/work_packages, method=POST},
                container = {href=/api/v3/work_packages, method=POST},
                creator = {href=/api/v3/work_packages, method=POST},
                delete = {href=/api/v3/work_packages, method=POST},
                status = {href=/api/v3/work_packages, method=POST},
                origin_open = {href=/api/v3/work_packages, method=POST},
                static_origin_open = {href=/api/v3/work_packages, method=POST},
                origin_open_location = {href=/api/v3/work_packages, method=POST},
                static_origin_open_location = {href=/api/v3/work_packages, method=POST},
                static_origin_download = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return FileLinkReadModelLinks(
        )
    ...
    def testFileLinkReadModelLinks(self):
        """Test FileLinkReadModelLinks"""
