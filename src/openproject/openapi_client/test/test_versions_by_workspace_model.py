    ...
    def make_instance(self, include_optional) -> VersionsByWorkspaceModel:
        ...
        if include_optional:
            return VersionsByWorkspaceModel(
                ...
                total = 0,
                count = 0,
                links = openproject_client.models.versions_by_workspace_model_all_of__links.Versions_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.versions_by_workspace_model_all_of__embedded.Versions_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
