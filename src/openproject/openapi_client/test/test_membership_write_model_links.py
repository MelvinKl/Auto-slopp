...
class TestMembershipWriteModelLinks(unittest.TestCase):
    """MembershipWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipWriteModelLinks:
        """Test MembershipWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipWriteModelLinks`
        """
        model = MembershipWriteModelLinks()
        if include_optional:
    ...
    def testMembershipWriteModelLinks(self):
        """Test MembershipWriteModelLinks"""
