    ...
    def make_instance(self, include_optional) -> TimeEntryActivityModel:
        ...
        if include_optional:
            return TimeEntryActivityModel(
                ...
                position = 56,
                default = True,
                embedded = openproject_client.models.time_entry_activity_model__embedded.TimeEntryActivityModel__embedded(
                    projects = [
                        null
                        ], ),
                links = openproject_client.models.time_entry_activity_model__links.TimeEntryActivityModel__links(
                    self = null, 
                    projects = [
                        null
                        ], )
