...
class TestGroupCollectionModel(unittest.TestCase):
    """GroupCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCollectionModel:
        """Test GroupCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCollectionModel`
        """
        model = GroupCollectionModel()
        if include_optional:
            return GroupCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = openproject_client.models.group_collection_model_all_of__links.GroupCollectionModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.group_collection_model_all_of__embedded.GroupCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testGroupCollectionModel(self):
        """Test GroupCollectionModel"""
