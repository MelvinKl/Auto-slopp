...
class TestListAvailableParentProjectCandidatesModel(unittest.TestCase):
    """ListAvailableParentProjectCandidatesModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAvailableParentProjectCandidatesModel:
        """Test ListAvailableParentProjectCandidatesModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAvailableParentProjectCandidatesModel`
        """
        model = ListAvailableParentProjectCandidatesModel()
        if include_optional:
            return ListAvailableParentProjectCandidatesModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = openproject_client.models.list_available_parent_project_candidates_model_all_of__links.List_available_parent_project_candidatesModel_allOf__links(
                    self = null, ),
                embedded = openproject_client.models.list_available_parent_project_candidates_model_all_of__embedded.List_available_parent_project_candidatesModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testListAvailableParentProjectCandidatesModel(self):
        """Test ListAvailableParentProjectCandidatesModel"""
