...
class TestQueryFilterInstanceSchemaModelLinks(unittest.TestCase):
    """QueryFilterInstanceSchemaModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFilterInstanceSchemaModelLinks:
        """Test QueryFilterInstanceSchemaModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFilterInstanceSchemaModelLinks`
        """
        model = QueryFilterInstanceSchemaModelLinks()
        if include_optional:
    ...
    def testQueryFilterInstanceSchemaModelLinks(self):
        """Test QueryFilterInstanceSchemaModelLinks"""
