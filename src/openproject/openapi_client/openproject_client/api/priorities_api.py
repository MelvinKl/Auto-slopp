...
class PrioritiesApi:
    ...
    def list_all_priorities(
        ...
        _param = self._list_all_priorities_serialize(
    ...
    @validate_call
    def list_all_priorities_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PriorityCollectionModel]:
        """List all Priorities
    ...
    @validate_call
    def list_all_priorities_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_all_priorities_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/priorities',
    ...
    def view_priority(
        self,
        id: Annotated[StrictInt, Field(description="Priority id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._view_priority_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_priority_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Priority id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_priority_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Priority id")],
        _request_timeout: Union[
            None,
    ...
    def _view_priority_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/priorities/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
