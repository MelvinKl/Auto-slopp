...
class QueryColumnsApi:
    ...
    @validate_call
    def view_query_column(
        self,
        id: Annotated[StrictStr, Field(description="QueryColumn id")],
        ...
        _param = self._view_query_column_serialize(
            id=id,
    ...
    @validate_call
    def view_query_column_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="QueryColumn id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_query_column_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="QueryColumn id")],
        _request_timeout: Union[
            None,
    ...
    def _view_query_column_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/columns/{id}',
