...
class FormsApi:
    ...
    @validate_call
    def show_or_validate_form(
        self,
        show_or_validate_form_request: Optional[ShowOrValidateFormRequest] = None,
        ...
        :param show_or_validate_form_request:
        :type show_or_validate_form_request: ShowOrValidateFormRequest
        ...
        _param = self._show_or_validate_form_serialize(
            show_or_validate_form_request=show_or_validate_form_request,
    ...
    @validate_call
    def show_or_validate_form_with_http_info(
        self,
        show_or_validate_form_request: Optional[ShowOrValidateFormRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def show_or_validate_form_without_preload_content(
        self,
        show_or_validate_form_request: Optional[ShowOrValidateFormRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _show_or_validate_form_serialize(
        self,
        ...
        if show_or_validate_form_request is not None:
            _body_params = show_or_validate_form_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/example/form',
