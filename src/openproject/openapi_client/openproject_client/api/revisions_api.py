...
class RevisionsApi:
    ...
    def view_revision(
        self,
        id: Annotated[StrictInt, Field(description="Revision id")],
        ...
        _param = self._view_revision_serialize(
            id=id,
    ...
    @validate_call
    def view_revision_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Revision id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_revision_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Revision id")],
        _request_timeout: Union[
            None,
    ...
    def _view_revision_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/revisions/{id}',
