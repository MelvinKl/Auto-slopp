...
class GroupsApi:
    ...
    def create_group(
        self,
        group_write_model: Optional[GroupWriteModel] = None,
        ...
        :param group_write_model:
        :type group_write_model: GroupWriteModel
        ...
        _param = self._create_group_serialize(
            group_write_model=group_write_model,
    ...
    def _create_group_serialize(
        ...
        if group_write_model is not None:
            _body_params = group_write_model
    ...
    def _delete_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_groups(
        self,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by group creation datetime  + updated_at: Sort by the time the group was updated last")] = None,
        ...
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by group creation datetime  + updated_at: Sort by the time the group was updated last
        :type sort_by: str
    ...
    def list_groups_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GroupCollectionModel]:
        """List groups
