...
class DefaultApi:
    ...
    @validate_call
    def get_custom_field_item(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        ...
        :param id: The custom field item's unique identifier (required)
        :type id: int
        ...
        _param = self._get_custom_field_item_serialize(
            id=id,
    ...
    @validate_call
    def get_custom_field_item_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HierarchyItemReadModel]:
        """Get a custom field hierarchy item
    ...
    @validate_call
    def get_custom_field_item_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_custom_field_item_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/custom_field_items/{id}',
    ...
    @validate_call
    def get_custom_field_item_branch(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_custom_field_item_branch_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HierarchyItemCollectionModel",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '422': "ErrorResponse",
        }
    ...
    @validate_call
    def get_custom_field_item_branch_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HierarchyItemCollectionModel]:
        """Get a custom field hierarchy item's branch
    ...
    @validate_call
    def get_custom_field_item_branch_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The custom field item's unique identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_custom_field_item_branch_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/custom_field_items/{id}/branch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_custom_field_items(
        self,
        id: Annotated[StrictInt, Field(description="The custom field's unique identifier")],
        parent: Annotated[Optional[StrictInt], Field(description="The identifier of the parent hierarchy item")] = None,
        depth: Annotated[Optional[StrictInt], Field(description="The level of hierarchy depth")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The custom field's unique identifier (required)
        :type id: int
        ...
        _param = self._get_custom_field_items_serialize(
            id=id,
            parent=parent,
            depth=depth,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_custom_field_items_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The custom field's unique identifier")],
        parent: Annotated[Optional[StrictInt], Field(description="The identifier of the parent hierarchy item")] = None,
        depth: Annotated[Optional[StrictInt], Field(description="The level of hierarchy depth")] = None,
    ...
    @validate_call
    def get_custom_field_items_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The custom field's unique identifier")],
        parent: Annotated[Optional[StrictInt], Field(description="The identifier of the parent hierarchy item")] = None,
        depth: Annotated[Optional[StrictInt], Field(description="The level of hierarchy depth")] = None,
    ...
    def _get_custom_field_items_serialize(
        self,
        id,
        parent,
        depth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/custom_fields/{id}/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
