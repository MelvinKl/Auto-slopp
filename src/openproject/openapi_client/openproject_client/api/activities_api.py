...
class ActivitiesApi:
    ...
    def get_activity(
        self,
        id: Annotated[StrictInt, Field(description="Activity id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_activity_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/activities/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_activity_emoji_reactions(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity whose emoji reactions will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the activity whose emoji reactions will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_activity_emoji_reactions_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_activity_emoji_reactions_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity whose emoji reactions will be listed")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmojiReactionsModel]:
        """List emoji reactions by activity
    ...
    @validate_call
    def list_activity_emoji_reactions_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity whose emoji reactions will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_activity_emoji_reactions_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/activities/{id}/emoji_reactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_work_package_activities_emoji_reactions(
        self,
        id: Annotated[StrictInt, Field(description="ID of the work package whose activities' emoji reactions will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the work package whose activities' emoji reactions will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_work_package_activities_emoji_reactions_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_work_package_activities_emoji_reactions_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the work package whose activities' emoji reactions will be listed")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_work_package_activities_emoji_reactions_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the work package whose activities' emoji reactions will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_work_package_activities_emoji_reactions_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/work_packages/{id}/activities_emoji_reactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def toggle_activity_emoji_reaction(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity to toggle emoji reaction for")],
        toggle_activity_emoji_reaction_request: ToggleActivityEmojiReactionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the activity to toggle emoji reaction for (required)
        :type id: int
        :param toggle_activity_emoji_reaction_request: (required)
        :type toggle_activity_emoji_reaction_request: ToggleActivityEmojiReactionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._toggle_activity_emoji_reaction_serialize(
            id=id,
            toggle_activity_emoji_reaction_request=toggle_activity_emoji_reaction_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def toggle_activity_emoji_reaction_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity to toggle emoji reaction for")],
        toggle_activity_emoji_reaction_request: ToggleActivityEmojiReactionRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmojiReactionModel]:
        """Toggle emoji reaction for an activity
    ...
    @validate_call
    def toggle_activity_emoji_reaction_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the activity to toggle emoji reaction for")],
        toggle_activity_emoji_reaction_request: ToggleActivityEmojiReactionRequest,
        _request_timeout: Union[
    ...
    def _toggle_activity_emoji_reaction_serialize(
        self,
        id,
        toggle_activity_emoji_reaction_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if toggle_activity_emoji_reaction_request is not None:
            _body_params = toggle_activity_emoji_reaction_request
