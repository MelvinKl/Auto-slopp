...
class PortfoliosApi:
    ...
    def delete_portfolio(
        self,
        id: Annotated[StrictInt, Field(description="Portfolio id")],
    ...
    def _delete_portfolio_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/portfolios/{id}',
    ...
    def list_portfolios(
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openportfolio.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + active: based on the active property of the portfolio + ancestor: filters portfolios by their ancestor. A portfolio is not considered to be its own ancestor. + available_project_attributes: filters portfolios based on the activated project attributes. + created_at: based on the time the portfolio was created + favorited: based on the favorited property of the portfolio + id: based on portfolios' id. + latest_activity_at: based on the time the last activity was registered on a portfolio. + name_and_identifier: based on both the name and the identifier. + parent_id: filters portfolios by their parent. + principal: based on members of the portfolio. + project_phase_any: based on the project phases active in a portfolio. + project_status_code: based on status code of the portfolio + storage_id: filters portfolios by linked storages + storage_url: filters portfolios by linked storages identified by the host url + type_id: based on the types active in a portfolio. + user_action: based on the actions the current user has in the portfolio. + visible: based on the visibility for the user (id) provided as the filter value. This filter is useful for admins to identify the portfolios visible to a user.  There might also be additional filters based on the custom fields that have been configured.  Each defined lifecycle step will also define a filter in this list endpoint. Given that the elements are not static but rather dynamically created on each OpenProject instance, a list cannot be provided. Those filters follow the schema: + project_start_gate_[id]: a filter on a project phase's start gate active in a portfolio. The id is the id of the phase the gate belongs to. + project_finish_gate_[id]: a filter on a project phase's finish gate active in a portfolio. The id is the id of the phase the gate belongs to. + project_phase_[id]: a filter on a project phase active in a portfolio. The id is the id of the phase queried for.
        :type filters: str
    ...
    def list_portfolios_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PortfolioCollectionModel]:
        """List portfolios
    ...
    def _list_portfolios_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/portfolios',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def portfolio_update_form(
        ...
        _param = self._portfolio_update_form_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def portfolio_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Portfolio id")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def portfolio_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Portfolio id")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    def _portfolio_update_form_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/portfolios/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_portfolio(
        ...
        :param id: Portfolio id (required)
        :type id: int
        :param portfolio_model:
        :type portfolio_model: PortfolioModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def view_portfolio(
        ...
        _param = self._view_portfolio_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_portfolio_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Portfolio id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_portfolio_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Portfolio id")],
        _request_timeout: Union[
            None,
