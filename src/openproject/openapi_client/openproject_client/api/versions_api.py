...
class VersionsApi:
    ...
    @validate_call
    def available_projects_for_versions(
        self,
        ...
        _param = self._available_projects_for_versions_serialize(
    ...
    @validate_call
    def available_projects_for_versions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def available_projects_for_versions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _available_projects_for_versions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/versions/available_projects',
    ...
    def create_version(
        self,
        version_write_model: Optional[VersionWriteModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param version_write_model:
        :type version_write_model: VersionWriteModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_version_serialize(
            version_write_model=version_write_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_version_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if version_write_model is not None:
            _body_params = version_write_model
    ...
    def _delete_version_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/versions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_versions(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - sharing: filters versions by how they are shared within the server (*none*, *descendants*, *hierarchy*, *tree*, *system*). - name: filters versions by their name.")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported attributes are:  - id: Sort by the version id - name: Sort by the version name using numeric collation, comparing sequences of decimal digits by their numeric value")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - sharing: filters versions by how they are shared within the server (*none*, *descendants*, *hierarchy*, *tree*, *system*). - name: filters versions by their name.
        :type filters: str
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported attributes are:  - id: Sort by the version id - name: Sort by the version name using numeric collation, comparing sequences of decimal digits by their numeric value
        :type sort_by: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def list_versions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VersionCollectionModel]:
        """List versions
    ...
    @validate_call
    def list_versions_available_in_a_project(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose versions will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This endpoint lists the versions that are *available* in a given project. Note that due to sharing this might be more than the versions *defined* by that project.  This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/versions`](https://www.openproject.org/docs/api/endpoints/versions/#list-versions-available-in-a-workspace)

        :param id: ID of the project whose versions will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_versions_available_in_a_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_versions_available_in_a_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose versions will be listed")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VersionsByWorkspaceModel]:
        """List versions available in a project
    ...
    @validate_call
    def list_versions_available_in_a_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose versions will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_versions_available_in_a_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_versions_available_in_a_workspace(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose versions will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This endpoint lists the versions that are *available* in a given workspace. Note that due to sharing this might be more than the versions *defined* by that workspace.

        :param id: ID of the workspace whose versions will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_versions_available_in_a_workspace_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_versions_available_in_a_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose versions will be listed")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_versions_available_in_a_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose versions will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_versions_available_in_a_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspaces/{id}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def version_create_form(
        ...
        _param = self._version_create_form_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def version_create_form_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def version_create_form_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _version_create_form_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/versions/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def version_update_form(
        ...
        _param = self._version_update_form_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def version_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def version_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _version_update_form_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/versions/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_version_schema(
        ...
        _param = self._view_version_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def view_version_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def view_version_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _view_version_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/versions/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
