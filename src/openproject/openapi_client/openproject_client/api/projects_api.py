...
from openproject_client.api_client import ApiClient, RequestSerialized
from openproject_client.api_response import ApiResponse
from openproject_client.rest import RESTResponseType
...
class ProjectsApi:
    ...
    def create_project_copy(
        ...
        _param = self._create_project_copy_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_project_copy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_project_copy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _create_project_copy_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/projects/{id}/copy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_project_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/projects/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def favorite_project(
        ...
        Adds the project to the current user's favorites.  This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/favorite`](https://www.openproject.org/docs/api/endpoints/workspaces/#favorite-workspace)
        ...
        _param = self._favorite_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def favorite_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def favorite_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _favorite_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/projects/{id}/favorite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_available_parent_project_candidates(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.")] = None,
        of: Annotated[Optional[StrictStr], Field(description="The id or identifier of the project the parent candidate is determined for")] = None,
        workspace_type: Annotated[Optional[StrictStr], Field(description="The workspace type of the new project the parent candidate is determined for. Ignored when `of` parameter is provided. Note that while 'portfolio' is supported as a type (since it is a type of Workspace), the endpoint will currently always return an empty resultset as portfolios cannot have parents.")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint and allows all the filters and sortBy supported by the project list endpoint.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type of: str
        :param workspace_type: The workspace type of the new project the parent candidate is determined for. Ignored when `of` parameter is provided. Note that while 'portfolio' is supported as a type (since it is a type of Workspace), the endpoint will currently always return an empty resultset as portfolios cannot have parents.
        :type workspace_type: str
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint and allows all the filters and sortBy supported by the project list endpoint.
        :type sort_by: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_available_parent_project_candidates_serialize(
            filters=filters,
            of=of,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAvailableParentProjectCandidatesModel",
            '403': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_available_parent_project_candidates_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.")] = None,
        of: Annotated[Optional[StrictStr], Field(description="The id or identifier of the project the parent candidate is determined for")] = None,
        workspace_type: Annotated[Optional[StrictStr], Field(description="The workspace type of the new project the parent candidate is determined for. Ignored when `of` parameter is provided. Note that while 'portfolio' is supported as a type (since it is a type of Workspace), the endpoint will currently always return an empty resultset as portfolios cannot have parents.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAvailableParentProjectCandidatesModel]:
        """List available parent project candidates
    ...
    @validate_call
    def list_available_parent_project_candidates_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.")] = None,
        of: Annotated[Optional[StrictStr], Field(description="The id or identifier of the project the parent candidate is determined for")] = None,
        workspace_type: Annotated[Optional[StrictStr], Field(description="The workspace type of the new project the parent candidate is determined for. Ignored when `of` parameter is provided. Note that while 'portfolio' is supported as a type (since it is a type of Workspace), the endpoint will currently always return an empty resultset as portfolios cannot have parents.")] = None,
    ...
    def _list_available_parent_project_candidates_serialize(
        self,
        filters,
        of,
        workspace_type,
        ...
        if workspace_type is not None:
            ...
            _query_params.append(('workspace_type', workspace_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/available_parent_projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_projects(
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + active: based on the active property of the project + ancestor: filters projects by their ancestor. A project is not considered to be its own ancestor. + available_project_attributes: filters projects based on the activated project project attributes. + created_at: based on the time the project was created + favorited: based on the favorited property of the project + id: based on projects' id. + latest_activity_at: based on the time the last activity was registered on a project. + name_and_identifier: based on both the name and the identifier. + parent_id: filters projects by their parent. + principal: based on members of the project. + project_phase_any: based on the project phases active in a project. + project_status_code: based on status code of the project + storage_id: filters projects by linked storages + storage_url: filters projects by linked storages identified by the host url + type_id: based on the types active in a project. + user_action: based on the actions the current user has in the project. + visible: based on the visibility for the user (id) provided as the filter value. This filter is useful for admins to identify the projects visible to a user.  There might also be additional filters based on the custom fields that have been configured.  Each defined lifecycle step will also define a filter in this list endpoint. Given that the elements are not static but rather dynamically created on each OpenProject instance, a list cannot be provided. Those filters follow the schema: + project_start_gate_[id]: a filter on a project phase's start gate active in a project. The id is the id of the phase the gate belongs to. + project_finish_gate_[id]: a filter on a project phase's finish gate active in a project. The id is the id of the phase the gate belongs to. + project_phase_[id]: a filter on a project phase active in a project. The id is the id of the phase queried for.
        :type filters: str
        :param sort_by: JSON specifying sort criteria. Currently supported orders are:  + id + name + typeahead (sorting by hierarchy and name) + created_at + public + latest_activity_at + required_disk_space  There might also be additional orders based on the custom fields that have been configured.
        :type sort_by: str
    ...
    def list_projects_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectCollectionModel]:
        """List projects
    ...
    @validate_call
    def list_projects_with_version(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This endpoint lists the projects where the given version is available.  The projects returned depend on the sharing settings of the given version, but are also limited to the projects that the current user is allowed to see.  This endpoint is deprecated and replaced by [`/api/v3/versions/{id}/workspaces`](https://www.openproject.org/docs/api/endpoints/projects/#list-workspaces-having-version)
        ...
        _param = self._list_projects_with_version_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_projects_with_version_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_projects_with_version_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
    ...
    def _list_projects_with_version_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/versions/{id}/projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_workspaces_with_version(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
        ...
        This endpoint lists the workspaces where the given version is available.  The workspaces returned depend on the sharing settings of the given version, but are also limited to the workspaces that the current user is allowed to see.
        ...
        _param = self._list_workspaces_with_version_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_workspaces_with_version_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_workspaces_with_version_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Version id")],
        _request_timeout: Union[
            None,
    ...
    def _list_workspaces_with_version_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/versions/{id}/workspaces',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def project_copy_form(
        ...
        _param = self._project_copy_form_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def project_copy_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def project_copy_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _project_copy_form_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/projects/{id}/copy/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def project_create_form(
        ...
        _param = self._project_create_form_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def project_create_form_with_http_info(
        self,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def project_create_form_without_preload_content(
        self,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
            None,
    ...
    def _project_create_form_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/projects/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def project_update_form(
        ...
        _param = self._project_update_form_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def project_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def project_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    def _project_update_form_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/projects/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def unfavorite_project(
        ...
        Removes the project from the current user's favorites.  This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/favorite`](https://www.openproject.org/docs/api/endpoints/workspaces/#unfavorite-workspace)
        ...
        _param = self._unfavorite_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def unfavorite_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def unfavorite_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _unfavorite_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def view_project(
        ...
        _param = self._view_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_project_configuration(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
        ...
        _param = self._view_project_configuration_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_project_configuration_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectConfigurationModel]:
        """View project configuration
    ...
    @validate_call
    def view_project_configuration_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _view_project_configuration_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/configuration',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_project_schema(
        ...
        _param = self._view_project_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def view_project_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkspacesSchemaModel]:
        """View project schema
    ...
    @validate_call
    def view_project_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _view_project_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_project_status(
        self,
        id: Annotated[StrictStr, Field(description="Project status id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Project status id (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._view_project_status_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_project_status_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Project status id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_project_status_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Project status id")],
        _request_timeout: Union[
            None,
    ...
    def _view_project_status_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_statuses/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
