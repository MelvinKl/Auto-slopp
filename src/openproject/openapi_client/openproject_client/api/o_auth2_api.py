...
class OAuth2Api:
    ...
    def get_oauth_application(
        self,
        id: Annotated[StrictInt, Field(description="OAuth application id")],
        ...
        :param id: OAuth application id (required)
        :type id: int
        ...
        _param = self._get_oauth_application_serialize(
            id=id,
    ...
    @validate_call
    def get_oauth_application_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="OAuth application id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthApplicationReadModel]:
        """Get the oauth application.
    ...
    @validate_call
    def get_oauth_application_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="OAuth application id")],
        _request_timeout: Union[
            None,
    ...
    def _get_oauth_application_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/oauth_applications/{id}',
    ...
    def get_oauth_client_credentials(
        self,
        id: Annotated[StrictInt, Field(description="OAuth Client Credentials id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: OAuth Client Credentials id (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_oauth_client_credentials_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OAuthClientCredentialsReadModel",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_oauth_client_credentials_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="OAuth Client Credentials id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthClientCredentialsReadModel]:
        """Get the oauth client credentials object.
    ...
    @validate_call
    def get_oauth_client_credentials_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="OAuth Client Credentials id")],
        _request_timeout: Union[
            None,
    ...
    def _get_oauth_client_credentials_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/oauth_client_credentials/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
