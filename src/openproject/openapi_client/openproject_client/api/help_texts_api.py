...
class HelpTextsApi:
    ...
    def get_help_text(
        self,
        id: Annotated[StrictInt, Field(description="Help text id")],
        ...
        _param = self._get_help_text_serialize(
            id=id,
    ...
    @validate_call
    def get_help_text_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Help text id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_help_text_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Help text id")],
        _request_timeout: Union[
            None,
    ...
    def _get_help_text_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/help_texts/{id}',
    ...
    def list_help_texts(
        ...
        _param = self._list_help_texts_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_help_texts_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HelpTextCollectionModel]:
        """List help texts
    ...
    @validate_call
    def list_help_texts_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_help_texts_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/help_texts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
