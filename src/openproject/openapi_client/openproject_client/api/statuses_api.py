...
class StatusesApi:
    ...
    def get_status(
        self,
        id: Annotated[StrictInt, Field(description="Status id")],
    ...
    def _get_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/statuses/{id}',
    ...
    def list_statuses_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StatusCollectionModel]:
        """List the collection of all statuses
