...
class WeekDayCollectionModelAllOfEmbedded(BaseModel):
    """
    WeekDayCollectionModelAllOfEmbedded
    """ # noqa: E501
    elements: Annotated[List[WeekDayModel], Field(min_length=7, max_length=7)] = Field(description="The array of week days.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [WeekDayModel.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
