...
class ValuesPropertyModelLinks(BaseModel):
    """
    ValuesPropertyModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This key - value pair.  **Resource**: Storage", alias="self")
    var_schema: Link = Field(description="The schema describing the key - value pair.  **Resource**: Schema", alias="schema")
