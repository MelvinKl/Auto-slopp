...
class StorageWriteModelLinks(BaseModel):
    """
    StorageWriteModelLinks
    """ # noqa: E501
    origin: Link = Field(description="The storage's host URL.  **Resource**: N/A")
    ...
    __properties: ClassVar[List[str]] = ["origin", "type", "authenticationMethod"]
