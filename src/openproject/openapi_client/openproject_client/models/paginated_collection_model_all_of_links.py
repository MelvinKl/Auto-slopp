...
class PaginatedCollectionModelAllOfLinks(BaseModel):
    """
    PaginatedCollectionModelAllOfLinks
    """ # noqa: E501
    jump_to: Link = Field(description="Templated link to another page offset.  **Resource**: Collection", alias="jumpTo")
    change_size: Link = Field(description="Templated link for another page size.  **Resource**: Collection", alias="changeSize")
    __properties: ClassVar[List[str]] = ["jumpTo", "changeSize"]
