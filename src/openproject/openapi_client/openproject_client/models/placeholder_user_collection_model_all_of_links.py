...
class PlaceholderUserCollectionModelAllOfLinks(BaseModel):
    """
    PlaceholderUserCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This placeholder user collection  **Resource**: Collection", alias="self")
