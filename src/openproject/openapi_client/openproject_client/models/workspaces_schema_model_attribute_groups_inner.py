...
class WorkspacesSchemaModelAttributeGroupsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the custom field section")
    name: Optional[StrictStr] = Field(default=None, description="The human-readable name of the custom field section")
    attributes: Optional[List[StrictStr]] = Field(default=None, description="Array of camelCase custom field attribute names belonging to this section. Only includes custom fields visible to the current user.")
    __properties: ClassVar[List[str]] = ["_type", "id", "name", "attributes"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ProjectFormCustomFieldSection']):
            raise ValueError("must be one of enum values ('ProjectFormCustomFieldSection')")
        return value
