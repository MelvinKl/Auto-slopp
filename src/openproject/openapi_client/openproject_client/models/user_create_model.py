...
class UserCreateModel(BaseModel):
    ...
    """ # noqa: E501
    admin: StrictBool
    email: Annotated[str, Field(strict=True, max_length=60)]
    login: Annotated[str, Field(strict=True, max_length=256)]
    password: Optional[StrictStr] = Field(default=None, description="The users password.  *Conditions:*  Only writable on creation, not on update.")
    ...
    status: Optional[StrictStr] = Field(default=None, description="The current activation status of the user.  *Conditions:*  Only writable on creation, not on update.")
    language: StrictStr
    __properties: ClassVar[List[str]] = ["admin", "email", "login", "password", "firstName", "lastName", "status", "language"]
