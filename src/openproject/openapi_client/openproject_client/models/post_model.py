...
class PostModel(BaseModel):
    ...
    PostModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Identifier of this post")
    subject: StrictStr = Field(description="The post's subject")
    links: Optional[PostModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "subject", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": PostModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
