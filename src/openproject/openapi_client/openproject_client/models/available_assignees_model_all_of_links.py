...
class AvailableAssigneesModelAllOfLinks(BaseModel):
    """
    AvailableAssigneesModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="The available assignees collection  **Resource**: AvailableAssigneesCollection", alias="self")
