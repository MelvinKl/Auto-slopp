...
class NonWorkingDayCollectionModelAllOfLinks(BaseModel):
    """
    NonWorkingDayCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This non working days collection  **Resource**: NonWorkingDayCollectionModel", alias="self")
