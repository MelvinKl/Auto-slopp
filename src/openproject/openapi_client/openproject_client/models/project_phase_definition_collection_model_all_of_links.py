...
class ProjectPhaseDefinitionCollectionModelAllOfLinks(BaseModel):
    """
    ProjectPhaseDefinitionCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This file links collection  **Resource**: ProjectPhaseDefinitionCollectionModel", alias="self")
