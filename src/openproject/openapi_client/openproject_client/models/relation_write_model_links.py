...
class RelationWriteModelLinks(BaseModel):
    """
    RelationWriteModelLinks
    """ # noqa: E501
    to: Optional[Link] = Field(default=None, description="The work package the relation ends in. Only available on relation creation, not on update.  **Resource**: WorkPackage  # Conditions  **Permission**: view work packages")
