...
class TimeEntryActivityModelLinks(BaseModel):
    """
    TimeEntryActivityModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This time entry activity  **Resource**: TimeEntriesActivity", alias="self")
    projects: List[Link]
    __properties: ClassVar[List[str]] = ["self", "projects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projects": [Link.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
