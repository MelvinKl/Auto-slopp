...
class HelpTextCollectionModelAllOfLinks(BaseModel):
    """
    HelpTextCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This help text collection  **Resource**: HelpTextCollectionModel", alias="self")
