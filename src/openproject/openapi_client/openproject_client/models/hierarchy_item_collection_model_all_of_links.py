...
class HierarchyItemCollectionModelAllOfLinks(BaseModel):
    """
    HierarchyItemCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This hierarchy item collection  **Resource**: HierarchyItemCollectionModel", alias="self")
