...
class MembershipFormModelEmbedded(BaseModel):
    """
    MembershipFormModelEmbedded
    """ # noqa: E501
    payload: MembershipWriteModel
    var_schema: MembershipSchemaModel = Field(alias="schema")
    validation_error: MembershipFormModelEmbeddedValidationError = Field(alias="validationError")
    __properties: ClassVar[List[str]] = ["payload", "schema", "validationError"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": MembershipWriteModel.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
            "schema": MembershipSchemaModel.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "validationError": MembershipFormModelEmbeddedValidationError.from_dict(obj["validationError"]) if obj.get("validationError") is not None else None
        })
        return _obj
