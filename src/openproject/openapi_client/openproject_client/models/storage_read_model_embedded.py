...
class StorageReadModelEmbedded(BaseModel):
    """
    StorageReadModelEmbedded
    """ # noqa: E501
    oauth_application: Optional[OAuthApplicationReadModel] = Field(default=None, alias="oauthApplication")
    oauth_client_credentials: Optional[OAuthClientCredentialsReadModel] = Field(default=None, alias="oauthClientCredentials")
    __properties: ClassVar[List[str]] = ["oauthApplication", "oauthClientCredentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oauthApplication": OAuthApplicationReadModel.from_dict(obj["oauthApplication"]) if obj.get("oauthApplication") is not None else None,
            "oauthClientCredentials": OAuthClientCredentialsReadModel.from_dict(obj["oauthClientCredentials"]) if obj.get("oauthClientCredentials") is not None else None
        })
        return _obj
