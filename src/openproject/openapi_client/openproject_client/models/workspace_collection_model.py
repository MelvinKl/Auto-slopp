...
class WorkspaceCollectionModel(BaseModel):
    ...
    links: WorkspaceCollectionModelAllOfLinks = Field(alias="_links")
    ...
    embedded: WorkspaceCollectionModelAllOfEmbedded = Field(alias="_embedded")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceCollectionModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceCollectionModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_links": WorkspaceCollectionModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "pageSize": obj.get("pageSize"),
            "offset": obj.get("offset"),
            "_embedded": WorkspaceCollectionModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
