...
class QueryModel(BaseModel):
    ...
    QueryModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Query id")
    name: Optional[StrictStr] = Field(default=None, description="Query name")
    filters: Optional[List[QueryFilterInstanceModel]] = Field(default=None, description="A set of QueryFilters which will be applied to the work packages to determine the resulting work packages")
    sums: Optional[StrictBool] = Field(default=None, description="Should sums (of supported properties) be shown?")
    timeline_visible: Optional[StrictBool] = Field(default=None, description="Should the timeline mode be shown?", alias="timelineVisible")
    timeline_labels: Optional[List[StrictStr]] = Field(default=None, description="Which labels are shown in the timeline, empty when default", alias="timelineLabels")
    timeline_zoom_level: Optional[StrictStr] = Field(default=None, description="Which zoom level should the timeline be rendered in?", alias="timelineZoomLevel")
    timestamps: Optional[List[Any]] = Field(default=None, description="Timestamps to filter by when showing changed attributes on work packages.")
    highlighting_mode: Optional[StrictStr] = Field(default=None, description="Which highlighting mode should the table have?", alias="highlightingMode")
    show_hierarchies: Optional[StrictBool] = Field(default=None, description="Should the hierarchy mode be enabled?", alias="showHierarchies")
    hidden: Optional[StrictBool] = Field(default=None, description="Should the query be hidden from the query list?")
    public: Optional[StrictBool] = Field(default=None, description="Can users besides the owner see the query?")
    starred: Optional[StrictBool] = Field(default=None, description="Should the query be highlighted to the user?")
    created_at: datetime = Field(description="Time of creation", alias="createdAt")
    updated_at: datetime = Field(description="Time of the most recent change to the query", alias="updatedAt")
    links: Optional[QueryModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "name", "filters", "sums", "timelineVisible", "timelineLabels", "timelineZoomLevel", "timestamps", "highlightingMode", "showHierarchies", "hidden", "public", "starred", "createdAt", "updatedAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "filters": [QueryFilterInstanceModel.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
            "sums": obj.get("sums"),
            "timelineVisible": obj.get("timelineVisible"),
            "timelineLabels": obj.get("timelineLabels"),
            "timelineZoomLevel": obj.get("timelineZoomLevel"),
            "timestamps": obj.get("timestamps"),
            "highlightingMode": obj.get("highlightingMode"),
            "showHierarchies": obj.get("showHierarchies"),
            "hidden": obj.get("hidden"),
            "public": obj.get("public"),
            "starred": obj.get("starred"),
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "_links": QueryModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
