...
class OAuthClientCredentialsReadModelLinks(BaseModel):
    """
    OAuthClientCredentialsReadModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This OAuth Client Credentials object  **Resource**: OAuthClientCredentials", alias="self")
    integration: Link = Field(description="The resource that integrates this OAuth client credentials. Currently, only `Storage` resources are able to contain OAuth client credentials.  **Resource**: Storage")
    __properties: ClassVar[List[str]] = ["self", "integration"]
