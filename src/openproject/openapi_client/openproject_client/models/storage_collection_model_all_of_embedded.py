...
class StorageCollectionModelAllOfEmbedded(BaseModel):
    """
    StorageCollectionModelAllOfEmbedded
    """ # noqa: E501
    elements: List[StorageReadModel]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [StorageReadModel.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
