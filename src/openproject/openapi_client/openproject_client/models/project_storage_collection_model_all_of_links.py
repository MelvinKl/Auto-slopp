...
class ProjectStorageCollectionModelAllOfLinks(BaseModel):
    """
    ProjectStorageCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This file links collection  **Resource**: ProjectStorageCollectionModel", alias="self")
