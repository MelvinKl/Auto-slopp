...
class WeekDayCollectionWriteModelEmbeddedElementsInner(BaseModel):
    """
    WeekDayCollectionWriteModelEmbeddedElementsInner
    """ # noqa: E501
    type: StrictStr = Field(alias="_type")
    working: StrictBool = Field(description="`true` for a working day. `false` for a weekend day.")
    links: WeekDaySelfLinkModel = Field(alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "working", "_links"]
