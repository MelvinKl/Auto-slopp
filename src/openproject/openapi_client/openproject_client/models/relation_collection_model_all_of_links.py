...
class RelationCollectionModelAllOfLinks(BaseModel):
    """
    RelationCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This relation collection  **Resource**: RelationCollectionReadModel", alias="self")
