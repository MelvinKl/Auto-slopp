...
class NotificationCollectionModelAllOfLinks(BaseModel):
    """
    NotificationCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This notification collection  **Resource**: NotificationCollectionModel", alias="self")
    jump_to: Optional[Link] = Field(default=None, description="The notification collection at another offset  **Resource**: NotificationCollectionModel", alias="jumpTo")
    change_size: Optional[Link] = Field(default=None, description="The notification collection with another size  **Resource**: NotificationCollectionModel", alias="changeSize")
    __properties: ClassVar[List[str]] = ["self", "jumpTo", "changeSize"]
