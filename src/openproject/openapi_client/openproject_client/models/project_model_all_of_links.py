...
class ProjectModelAllOfLinks(BaseModel):
    """
    ProjectModelAllOfLinks
    """ # noqa: E501
    update: Optional[Link] = Field(default=None, description="Form endpoint that aids in updating this project  # Conditions  **Permission**: edit workspace")
    update_immediately: Optional[Link] = Field(default=None, description="Directly update this project  # Conditions  **Permission**: edit workspace", alias="updateImmediately")
    delete: Optional[Link] = Field(default=None, description="Delete this project  # Conditions  **Permission**: admin")
    favor: Optional[Link] = Field(default=None, description="Mark this project as favorited by the current user  # Conditions  Only present if the project is not yet favorited  Permission**: none but login is required")
    disfavor: Optional[Link] = Field(default=None, description="Mark this project as not favorited by the current user  # Conditions Only present if the project is favorited by the current user  Permission**: none but login is required")
    ...
    types: Optional[Link] = Field(default=None, description="Types available in this project  **Resource**: Collection  # Conditions  **Permission**: view work packages or manage types")
    versions: Optional[Link] = Field(default=None, description="Versions available in this project  **Resource**: Collection  # Conditions  **Permission**: view work packages or manage versions")
    memberships: Optional[Link] = Field(default=None, description="Memberships in the project  **Resource**: Collection  # Conditions  **Permission**: view members")
    work_packages: Optional[Link] = Field(default=None, description="Work Packages of this project  **Resource**: Collection", alias="workPackages")
    parent: Optional[Link] = Field(default=None, description="Parent of the project  **Resource**: Workspace  # Conditions  **Permission** edit workspace")
    status: Optional[Link] = Field(default=None, description="Denotes the status of the project, so whether the project is on track, at risk or is having trouble.  **Resource**: ProjectStatus  # Conditions  **Permission** edit workspace")
    storages: Optional[List[ProjectModelAllOfLinksStorages]] = None
    ...
    ancestors: Optional[List[ProjectModelAllOfLinksAncestors]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storages": [ProjectModelAllOfLinksStorages.from_dict(_item) for _item in obj["storages"]] if obj.get("storages") is not None else None,
            "projectStorages": Link.from_dict(obj["projectStorages"]) if obj.get("projectStorages") is not None else None,
            "ancestors": [ProjectModelAllOfLinksAncestors.from_dict(_item) for _item in obj["ancestors"]] if obj.get("ancestors") is not None else None
        })
        return _obj
