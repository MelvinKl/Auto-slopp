...
class StorageWriteModel(BaseModel):
    """
    StorageWriteModel
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Storage name, if not provided, falls back to a default.")
    ...
    application_password: Optional[StrictStr] = Field(default=None, description="The application password to use for the Nextcloud storage. Ignored if the provider type is not Nextcloud.  If a string is provided, the password is set and automatic management is enabled for the storage. If null is provided, the password is unset and automatic management is disabled for the storage.", alias="applicationPassword")
    ...
    links: Optional[StorageWriteModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["name", "storageAudience", "tokenExchangeScope", "applicationPassword", "forbiddenFileNameCharacters", "_links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if application_password (nullable) is None
        # and model_fields_set contains the field
        if self.application_password is None and "application_password" in self.model_fields_set:
            _dict['applicationPassword'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": StorageWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
