...
class FileLinkCollectionReadModelAllOfLinks(BaseModel):
    """
    FileLinkCollectionReadModelAllOfLinks
    """ # noqa: E501
    var_self: Optional[Link] = Field(default=None, description="This file links collection  **Resource**: FileLinkCollectionReadModel", alias="self")
