...
class ProjectPhaseDefinitionModelLinks(BaseModel):
    """
    ProjectPhaseDefinitionModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This project phase definition.  **Resource**: ProjectPhaseDefinition", alias="self")
