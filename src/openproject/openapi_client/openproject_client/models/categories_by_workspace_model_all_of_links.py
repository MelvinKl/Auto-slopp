...
class CategoriesByWorkspaceModelAllOfLinks(BaseModel):
    """
    CategoriesByWorkspaceModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="The categories collection  **Resource**: CategoriesCollection", alias="self")
