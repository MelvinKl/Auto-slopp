...
class ProjectPhaseModelLinks(BaseModel):
    """
    ProjectPhaseModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This project phase.  **Resource**: ProjectPhase", alias="self")
    definition: Link = Field(description="The definition this phase relies on.  **Resource**: ProjectPhaseDefinition")
    project: Link = Field(description="The project resource, that is the container of this phase.  **Resource**: Project")
    __properties: ClassVar[List[str]] = ["self", "definition", "project"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definition": Link.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
