...
class VersionWriteModelAllOfLinks(BaseModel):
    """
    VersionWriteModelAllOfLinks
    """ # noqa: E501
    defining_project: Optional[Link] = Field(default=None, description="The workspace to which the version belongs  **Resource**: Workspace", alias="definingProject")
    __properties: ClassVar[List[str]] = ["definingProject"]
