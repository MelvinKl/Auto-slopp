...
class ListAvailableParentProjectCandidatesModelAllOfLinks(BaseModel):
    """
    ListAvailableParentProjectCandidatesModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="The project collection  **Resource**: ProjectCollection", alias="self")
