...
class CustomActionModel(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the custom action")
    description: Optional[StrictStr] = Field(default=None, description="The description for the custom action")
    links: Optional[CustomActionModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "name", "description", "_links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CustomAction']):
            raise ValueError("must be one of enum values ('CustomAction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": CustomActionModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
