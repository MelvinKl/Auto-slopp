...
class GroupModelAllOfLinks(BaseModel):
    """
    GroupModelAllOfLinks
    """ # noqa: E501
    var_self: Optional[Link] = Field(default=None, description="This group resource  **Resource**: Group", alias="self")
    members: Optional[List[GroupModelAllOfLinksMembers]] = None
    memberships: Optional[Link] = Field(default=None, description="An collection of all memberships of the group.  **Resource**: MembershipCollection")
    delete: Optional[Link] = Field(default=None, description="An href to delete the group.  # Conditions:  - `admin`")
    update_immediately: Optional[Link] = Field(default=None, description="An href to update the group.  # Conditions:  - `admin`  **Resource**: Group", alias="updateImmediately")
    __properties: ClassVar[List[str]] = ["self", "members", "memberships", "delete", "updateImmediately"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [GroupModelAllOfLinksMembers.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
