...
class NotificationModelEmbedded(BaseModel):
    """
    NotificationModelEmbedded
    """ # noqa: E501
    actor: Optional[UserModel] = None
    project: MembershipReadModelEmbeddedProject
    activity: Optional[ActivityModel] = None
    resource: WorkPackageModel
    __properties: ClassVar[List[str]] = ["actor", "project", "activity", "resource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actor": UserModel.from_dict(obj["actor"]) if obj.get("actor") is not None else None,
            "project": MembershipReadModelEmbeddedProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "activity": ActivityModel.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
            "resource": WorkPackageModel.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
