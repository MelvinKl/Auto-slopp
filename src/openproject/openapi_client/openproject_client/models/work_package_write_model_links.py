...
class WorkPackageWriteModelLinks(BaseModel):
    """
    ...
    type: Optional[Link] = Field(default=None, description="The type of the work package  **Resource**: Type")
    priority: Optional[Link] = Field(default=None, description="The priority of the work package  **Resource**: Priority")
    project: Optional[Link] = Field(default=None, description="The project to which the work package belongs  **Resource**: Project")
    status: Optional[Link] = Field(default=None, description="The current status of the work package  **Resource**: Status")
    ...
    __properties: ClassVar[List[str]] = ["category", "type", "priority", "project", "status", "responsible", "assignee", "version", "parent"]
