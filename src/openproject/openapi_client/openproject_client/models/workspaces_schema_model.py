...
class WorkspacesSchemaModel(BaseModel):
    ...
    links: Optional[WorkspacesSchemaModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "_dependencies", "_attributeGroups", "id", "name", "identifier", "description", "public", "active", "status", "statusExplanation", "parent", "createdAt", "updatedAt", "_links"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of status_explanation
        if self.status_explanation:
            _dict['statusExplanation'] = self.status_explanation.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_attributeGroups": [WorkspacesSchemaModelAttributeGroupsInner.from_dict(_item) for _item in obj["_attributeGroups"]] if obj.get("_attributeGroups") is not None else None,
            "id": SchemaPropertyModel.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "name": SchemaPropertyModel.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "identifier": SchemaPropertyModel.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None,
            "description": SchemaPropertyModel.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "public": SchemaPropertyModel.from_dict(obj["public"]) if obj.get("public") is not None else None,
            "active": SchemaPropertyModel.from_dict(obj["active"]) if obj.get("active") is not None else None,
            "status": SchemaPropertyModel.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "statusExplanation": SchemaPropertyModel.from_dict(obj["statusExplanation"]) if obj.get("statusExplanation") is not None else None,
            ...
            "_links": WorkspacesSchemaModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
