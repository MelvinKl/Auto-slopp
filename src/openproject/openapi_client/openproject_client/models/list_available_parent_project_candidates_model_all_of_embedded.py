...
class ListAvailableParentProjectCandidatesModelAllOfEmbedded(BaseModel):
    """
    ListAvailableParentProjectCandidatesModelAllOfEmbedded
    """ # noqa: E501
    elements: Optional[List[ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements]] = Field(default=None, description="Collection of projects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
