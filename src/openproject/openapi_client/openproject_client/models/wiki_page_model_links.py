...
class WikiPageModelLinks(BaseModel):
    """
    WikiPageModelLinks
    """ # noqa: E501
    add_attachment: Optional[Link] = Field(default=None, description="Attach a file to the wiki page  # Conditions  **Permission**: edit wiki page", alias="addAttachment")
    __properties: ClassVar[List[str]] = ["addAttachment"]
