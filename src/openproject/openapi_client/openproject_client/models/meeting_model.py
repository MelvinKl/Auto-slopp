...
class MeetingModel(BaseModel):
    ...
    MeetingModel
    """ # noqa: E501
    id: Annotated[int, Field(strict=True, gt=0)] = Field(description="Identifier of this meeting")
    title: StrictStr = Field(description="The meeting's title")
    location: Optional[StrictStr] = Field(default=None, description="The meeting's location")
    lock_version: StrictInt = Field(description="The version of the item as used for optimistic locking", alias="lockVersion")
    start_time: datetime = Field(description="The scheduled meeting start time.", alias="startTime")
    end_time: datetime = Field(description="The scheduled meeting start time.", alias="endTime")
    duration: Union[StrictFloat, StrictInt] = Field(description="The meeting duration in minutes.")
    created_at: datetime = Field(description="Time of creation. Can be writable by admins with the `apiv3_write_readonly_attributes` setting enabled.", alias="createdAt")
    updated_at: datetime = Field(description="Time of the most recent change to the meeting.", alias="updatedAt")
    links: Optional[MeetingModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "title", "location", "lockVersion", "startTime", "endTime", "duration", "createdAt", "updatedAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": MeetingModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
