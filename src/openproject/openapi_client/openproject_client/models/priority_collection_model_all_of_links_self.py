...
class PriorityCollectionModelAllOfLinksSelf(BaseModel):
    """
    ...
    var_self: Optional[Link] = Field(default=None, description="This priority collection  **Resource**: PriorityCollectionModel", alias="self")
    __properties: ClassVar[List[str]] = ["href", "title", "templated", "method", "payload", "identifier", "type", "self"]
