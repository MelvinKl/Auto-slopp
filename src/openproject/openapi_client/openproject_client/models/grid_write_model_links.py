...
class GridWriteModelLinks(BaseModel):
    """
    GridWriteModelLinks
    """ # noqa: E501
    scope: Optional[Link] = Field(default=None, description="The location where this grid is used, usually represented as a relative URL.")
