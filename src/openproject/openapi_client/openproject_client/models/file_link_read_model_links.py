...
class FileLinkReadModelLinks(BaseModel):
    """
    FileLinkReadModelLinks
    """ # noqa: E501
    var_self: Optional[Link] = Field(default=None, description="This file link.  **Resource**: FileLink", alias="self")
    storage: Optional[Link] = Field(default=None, description="The storage resource of the linked file.  **Resource**: Storage")
    container: Optional[Link] = Field(default=None, description="The container the origin file is linked to.  Can be one of the following **Resources**:  - WorkPackage")
    creator: Optional[Link] = Field(default=None, description="The creator of the file link.  **Resource**: User")
    delete: Optional[Link] = Field(default=None, description="The uri to delete the file link.  **Resource**: N/A")
    status: Optional[Link] = Field(default=None, description="The urn of the user specific file link status on its storage. Can be one of:  - urn:openproject-org:api:v3:file-links:permission:ViewAllowed - urn:openproject-org:api:v3:file-links:permission:ViewNotAllowed - urn:openproject-org:api:v3:file-links:NotFound - urn:openproject-org:api:v3:file-links:Error  **Resource**: N/A")
    origin_open: Optional[Link] = Field(default=None, description="The uri to open the origin file on the origin itself.  **Resource**: N/A", alias="originOpen")
    static_origin_open: Optional[Link] = Field(default=None, description="A static uri to open the origin file on the storage. Responds with a redirect.  **Resource**: N/A", alias="staticOriginOpen")
    origin_open_location: Optional[Link] = Field(default=None, description="The uri to open the location of origin file on the origin itself.  **Resource**: N/A", alias="originOpenLocation")
    static_origin_open_location: Optional[Link] = Field(default=None, description="A static uri to open the location of the origin file on the storage. Responds with a redirect.  **Resource**: N/A", alias="staticOriginOpenLocation")
    static_origin_download: Optional[Link] = Field(default=None, description="A static uri to generate a new download URL from the storage. Responds with a redirect.  **Resource**: N/A", alias="staticOriginDownload")
    __properties: ClassVar[List[str]] = ["self", "storage", "container", "creator", "delete", "status", "originOpen", "staticOriginOpen", "originOpenLocation", "staticOriginOpenLocation", "staticOriginDownload"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of origin_open
        if self.origin_open:
            _dict['originOpen'] = self.origin_open.to_dict()
        # override the default output from pydantic by calling `to_dict()` of static_origin_open
        if self.static_origin_open:
            _dict['staticOriginOpen'] = self.static_origin_open.to_dict()
        # override the default output from pydantic by calling `to_dict()` of origin_open_location
        if self.origin_open_location:
            _dict['originOpenLocation'] = self.origin_open_location.to_dict()
        # override the default output from pydantic by calling `to_dict()` of static_origin_open_location
        if self.static_origin_open_location:
            _dict['staticOriginOpenLocation'] = self.static_origin_open_location.to_dict()
        # override the default output from pydantic by calling `to_dict()` of static_origin_download
        if self.static_origin_download:
            _dict['staticOriginDownload'] = self.static_origin_download.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storage": Link.from_dict(obj["storage"]) if obj.get("storage") is not None else None,
            "container": Link.from_dict(obj["container"]) if obj.get("container") is not None else None,
            "creator": Link.from_dict(obj["creator"]) if obj.get("creator") is not None else None,
            ...
            "originOpen": Link.from_dict(obj["originOpen"]) if obj.get("originOpen") is not None else None,
            "staticOriginOpen": Link.from_dict(obj["staticOriginOpen"]) if obj.get("staticOriginOpen") is not None else None,
            "originOpenLocation": Link.from_dict(obj["originOpenLocation"]) if obj.get("originOpenLocation") is not None else None,
            "staticOriginOpenLocation": Link.from_dict(obj["staticOriginOpenLocation"]) if obj.get("staticOriginOpenLocation") is not None else None,
            "staticOriginDownload": Link.from_dict(obj["staticOriginDownload"]) if obj.get("staticOriginDownload") is not None else None
        })
        return _obj
