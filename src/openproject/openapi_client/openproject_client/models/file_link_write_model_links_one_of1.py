...
class FileLinkWriteModelLinksOneOf1(BaseModel):
    """
    FileLinkWriteModelLinksOneOf1
    """ # noqa: E501
    storage_url: Link = Field(description="The storage url the file link references to.  **Resource**: N/A", alias="storageUrl")
    __properties: ClassVar[List[str]] = ["storageUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.storage_url:
            _dict['storageUrl'] = self.storage_url.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "storageUrl": Link.from_dict(obj["storageUrl"]) if obj.get("storageUrl") is not None else None
        })
        return _obj
