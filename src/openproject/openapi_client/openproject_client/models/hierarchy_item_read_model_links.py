...
class HierarchyItemReadModelLinks(BaseModel):
    """
    HierarchyItemReadModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This hierarchy item  **Resource**: HierarchyItem", alias="self")
    parent: Optional[Link] = Field(default=None, description="The hierarchy item that is the parent of the current hierarchy item  **Resource**: HierarchyItem")
    children: List[Link]
    branch: Link = Field(description="The branch of the hierarchy item, ordered from root to node.  **Resource**: HierarchyItemCollection")
    __properties: ClassVar[List[str]] = ["self", "parent", "children", "branch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "branch": Link.from_dict(obj["branch"]) if obj.get("branch") is not None else None
        })
        return _obj
