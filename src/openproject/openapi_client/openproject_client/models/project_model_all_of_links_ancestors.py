...
class ProjectModelAllOfLinksAncestors(BaseModel):
    """
    A collection of links to the ancestor workspaces.  **Resource**: Workspace
    """ # noqa: E501
    href: StrictStr = Field(description="URL to the referenced resource (might be relative)")
    title: Optional[StrictStr] = Field(default=None, description="Representative label for the resource")
    templated: Optional[StrictBool] = Field(default=False, description="If true the href contains parts that need to be replaced by the client")
    method: Optional[StrictStr] = Field(default='GET', description="The HTTP verb to use when requesting the resource")
    payload: Optional[Dict[str, Any]] = Field(default=None, description="The payload to send in the request to achieve the desired result")
    identifier: Optional[StrictStr] = Field(default=None, description="An optional unique identifier to the link object")
    type: Optional[StrictStr] = Field(default=None, description="The MIME-Type of the returned resource.")
    __properties: ClassVar[List[str]] = ["href", "title", "templated", "method", "payload", "identifier", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectModelAllOfLinksAncestors from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectModelAllOfLinksAncestors from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "href": obj.get("href"),
            "title": obj.get("title"),
            "templated": obj.get("templated") if obj.get("templated") is not None else False,
