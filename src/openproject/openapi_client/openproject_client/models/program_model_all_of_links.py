...
class ProgramModelAllOfLinks(BaseModel):
    """
    ProgramModelAllOfLinks
    """ # noqa: E501
    update: Optional[Link] = Field(default=None, description="Form endpoint that aids in updating this program  # Conditions  **Permission**: edit workspace")
    update_immediately: Optional[Link] = Field(default=None, description="Directly update this program  # Conditions  **Permission**: edit workspace", alias="updateImmediately")
    delete: Optional[Link] = Field(default=None, description="Delete this program  # Conditions  **Permission**: admin")
    favor: Optional[Link] = Field(default=None, description="Mark this program as favorited by the current user  # Conditions  Only present if the program is not yet favorited  Permission**: none but login is required")
    disfavor: Optional[Link] = Field(default=None, description="Mark this program as not favorited by the current user  # Conditions Only present if the program is favorited by the current user  Permission**: none but login is required")
    ...
    create_work_package_immediately: Optional[Link] = Field(default=None, description="Directly creates a work package in the program  # Conditions  **Permission**: add work packages", alias="createWorkPackageImmediately")
    var_self: Link = Field(description="This program  **Resource**: Program", alias="self")
    categories: Link = Field(description="Categories available in this program  **Resource**: Collection")
    types: Optional[Link] = Field(default=None, description="Types available in this program  **Resource**: Collection  # Conditions  **Permission**: view work packages or manage types")
    versions: Optional[Link] = Field(default=None, description="Versions available in this program  **Resource**: Collection  # Conditions  **Permission**: view work packages or manage versions")
    memberships: Optional[Link] = Field(default=None, description="Memberships in the  program  **Resource**: Collection  # Conditions  **Permission**: view members")
    work_packages: Optional[Link] = Field(default=None, description="Work Packages of this program  **Resource**: Collection", alias="workPackages")
    parent: Optional[Link] = Field(default=None, description="Parent of the program  **Resource**: Program  # Conditions  **Permission** edit workspace")
    status: Optional[Link] = Field(default=None, description="Denotes the status of the program, so whether the program is on track, at risk or is having trouble.  **Resource**: ProjectStatus  # Conditions  **Permission** edit workspace")
    storages: Optional[List[ProgramModelAllOfLinksStorages]] = None
    project_storages: Optional[Link] = Field(default=None, description="The project storage collection of this program.  **Resource**: Collection  # Conditions  **Permission**: view_file_links", alias="projectStorages")
    ancestors: Optional[List[ProgramModelAllOfLinksAncestors]] = None
    __properties: ClassVar[List[str]] = ["update", "updateImmediately", "delete", "favor", "disfavor", "createWorkPackage", "createWorkPackageImmediately", "self", "categories", "types", "versions", "memberships", "workPackages", "parent", "status", "storages", "projectStorages", "ancestors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of favor
        if self.favor:
            _dict['favor'] = self.favor.to_dict()
        # override the default output from pydantic by calling `to_dict()` of disfavor
        if self.disfavor:
            _dict['disfavor'] = self.disfavor.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "favor": Link.from_dict(obj["favor"]) if obj.get("favor") is not None else None,
            "disfavor": Link.from_dict(obj["disfavor"]) if obj.get("disfavor") is not None else None,
            ...
            "storages": [ProgramModelAllOfLinksStorages.from_dict(_item) for _item in obj["storages"]] if obj.get("storages") is not None else None,
            "projectStorages": Link.from_dict(obj["projectStorages"]) if obj.get("projectStorages") is not None else None,
            "ancestors": [ProgramModelAllOfLinksAncestors.from_dict(_item) for _item in obj["ancestors"]] if obj.get("ancestors") is not None else None
        })
        return _obj
