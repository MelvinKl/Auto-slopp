...
class QueryFilterInstanceModel(BaseModel):
    """
    QueryFilterInstanceModel
    """ # noqa: E501
    links: QueryFilterInstanceModelLinks = Field(alias="_links")
    type: StrictStr = Field(alias="_type")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["_links", "_type", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": QueryFilterInstanceModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_type": obj.get("_type"),
            "name": obj.get("name")
        })
        return _obj
