...
class StorageFileModelAllOfLinks(BaseModel):
    """
    StorageFileModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="Not provided  **Resource**: urn:openproject-org:api:v3:storages:storage_file:no_link_provided", alias="self")
