...
class DocumentModelLinks(BaseModel):
    """
    DocumentModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This document  **Resource**: Document", alias="self")
    project: Link = Field(description="The project the document is in  **Resource**: Project")
    attachments: Link = Field(description="The attachments belonging to the document  **Resource**: []Attachment")
    __properties: ClassVar[List[str]] = ["self", "project", "attachments"]
