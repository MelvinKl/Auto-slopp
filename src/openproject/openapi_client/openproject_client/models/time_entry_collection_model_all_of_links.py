...
class TimeEntryCollectionModelAllOfLinks(BaseModel):
    """
    TimeEntryCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This time entry collection  **Resource**: TimeEntryCollectionModel", alias="self")
