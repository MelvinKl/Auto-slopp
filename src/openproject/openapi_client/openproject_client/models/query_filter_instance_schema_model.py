...
class QueryFilterInstanceSchemaModel(BaseModel):
    """
    QueryFilterInstanceSchemaModel
    """ # noqa: E501
    name: StrictStr = Field(description="Describes the name attribute")
    links: QueryFilterInstanceSchemaModelLinks = Field(alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "_links": QueryFilterInstanceSchemaModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
