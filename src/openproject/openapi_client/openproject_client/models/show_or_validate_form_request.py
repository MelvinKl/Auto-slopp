...
class ShowOrValidateFormRequest(BaseModel):
    """
    ShowOrValidateFormRequest
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    lock_version: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="lockVersion")
    subject: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_type", "lockVersion", "subject"]
