...
class TimeEntryActivityModelEmbedded(BaseModel):
    """
    TimeEntryActivityModelEmbedded
    """ # noqa: E501
    projects: List[MembershipReadModelEmbeddedProject]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projects": [MembershipReadModelEmbeddedProject.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
