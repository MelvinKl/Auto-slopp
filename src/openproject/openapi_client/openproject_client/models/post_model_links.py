...
class PostModelLinks(BaseModel):
    """
    PostModelLinks
    """ # noqa: E501
    add_attachment: Optional[Link] = Field(default=None, description="Attach a file to the post  # Conditions  **Permission**: edit messages", alias="addAttachment")
