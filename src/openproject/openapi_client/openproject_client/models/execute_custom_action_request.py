...
class ExecuteCustomActionRequest(BaseModel):
    """
    ExecuteCustomActionRequest
    """ # noqa: E501
    links: Optional[ExecuteCustomActionRequestLinks] = Field(default=None, alias="_links")
    lock_version: Optional[StrictStr] = Field(default=None, alias="lockVersion")
    __properties: ClassVar[List[str]] = ["_links", "lockVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": ExecuteCustomActionRequestLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
