...
class ProjectConfigurationModel(BaseModel):
    ...
    """ # noqa: E501
    maximum_attachment_file_size: Optional[StrictInt] = Field(default=None, description="The maximum allowed size of an attachment in Bytes", alias="maximumAttachmentFileSize")
    host_name: Optional[StrictStr] = Field(default=None, description="The host name configured for the system", alias="hostName")
    per_page_options: Optional[List[StrictInt]] = Field(default=None, description="Page size steps to be offered in paginated list UI", alias="perPageOptions")
    duration_format: Optional[StrictStr] = Field(default=None, description="The format used to display Work, Remaining Work, and Spent time durations", alias="durationFormat")
    active_feature_flags: Optional[List[StrictStr]] = Field(default=None, description="The list of all feature flags that are active", alias="activeFeatureFlags")
    enabled_internal_comments: Optional[StrictBool] = Field(default=None, description="Whether internal comments are enabled for this project", alias="enabledInternalComments")
    __properties: ClassVar[List[str]] = ["maximumAttachmentFileSize", "hostName", "perPageOptions", "durationFormat", "activeFeatureFlags", "enabledInternalComments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maximumAttachmentFileSize": obj.get("maximumAttachmentFileSize"),
            "hostName": obj.get("hostName"),
            "perPageOptions": obj.get("perPageOptions"),
            "durationFormat": obj.get("durationFormat"),
            "activeFeatureFlags": obj.get("activeFeatureFlags"),
            "enabledInternalComments": obj.get("enabledInternalComments")
        })
        return _obj
