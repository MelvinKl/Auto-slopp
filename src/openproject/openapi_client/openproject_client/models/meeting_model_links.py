...
class MeetingModelLinks(BaseModel):
    """
    MeetingModelLinks
    """ # noqa: E501
    var_self: Optional[Link] = Field(default=None, description="This meeting  **Resource**: Meeting", alias="self")
    author: Optional[Link] = Field(default=None, description="The user having created the meeting  **Resource**: User")
    project: Optional[Link] = Field(default=None, description="The project the meeting is in  **Resource**: Project")
    ...
    add_attachment: Optional[Link] = Field(default=None, description="Attach a file to the meeting  # Conditions  **Permission**: edit meeting", alias="addAttachment")
    __properties: ClassVar[List[str]] = ["self", "author", "project", "attachments", "addAttachment"]
