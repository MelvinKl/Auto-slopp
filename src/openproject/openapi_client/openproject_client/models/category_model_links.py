...
class CategoryModelLinks(BaseModel):
    """
    CategoryModelLinks
    """ # noqa: E501
    var_self: Link = Field(description="This category  **Resource**: Category", alias="self")
    project: Link = Field(description="The project of this category  **Resource**: Project")
    default_assignee: Optional[Link] = Field(default=None, description="Default assignee for work packages of this category  **Resource**: User", alias="defaultAssignee")
    __properties: ClassVar[List[str]] = ["self", "project", "defaultAssignee"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of default_assignee
        if self.default_assignee:
            _dict['defaultAssignee'] = self.default_assignee.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultAssignee": Link.from_dict(obj["defaultAssignee"]) if obj.get("defaultAssignee") is not None else None
        })
        return _obj
