...
class StorageCollectionModelAllOfLinks(BaseModel):
    """
    StorageCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: Link = Field(description="This storage collection  **Resource**: StorageCollectionReadModel", alias="self")
