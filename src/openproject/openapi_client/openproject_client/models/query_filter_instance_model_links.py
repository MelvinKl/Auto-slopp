...
class QueryFilterInstanceModelLinks(BaseModel):
    """
    QueryFilterInstanceModelLinks
    """ # noqa: E501
    filter: Link
    var_schema: Link = Field(alias="schema")
    operator: Optional[Link] = None
    __properties: ClassVar[List[str]] = ["filter", "schema", "operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operator": Link.from_dict(obj["operator"]) if obj.get("operator") is not None else None
        })
        return _obj
