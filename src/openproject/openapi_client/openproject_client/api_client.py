...
from openproject_client.configuration import Configuration
from openproject_client.api_response import ApiResponse, T as ApiResponseT
import openproject_client.models
from openproject_client import rest
from openproject_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openproject_client.models, klass)
