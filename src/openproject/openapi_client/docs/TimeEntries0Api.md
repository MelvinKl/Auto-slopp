# openproject_client.TimeEntriesApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.TimeEntriesApi(api_client)
    time_entry_model = openproject_client.TimeEntryModel() # TimeEntryModel |  (optional)
