# openproject_client.UserPreferencesApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.UserPreferencesApi(api_client)
...
with openproject_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openproject_client.UserPreferencesApi(api_client)
    update_user_preferences_request = openproject_client.UpdateUserPreferencesRequest() # UpdateUserPreferencesRequest |  (optional)
