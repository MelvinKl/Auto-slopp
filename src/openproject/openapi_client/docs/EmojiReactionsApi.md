# openproject_client.EmojiReactionsApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.EmojiReactionsApi(api_client)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    toggle_activity_emoji_reaction_request = openproject_client.ToggleActivityEmojiReactionRequest() # ToggleActivityEmojiReactionRequest | 
