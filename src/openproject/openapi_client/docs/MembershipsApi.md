# openproject_client.MembershipsApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.MembershipsApi(api_client)
    membership_write_model = openproject_client.MembershipWriteModel() # MembershipWriteModel |  (optional)
