...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.QueriesApi(api_client)
...
with openproject_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openproject_client.QueriesApi(api_client)
    query_create_form = openproject_client.QueryCreateForm() # QueryCreateForm |  (optional)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.QueriesApi(api_client)
    id = 1 # int | Query id
    query_update_form = openproject_client.QueryUpdateForm() # QueryUpdateForm |  (optional)
