...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    storage_write_model = openproject_client.StorageWriteModel() # StorageWriteModel |  (optional)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    storage_folder_write_model = openproject_client.StorageFolderWriteModel() # StorageFolderWriteModel |  (optional)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.FileLinksApi(api_client)
    id = 1337 # int | Storage id
    o_auth_client_credentials_write_model = openproject_client.OAuthClientCredentialsWriteModel() # OAuthClientCredentialsWriteModel |  (optional)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.FileLinksApi(api_client)
    id = 1337 # int | Storage id
    storage_file_upload_preparation_model = openproject_client.StorageFileUploadPreparationModel() # StorageFileUploadPreparationModel |  (optional)
