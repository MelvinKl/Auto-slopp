...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.FormsApi(api_client)
    show_or_validate_form_request = openproject_client.ShowOrValidateFormRequest() # ShowOrValidateFormRequest |  (optional)
