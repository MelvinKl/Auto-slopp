# openproject_client.ProjectsApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.ProjectsApi(api_client)
    project_model = openproject_client.ProjectModel() # ProjectModel |  (optional)
