# openproject_client.VersionsApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.VersionsApi(api_client)
...
with openproject_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openproject_client.VersionsApi(api_client)
    version_write_model = openproject_client.VersionWriteModel() # VersionWriteModel |  (optional)
