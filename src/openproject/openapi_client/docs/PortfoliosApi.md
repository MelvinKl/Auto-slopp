# openproject_client.PortfoliosApi
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.PortfoliosApi(api_client)
...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.PortfoliosApi(api_client)
    id = 1 # int | Portfolio id
    portfolio_model = openproject_client.PortfolioModel() # PortfolioModel |  (optional)
