...
with openproject_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openproject_client.GroupsApi(api_client)
    group_write_model = openproject_client.GroupWriteModel() # GroupWriteModel |  (optional)
