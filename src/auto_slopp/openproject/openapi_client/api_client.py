...
from auto_slopp.openproject.openapi_client.configuration import Configuration
from auto_slopp.openproject.openapi_client.api_response import ApiResponse, T as ApiResponseT
import auto_slopp.openproject.openapi_client.models
from auto_slopp.openproject.openapi_client import rest
from auto_slopp.openproject.openapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(auto_slopp.openproject.openapi_client.models, klass)
