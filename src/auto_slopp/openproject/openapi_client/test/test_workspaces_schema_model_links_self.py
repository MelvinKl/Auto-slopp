...
class TestWorkspacesSchemaModelLinksSelf(unittest.TestCase):
    """WorkspacesSchemaModelLinksSelf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspacesSchemaModelLinksSelf:
        """Test WorkspacesSchemaModelLinksSelf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspacesSchemaModelLinksSelf`
        """
        model = WorkspacesSchemaModelLinksSelf()
        if include_optional:
            return WorkspacesSchemaModelLinksSelf(
    ...
    def testWorkspacesSchemaModelLinksSelf(self):
        """Test WorkspacesSchemaModelLinksSelf"""
