...
class TestMembershipReadModelEmbeddedPrincipal(unittest.TestCase):
    """MembershipReadModelEmbeddedPrincipal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipReadModelEmbeddedPrincipal:
        """Test MembershipReadModelEmbeddedPrincipal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipReadModelEmbeddedPrincipal`
        """
        model = MembershipReadModelEmbeddedPrincipal()
        if include_optional:
            return MembershipReadModelEmbeddedPrincipal(
                ...
                links = auto_slopp.openproject.openapi_client.models.group_model_all_of__links.GroupModel_allOf__links(
                    self = null, 
                    members = [
                        null
                        ], 
                ...
                language = '',
                identity_url = '',
                embedded = auto_slopp.openproject.openapi_client.models.group_model_all_of__embedded.GroupModel_allOf__embedded(
                    members = [
                        null
                        ], )
            )
    ...
    def testMembershipReadModelEmbeddedPrincipal(self):
        """Test MembershipReadModelEmbeddedPrincipal"""
