...
class TestListAvailableParentProjectCandidatesModelAllOfEmbedded(unittest.TestCase):
    """ListAvailableParentProjectCandidatesModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAvailableParentProjectCandidatesModelAllOfEmbedded:
        """Test ListAvailableParentProjectCandidatesModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAvailableParentProjectCandidatesModelAllOfEmbedded`
        """
        model = ListAvailableParentProjectCandidatesModelAllOfEmbedded()
        if include_optional:
    ...
    def testListAvailableParentProjectCandidatesModelAllOfEmbedded(self):
        """Test ListAvailableParentProjectCandidatesModelAllOfEmbedded"""
