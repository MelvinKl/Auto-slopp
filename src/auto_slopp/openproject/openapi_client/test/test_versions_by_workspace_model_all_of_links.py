...
class TestVersionsByWorkspaceModelAllOfLinks(unittest.TestCase):
    """VersionsByWorkspaceModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionsByWorkspaceModelAllOfLinks:
        """Test VersionsByWorkspaceModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionsByWorkspaceModelAllOfLinks`
        """
        model = VersionsByWorkspaceModelAllOfLinks()
        if include_optional:
            return VersionsByWorkspaceModelAllOfLinks(
    ...
    def testVersionsByWorkspaceModelAllOfLinks(self):
        """Test VersionsByWorkspaceModelAllOfLinks"""
