...
class TestWorkPackageModelAllOfLinksCustomActions(unittest.TestCase):
    """WorkPackageModelAllOfLinksCustomActions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageModelAllOfLinksCustomActions:
        """Test WorkPackageModelAllOfLinksCustomActions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageModelAllOfLinksCustomActions`
        """
        model = WorkPackageModelAllOfLinksCustomActions()
        if include_optional:
            return WorkPackageModelAllOfLinksCustomActions(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testWorkPackageModelAllOfLinksCustomActions(self):
        """Test WorkPackageModelAllOfLinksCustomActions"""
