...
class TestPlaceholderUserCollectionModelAllOfEmbedded(unittest.TestCase):
    """PlaceholderUserCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserCollectionModelAllOfEmbedded:
        """Test PlaceholderUserCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserCollectionModelAllOfEmbedded`
        """
        model = PlaceholderUserCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testPlaceholderUserCollectionModelAllOfEmbedded(self):
        """Test PlaceholderUserCollectionModelAllOfEmbedded"""
