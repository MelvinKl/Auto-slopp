...
class TestVersionsByWorkspaceModel(unittest.TestCase):
    """VersionsByWorkspaceModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionsByWorkspaceModel:
        """Test VersionsByWorkspaceModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionsByWorkspaceModel`
        """
        model = VersionsByWorkspaceModel()
        if include_optional:
            return VersionsByWorkspaceModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.versions_by_workspace_model_all_of__links.Versions_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.versions_by_workspace_model_all_of__embedded.Versions_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testVersionsByWorkspaceModel(self):
        """Test VersionsByWorkspaceModel"""
