...
class TestVersionReadModelAllOfLinks(unittest.TestCase):
    """VersionReadModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionReadModelAllOfLinks:
        """Test VersionReadModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionReadModelAllOfLinks`
        """
        model = VersionReadModelAllOfLinks()
        if include_optional:
            return VersionReadModelAllOfLinks(
                ...
                defining_project = {href=/api/v3/work_packages, method=POST},
                available_in_projects = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return VersionReadModelAllOfLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testVersionReadModelAllOfLinks(self):
        """Test VersionReadModelAllOfLinks"""
