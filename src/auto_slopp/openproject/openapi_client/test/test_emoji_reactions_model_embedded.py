...
class TestEmojiReactionsModelEmbedded(unittest.TestCase):
    """EmojiReactionsModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiReactionsModelEmbedded:
        """Test EmojiReactionsModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiReactionsModelEmbedded`
        """
        model = EmojiReactionsModelEmbedded()
        if include_optional:
            return EmojiReactionsModelEmbedded(
                elements = [
    ...
    def testEmojiReactionsModelEmbedded(self):
        """Test EmojiReactionsModelEmbedded"""
