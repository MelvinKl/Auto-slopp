...
class TestTimeEntriesApi(unittest.TestCase):
    ...
    def test_available_projects_for_time_entries(self) -> None:
        """Test case for available_projects_for_time_entries

        Available projects for time entries
        """
        pass

    def test_time_entry_create_form(self) -> None:
        """Test case for time_entry_create_form

        Time entry create form
        """
        pass

    def test_time_entry_update_form(self) -> None:
        """Test case for time_entry_update_form
    ...
    def test_view_time_entry_schema(self) -> None:
        """Test case for view_time_entry_schema
