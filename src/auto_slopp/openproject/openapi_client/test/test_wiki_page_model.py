...
class TestWikiPageModel(unittest.TestCase):
    """WikiPageModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WikiPageModel:
        """Test WikiPageModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WikiPageModel`
        """
        model = WikiPageModel()
        if include_optional:
            return WikiPageModel(
                id = 0,
                title = '',
                links = auto_slopp.openproject.openapi_client.models.wiki_page_model__links.Wiki_PageModel__links(
                    add_attachment = null, )
            )
        else:
            return WikiPageModel(
