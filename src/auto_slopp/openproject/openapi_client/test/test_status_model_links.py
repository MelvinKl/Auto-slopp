...
class TestStatusModelLinks(unittest.TestCase):
    """StatusModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusModelLinks:
        """Test StatusModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusModelLinks`
        """
        model = StatusModelLinks()
        if include_optional:
