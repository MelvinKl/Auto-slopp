...
class TestPriorityCollectionModelAllOfLinksSelf(unittest.TestCase):
    """PriorityCollectionModelAllOfLinksSelf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityCollectionModelAllOfLinksSelf:
        """Test PriorityCollectionModelAllOfLinksSelf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityCollectionModelAllOfLinksSelf`
        """
        model = PriorityCollectionModelAllOfLinksSelf()
        if include_optional:
    ...
    def testPriorityCollectionModelAllOfLinksSelf(self):
        """Test PriorityCollectionModelAllOfLinksSelf"""
