...
class TestQueriesApi(unittest.TestCase):
    ...
    def test_available_projects_for_query(self) -> None:
        """Test case for available_projects_for_query
    ...
    def test_query_create_form(self) -> None:
        """Test case for query_create_form

        Query Create Form
        """
        pass

    def test_query_update_form(self) -> None:
        """Test case for query_update_form
    ...
    def test_view_default_query(self) -> None:
        """Test case for view_default_query

        View default query
        """
        pass

    def test_view_default_query_for_project(self) -> None:
        """Test case for view_default_query_for_project

        View default query for project
        """
        pass

    def test_view_default_query_for_workspace(self) -> None:
        """Test case for view_default_query_for_workspace
    ...
    def test_view_query(self) -> None:
        """Test case for view_query

        View query
        """
        pass

    def test_view_schema_for_global_queries(self) -> None:
        """Test case for view_schema_for_global_queries

        View schema for global queries
        """
        pass

    def test_view_schema_for_project_queries(self) -> None:
        """Test case for view_schema_for_project_queries

        View schema for project queries
        """
        pass

    def test_view_schema_for_workspace_queries(self) -> None:
        """Test case for view_schema_for_workspace_queries
