...
class TestHierarchyItemCollectionModelAllOfLinks(unittest.TestCase):
    """HierarchyItemCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyItemCollectionModelAllOfLinks:
        """Test HierarchyItemCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyItemCollectionModelAllOfLinks`
        """
        model = HierarchyItemCollectionModelAllOfLinks()
        if include_optional:
            return HierarchyItemCollectionModelAllOfLinks(
    ...
    def testHierarchyItemCollectionModelAllOfLinks(self):
        """Test HierarchyItemCollectionModelAllOfLinks"""
