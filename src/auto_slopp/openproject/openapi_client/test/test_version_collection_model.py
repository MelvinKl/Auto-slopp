    ...
    def make_instance(self, include_optional) -> VersionCollectionModel:
        ...
        if include_optional:
            return VersionCollectionModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.version_collection_model_all_of__links.VersionCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.version_collection_model_all_of__embedded.VersionCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
