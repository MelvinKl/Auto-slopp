...
class TestListReminders200Response(unittest.TestCase):
    """ListReminders200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListReminders200Response:
        """Test ListReminders200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListReminders200Response`
        """
        model = ListReminders200Response()
        if include_optional:
            return ListReminders200Response(
                type = 'Collection',
                total = 0,
                count = 0,
                embedded = auto_slopp.openproject.openapi_client.models.list_reminders_200_response__embedded.list_reminders_200_response__embedded(
                    elements = [
    ...
    def testListReminders200Response(self):
        """Test ListReminders200Response"""
