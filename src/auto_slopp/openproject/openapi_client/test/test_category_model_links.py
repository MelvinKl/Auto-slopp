...
class TestCategoryModelLinks(unittest.TestCase):
    """CategoryModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryModelLinks:
        """Test CategoryModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryModelLinks`
        """
        model = CategoryModelLinks()
        if include_optional:
            return CategoryModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                project = {href=/api/v3/work_packages, method=POST},
                default_assignee = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return CategoryModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testCategoryModelLinks(self):
        """Test CategoryModelLinks"""
