...
class TestPortfolioModelAllOfLinksAncestors(unittest.TestCase):
    """PortfolioModelAllOfLinksAncestors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioModelAllOfLinksAncestors:
        """Test PortfolioModelAllOfLinksAncestors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioModelAllOfLinksAncestors`
        """
        model = PortfolioModelAllOfLinksAncestors()
        if include_optional:
            return PortfolioModelAllOfLinksAncestors(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testPortfolioModelAllOfLinksAncestors(self):
        """Test PortfolioModelAllOfLinksAncestors"""
