...
class TestQueryFilterInstanceSchemaApi(unittest.TestCase):
    """QueryFilterInstanceSchemaApi unit test stubs"""

    def setUp(self) -> None:
        self.api = QueryFilterInstanceSchemaApi()

    def tearDown(self) -> None:
        pass

    def test_list_query_filter_instance_schemas(self) -> None:
        """Test case for list_query_filter_instance_schemas

        List Query Filter Instance Schemas
        """
        pass

    def test_list_query_filter_instance_schemas_for_project(self) -> None:
        """Test case for list_query_filter_instance_schemas_for_project

        List Query Filter Instance Schemas for Project
        """
        pass

    def test_list_query_filter_instance_schemas_for_workspace(self) -> None:
        """Test case for list_query_filter_instance_schemas_for_workspace

        List Query Filter Instance Schemas for Workspace
        """
        pass

    def test_view_query_filter_instance_schema(self) -> None:
        """Test case for view_query_filter_instance_schema
