...
class TestPaginatedCollectionModel(unittest.TestCase):
    """PaginatedCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedCollectionModel:
        """Test PaginatedCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedCollectionModel`
        """
        model = PaginatedCollectionModel()
        if include_optional:
    ...
    def testPaginatedCollectionModel(self):
        """Test PaginatedCollectionModel"""
