...
class TestProjectPhaseDefinitionModelLinks(unittest.TestCase):
    """ProjectPhaseDefinitionModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseDefinitionModelLinks:
        """Test ProjectPhaseDefinitionModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseDefinitionModelLinks`
        """
        model = ProjectPhaseDefinitionModelLinks()
        if include_optional:
            return ProjectPhaseDefinitionModelLinks(
    ...
    def testProjectPhaseDefinitionModelLinks(self):
        """Test ProjectPhaseDefinitionModelLinks"""
