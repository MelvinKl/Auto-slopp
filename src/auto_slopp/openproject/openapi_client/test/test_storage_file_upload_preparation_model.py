...
class TestStorageFileUploadPreparationModel(unittest.TestCase):
    """StorageFileUploadPreparationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFileUploadPreparationModel:
        """Test StorageFileUploadPreparationModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFileUploadPreparationModel`
        """
        model = StorageFileUploadPreparationModel()
        if include_optional:
    ...
    def testStorageFileUploadPreparationModel(self):
        """Test StorageFileUploadPreparationModel"""
