...
class TestReminderModelLinks(unittest.TestCase):
    """ReminderModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderModelLinks:
        """Test ReminderModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderModelLinks`
        """
        model = ReminderModelLinks()
        if include_optional:
            return ReminderModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                creator = {href=/api/v3/work_packages, method=POST},
                remindable = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return ReminderModelLinks(
                creator = {href=/api/v3/work_packages, method=POST},
    ...
    def testReminderModelLinks(self):
        """Test ReminderModelLinks"""
