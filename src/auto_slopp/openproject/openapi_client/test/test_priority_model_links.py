...
class TestPriorityModelLinks(unittest.TestCase):
    """PriorityModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityModelLinks:
        """Test PriorityModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityModelLinks`
        """
        model = PriorityModelLinks()
        if include_optional:
    ...
    def testPriorityModelLinks(self):
        """Test PriorityModelLinks"""
