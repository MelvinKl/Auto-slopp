...
class TestCategoriesByWorkspaceModelAllOfEmbeddedElements(unittest.TestCase):
    """CategoriesByWorkspaceModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoriesByWorkspaceModelAllOfEmbeddedElements:
        """Test CategoriesByWorkspaceModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoriesByWorkspaceModelAllOfEmbeddedElements`
        """
        model = CategoriesByWorkspaceModelAllOfEmbeddedElements()
        if include_optional:
            return CategoriesByWorkspaceModelAllOfEmbeddedElements(
                id = 0,
                name = '',
                links = auto_slopp.openproject.openapi_client.models.category_model__links.CategoryModel__links(
                    self = null, 
                    project = null, 
    ...
    def testCategoriesByWorkspaceModelAllOfEmbeddedElements(self):
        """Test CategoriesByWorkspaceModelAllOfEmbeddedElements"""
