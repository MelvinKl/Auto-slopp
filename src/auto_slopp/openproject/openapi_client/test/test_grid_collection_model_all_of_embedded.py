...
class TestGridCollectionModelAllOfEmbedded(unittest.TestCase):
    """GridCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridCollectionModelAllOfEmbedded:
        """Test GridCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridCollectionModelAllOfEmbedded`
        """
        model = GridCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testGridCollectionModelAllOfEmbedded(self):
        """Test GridCollectionModelAllOfEmbedded"""
