    ...
    def make_instance(self, include_optional) -> QueryModel:
        ...
        if include_optional:
            return QueryModel(
                ...
                name = '',
                filters = [
                    auto_slopp.openproject.openapi_client.models.query_filter_instance_model.Query_Filter_Instance_Model(
                        _links = auto_slopp.openproject.openapi_client.models.query_filter_instance_model__links.Query_Filter_Instance_Model__links(
                ...
                links = auto_slopp.openproject.openapi_client.models.query_model__links.QueryModel__links(
                    star = null, 
                    unstar = null, 
                    update = null, 
