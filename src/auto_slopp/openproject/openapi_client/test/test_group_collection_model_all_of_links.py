...
class TestGroupCollectionModelAllOfLinks(unittest.TestCase):
    """GroupCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCollectionModelAllOfLinks:
        """Test GroupCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCollectionModelAllOfLinks`
        """
        model = GroupCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testGroupCollectionModelAllOfLinks(self):
        """Test GroupCollectionModelAllOfLinks"""
