...
class TestSchemaPropertyModel(unittest.TestCase):
    """SchemaPropertyModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaPropertyModel:
        """Test SchemaPropertyModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemaPropertyModel`
        """
        ...
        if include_optional:
            return SchemaPropertyModel(
                ...
                location = '',
                placeholder = '',
                links = auto_slopp.openproject.openapi_client.models._links._links()
            )
        else:
            return SchemaPropertyModel(
                type = '',
    ...
    def testSchemaPropertyModel(self):
        """Test SchemaPropertyModel"""
