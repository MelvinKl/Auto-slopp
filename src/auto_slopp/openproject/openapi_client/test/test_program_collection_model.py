...
class TestProgramCollectionModel(unittest.TestCase):
    """ProgramCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramCollectionModel:
        """Test ProgramCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramCollectionModel`
        """
        model = ProgramCollectionModel()
        if include_optional:
            return ProgramCollectionModel(
                ...
                page_size = 0,
                offset = 0,
                embedded = auto_slopp.openproject.openapi_client.models.program_collection_model_all_of__embedded.ProgramCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testProgramCollectionModel(self):
        """Test ProgramCollectionModel"""
