...
class TestDefaultApi(unittest.TestCase):
    ...
    def test_get_custom_field_item(self) -> None:
        """Test case for get_custom_field_item

        Get a custom field hierarchy item
        """
        pass

    def test_get_custom_field_item_branch(self) -> None:
        """Test case for get_custom_field_item_branch

        Get a custom field hierarchy item's branch
        """
        pass

    def test_get_custom_field_items(self) -> None:
        """Test case for get_custom_field_items
