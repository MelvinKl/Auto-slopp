...
class TestTimeEntryCollectionModelAllOfEmbedded(unittest.TestCase):
    """TimeEntryCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryCollectionModelAllOfEmbedded:
        """Test TimeEntryCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryCollectionModelAllOfEmbedded`
        """
        model = TimeEntryCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testTimeEntryCollectionModelAllOfEmbedded(self):
        """Test TimeEntryCollectionModelAllOfEmbedded"""
