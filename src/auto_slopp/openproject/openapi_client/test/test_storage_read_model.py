    ...
    def make_instance(self, include_optional) -> StorageReadModel:
        ...
        if include_optional:
            return StorageReadModel(
                ...
                configured = True,
                embedded = auto_slopp.openproject.openapi_client.models.storage_read_model__embedded.StorageReadModel__embedded(
                ...
                links = auto_slopp.openproject.openapi_client.models.storage_read_model__links.StorageReadModel__links(
                    self = null, 
                    type = null, 
