...
class TestWorkPackageModel(unittest.TestCase):
    """WorkPackageModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageModel:
        """Test WorkPackageModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageModel`
        """
        ...
        if include_optional:
            return WorkPackageModel(
                ...
                derived_start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                derived_due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                duration = '',
                estimated_time = '',
                ...
                spent_time = '',
                percentage_done = 0,
                derived_percentage_done = 0,
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = auto_slopp.openproject.openapi_client.models.work_package_model_all_of__links.WorkPackageModel_allOf__links(
                    add_comment = null, 
                    add_relation = null, 
                    add_watcher = null, 
                    custom_actions = [
                    ...
                    attachments = null, 
                    add_attachment = null, 
                    prepare_attachment = null, 
                    author = null, 
                    assignee = null, 
                    available_watchers = null, 
                    budget = null, 
                    category = null, 
                    children = [
                        null
