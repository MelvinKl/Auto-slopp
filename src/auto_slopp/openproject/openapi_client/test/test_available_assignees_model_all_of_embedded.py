...
class TestAvailableAssigneesModelAllOfEmbedded(unittest.TestCase):
    """AvailableAssigneesModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableAssigneesModelAllOfEmbedded:
        """Test AvailableAssigneesModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableAssigneesModelAllOfEmbedded`
        """
        model = AvailableAssigneesModelAllOfEmbedded()
        if include_optional:
    ...
    def testAvailableAssigneesModelAllOfEmbedded(self):
        """Test AvailableAssigneesModelAllOfEmbedded"""
