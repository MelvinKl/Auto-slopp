...
class TestWorkspacesSchemaModelLinks(unittest.TestCase):
    """WorkspacesSchemaModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspacesSchemaModelLinks:
        """Test WorkspacesSchemaModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspacesSchemaModelLinks`
        """
        model = WorkspacesSchemaModelLinks()
        if include_optional:
            return WorkspacesSchemaModelLinks(
                var_self = auto_slopp.openproject.openapi_client.models.workspaces_schema_model__links_self.Workspaces_schemaModel__links_self(
    ...
    def testWorkspacesSchemaModelLinks(self):
        """Test WorkspacesSchemaModelLinks"""
