...
class TestQueryFilterInstanceSchemaModel(unittest.TestCase):
    """QueryFilterInstanceSchemaModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFilterInstanceSchemaModel:
        """Test QueryFilterInstanceSchemaModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFilterInstanceSchemaModel`
        """
        model = QueryFilterInstanceSchemaModel()
        if include_optional:
            return QueryFilterInstanceSchemaModel(
                name = '',
                links = auto_slopp.openproject.openapi_client.models.query_filter_instance_schema_model__links.Query_Filter_Instance_SchemaModel__links(
                    self = null, 
                    filter = null, )
            )
        else:
    ...
    def testQueryFilterInstanceSchemaModel(self):
        """Test QueryFilterInstanceSchemaModel"""
