...
class TestFileLinkReadModelEmbedded(unittest.TestCase):
    """FileLinkReadModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkReadModelEmbedded:
        """Test FileLinkReadModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkReadModelEmbedded`
        """
        model = FileLinkReadModelEmbedded()
        if include_optional:
    ...
    def testFileLinkReadModelEmbedded(self):
        """Test FileLinkReadModelEmbedded"""
