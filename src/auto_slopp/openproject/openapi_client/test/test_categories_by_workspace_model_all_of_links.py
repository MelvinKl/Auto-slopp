...
class TestCategoriesByWorkspaceModelAllOfLinks(unittest.TestCase):
    """CategoriesByWorkspaceModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoriesByWorkspaceModelAllOfLinks:
        """Test CategoriesByWorkspaceModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoriesByWorkspaceModelAllOfLinks`
        """
        model = CategoriesByWorkspaceModelAllOfLinks()
        if include_optional:
            return CategoriesByWorkspaceModelAllOfLinks(
    ...
    def testCategoriesByWorkspaceModelAllOfLinks(self):
        """Test CategoriesByWorkspaceModelAllOfLinks"""
