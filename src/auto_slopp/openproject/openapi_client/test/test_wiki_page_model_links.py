...
class TestWikiPageModelLinks(unittest.TestCase):
    """WikiPageModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WikiPageModelLinks:
        """Test WikiPageModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WikiPageModelLinks`
        """
        model = WikiPageModelLinks()
        if include_optional:
    ...
    def testWikiPageModelLinks(self):
        """Test WikiPageModelLinks"""
