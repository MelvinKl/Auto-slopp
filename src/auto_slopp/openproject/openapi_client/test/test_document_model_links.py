...
class TestDocumentModelLinks(unittest.TestCase):
    """DocumentModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentModelLinks:
        """Test DocumentModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentModelLinks`
        """
        model = DocumentModelLinks()
        if include_optional:
    ...
    def testDocumentModelLinks(self):
        """Test DocumentModelLinks"""
