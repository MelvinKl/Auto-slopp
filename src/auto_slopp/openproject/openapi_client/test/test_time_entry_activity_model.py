...
class TestTimeEntryActivityModel(unittest.TestCase):
    """TimeEntryActivityModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryActivityModel:
        """Test TimeEntryActivityModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryActivityModel`
        """
        model = TimeEntryActivityModel()
        if include_optional:
            return TimeEntryActivityModel(
                ...
                position = 56,
                default = True,
                embedded = auto_slopp.openproject.openapi_client.models.time_entry_activity_model__embedded.TimeEntryActivityModel__embedded(
                    projects = [
                        null
                        ], ),
                links = auto_slopp.openproject.openapi_client.models.time_entry_activity_model__links.TimeEntryActivityModel__links(
                    self = null, 
                    projects = [
                        null
                        ], )
    ...
    def testTimeEntryActivityModel(self):
        """Test TimeEntryActivityModel"""
