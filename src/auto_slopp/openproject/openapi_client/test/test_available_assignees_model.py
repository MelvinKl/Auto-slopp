...
class TestAvailableAssigneesModel(unittest.TestCase):
    """AvailableAssigneesModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableAssigneesModel:
        """Test AvailableAssigneesModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableAssigneesModel`
        """
        model = AvailableAssigneesModel()
        if include_optional:
            return AvailableAssigneesModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.available_assignees_model_all_of__links.Available_AssigneesModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.available_assignees_model_all_of__embedded.Available_AssigneesModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testAvailableAssigneesModel(self):
        """Test AvailableAssigneesModel"""
