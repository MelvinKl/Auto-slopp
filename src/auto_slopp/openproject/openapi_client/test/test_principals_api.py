...
class TestPrincipalsApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = PrincipalsApi()

    def tearDown(self) -> None:
        pass

    def test_create_placeholder_user(self) -> None:
        """Test case for create_placeholder_user
    ...
    def test_delete_placeholder_user(self) -> None:
        """Test case for delete_placeholder_user
    ...
    def test_list_placeholder_users(self) -> None:
        """Test case for list_placeholder_users
    ...
    def test_update_placeholder_user(self) -> None:
        """Test case for update_placeholder_user
    ...
    def test_view_placeholder_user(self) -> None:
        """Test case for view_placeholder_user
