...
class TestWorkPackagePatchModel(unittest.TestCase):
    """WorkPackagePatchModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackagePatchModel:
        """Test WorkPackagePatchModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackagePatchModel`
        """
        model = WorkPackagePatchModel()
        if include_optional:
    ...
    def testWorkPackagePatchModel(self):
        """Test WorkPackagePatchModel"""
