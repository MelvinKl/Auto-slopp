...
class TestGridWriteModelLinks(unittest.TestCase):
    """GridWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridWriteModelLinks:
        """Test GridWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridWriteModelLinks`
        """
        model = GridWriteModelLinks()
        if include_optional:
    ...
    def testGridWriteModelLinks(self):
        """Test GridWriteModelLinks"""
