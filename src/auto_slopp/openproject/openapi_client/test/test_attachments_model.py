...
class TestAttachmentsModel(unittest.TestCase):
    """AttachmentsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsModel:
        """Test AttachmentsModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsModel`
        """
        ...
        if include_optional:
            return AttachmentsModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.attachments_model_all_of__links.Attachments_Model_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.attachments_model_all_of__embedded.Attachments_Model_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
