...
class TestOffsetPaginatedCollectionLinks(unittest.TestCase):
    """OffsetPaginatedCollectionLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OffsetPaginatedCollectionLinks:
        """Test OffsetPaginatedCollectionLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OffsetPaginatedCollectionLinks`
        """
        model = OffsetPaginatedCollectionLinks()
        if include_optional:
            return OffsetPaginatedCollectionLinks(
    ...
    def testOffsetPaginatedCollectionLinks(self):
        """Test OffsetPaginatedCollectionLinks"""
