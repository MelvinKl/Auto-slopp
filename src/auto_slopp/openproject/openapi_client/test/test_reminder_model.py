...
class TestReminderModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReminderModel:
        """Test ReminderModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderModel`
        """
        model = ReminderModel()
        if include_optional:
            return ReminderModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.reminder_model__links.ReminderModel__links(
                    self = null, 
                    creator = null, 
                    remindable = null, )
            )
