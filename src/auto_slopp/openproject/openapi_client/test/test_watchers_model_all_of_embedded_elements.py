...
class TestWatchersModelAllOfEmbeddedElements(unittest.TestCase):
    """WatchersModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchersModelAllOfEmbeddedElements:
        """Test WatchersModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchersModelAllOfEmbeddedElements`
        """
        model = WatchersModelAllOfEmbeddedElements()
        if include_optional:
            return WatchersModelAllOfEmbeddedElements(
                ...
                links = auto_slopp.openproject.openapi_client.models.user_model_all_of__links.UserModel_allOf__links(
                    show_user = null, 
    ...
    def testWatchersModelAllOfEmbeddedElements(self):
        """Test WatchersModelAllOfEmbeddedElements"""
