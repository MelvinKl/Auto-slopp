...
class TestStorageWriteModel(unittest.TestCase):
    """StorageWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageWriteModel:
        """Test StorageWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageWriteModel`
        """
        model = StorageWriteModel()
        if include_optional:
            return StorageWriteModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.storage_write_model__links.StorageWriteModel__links(
                    origin = null, 
                    type = null, 
    ...
    def testStorageWriteModel(self):
        """Test StorageWriteModel"""
