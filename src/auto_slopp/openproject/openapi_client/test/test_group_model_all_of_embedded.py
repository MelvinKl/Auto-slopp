...
class TestGroupModelAllOfEmbedded(unittest.TestCase):
    """GroupModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupModelAllOfEmbedded:
        """Test GroupModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupModelAllOfEmbedded`
        """
        model = GroupModelAllOfEmbedded()
        if include_optional:
    ...
    def testGroupModelAllOfEmbedded(self):
        """Test GroupModelAllOfEmbedded"""
