    ...
    def make_instance(self, include_optional) -> HierarchyItemCollectionModel:
        ...
        if include_optional:
            return HierarchyItemCollectionModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.hierarchy_item_collection_model_all_of__links.HierarchyItemCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.hierarchy_item_collection_model_all_of__embedded.HierarchyItemCollectionModel_allOf__embedded(
                    elements = [
                        auto_slopp.openproject.openapi_client.models.hierarchy_item_read_model.HierarchyItemReadModel(
                            _type = 'HierarchyItem', 
                            id = 56, 
                            label = '', 
                            short = '', 
                            ...
                            formatted_weight = '', 
                            depth = 56, 
                            _links = auto_slopp.openproject.openapi_client.models.hierarchy_item_read_model__links.HierarchyItemReadModel__links(
                                self = null, 
                                parent = null, 
                                children = [
                                    null
