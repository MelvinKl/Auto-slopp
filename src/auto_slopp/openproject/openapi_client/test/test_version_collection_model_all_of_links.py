...
class TestVersionCollectionModelAllOfLinks(unittest.TestCase):
    """VersionCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionCollectionModelAllOfLinks:
        """Test VersionCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionCollectionModelAllOfLinks`
        """
        model = VersionCollectionModelAllOfLinks()
        if include_optional:
            return VersionCollectionModelAllOfLinks(
    ...
    def testVersionCollectionModelAllOfLinks(self):
        """Test VersionCollectionModelAllOfLinks"""
