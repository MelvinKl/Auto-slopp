...
class TestGroupCollectionModelAllOfEmbedded(unittest.TestCase):
    """GroupCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCollectionModelAllOfEmbedded:
        """Test GroupCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCollectionModelAllOfEmbedded`
        """
        model = GroupCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testGroupCollectionModelAllOfEmbedded(self):
        """Test GroupCollectionModelAllOfEmbedded"""
