...
class TestActivityCommentWriteModel(unittest.TestCase):
    """ActivityCommentWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCommentWriteModel:
        """Test ActivityCommentWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCommentWriteModel`
        """
        model = ActivityCommentWriteModel()
        if include_optional:
            return ActivityCommentWriteModel(
                comment = auto_slopp.openproject.openapi_client.models.activity_comment_write_model_comment.ActivityCommentWriteModel_comment(
                    raw = '', ),
                internal = True
            )
        else:
    ...
    def testActivityCommentWriteModel(self):
        """Test ActivityCommentWriteModel"""
