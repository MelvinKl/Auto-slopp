...
class TestActivitiesApi(unittest.TestCase):
    ...
    def test_list_activity_emoji_reactions(self) -> None:
        """Test case for list_activity_emoji_reactions

        List emoji reactions by activity
        """
        pass

    def test_list_work_package_activities_emoji_reactions(self) -> None:
        """Test case for list_work_package_activities_emoji_reactions

        List emoji reactions by work package activities
        """
        pass

    def test_toggle_activity_emoji_reaction(self) -> None:
        """Test case for toggle_activity_emoji_reaction
