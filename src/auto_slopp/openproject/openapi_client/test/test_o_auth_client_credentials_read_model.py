...
class TestOAuthClientCredentialsReadModel(unittest.TestCase):
    """OAuthClientCredentialsReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthClientCredentialsReadModel:
        """Test OAuthClientCredentialsReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthClientCredentialsReadModel`
        """
        model = OAuthClientCredentialsReadModel()
        if include_optional:
            return OAuthClientCredentialsReadModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.o_auth_client_credentials_read_model__links.OAuthClientCredentialsReadModel__links(
                    self = null, 
                    integration = null, )
            )
        else:
    ...
    def testOAuthClientCredentialsReadModel(self):
        """Test OAuthClientCredentialsReadModel"""
