...
class TestBudgetModelLinks(unittest.TestCase):
    """BudgetModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetModelLinks:
        """Test BudgetModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetModelLinks`
        """
        model = BudgetModelLinks()
        if include_optional:
