...
class TestCustomActionModel(unittest.TestCase):
    """CustomActionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionModel:
        """Test CustomActionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionModel`
        """
        ...
        if include_optional:
            return CustomActionModel(
                ...
                name = '',
                description = '',
                links = auto_slopp.openproject.openapi_client.models.custom_action_model__links.CustomActionModel__links(
                    self = null, 
    ...
    def testCustomActionModel(self):
        """Test CustomActionModel"""
