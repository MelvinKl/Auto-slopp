...
class TestRoleModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RoleModel:
        """Test RoleModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleModel`
        """
        model = RoleModel()
        if include_optional:
            return RoleModel(
                ...
                id = 1,
                name = '',
                links = auto_slopp.openproject.openapi_client.models.role_model__links.RoleModel__links(
                    self = null, )
            )
        else:
            return RoleModel(
