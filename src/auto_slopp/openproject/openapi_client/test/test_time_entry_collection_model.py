...
class TestTimeEntryCollectionModel(unittest.TestCase):
    """TimeEntryCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryCollectionModel:
        """Test TimeEntryCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryCollectionModel`
        """
        model = TimeEntryCollectionModel()
        if include_optional:
            return TimeEntryCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.time_entry_collection_model_all_of__links.TimeEntryCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.time_entry_collection_model_all_of__embedded.TimeEntryCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testTimeEntryCollectionModel(self):
        """Test TimeEntryCollectionModel"""
