...
class TestAddWatcherRequest(unittest.TestCase):
    """AddWatcherRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddWatcherRequest:
        """Test AddWatcherRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddWatcherRequest`
        """
        model = AddWatcherRequest()
        if include_optional:
            return AddWatcherRequest(
                user = auto_slopp.openproject.openapi_client.models.execute_custom_action_request__links_work_package.Execute_custom_action_request__links_workPackage(
                    href = '', )
            )
        else:
            return AddWatcherRequest(
    ...
    def testAddWatcherRequest(self):
        """Test AddWatcherRequest"""
