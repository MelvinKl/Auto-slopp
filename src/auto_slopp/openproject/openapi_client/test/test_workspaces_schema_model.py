...
class TestWorkspacesSchemaModel(unittest.TestCase):
    """WorkspacesSchemaModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspacesSchemaModel:
        """Test WorkspacesSchemaModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspacesSchemaModel`
        """
        model = WorkspacesSchemaModel()
        if include_optional:
            return WorkspacesSchemaModel(
                type = 'Schema',
                dependencies = [
                    null
                    ],
                attribute_groups = [
                    auto_slopp.openproject.openapi_client.models.workspaces_schema_model__attribute_groups_inner.Workspaces_schemaModel__attributeGroups_inner(
                ...
                name = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                identifier = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                description = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                public = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                active = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                status = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                status_explanation = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                updated_at = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                links = auto_slopp.openproject.openapi_client.models.workspaces_schema_model__links.Workspaces_schemaModel__links(
                    self = auto_slopp.openproject.openapi_client.models.workspaces_schema_model__links_self.Workspaces_schemaModel__links_self(
    ...
    def testWorkspacesSchemaModel(self):
        """Test WorkspacesSchemaModel"""
