...
class TestPortfolioCollectionModelAllOfLinks(unittest.TestCase):
    """PortfolioCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioCollectionModelAllOfLinks:
        """Test PortfolioCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioCollectionModelAllOfLinks`
        """
        model = PortfolioCollectionModelAllOfLinks()
        if include_optional:
            return PortfolioCollectionModelAllOfLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                jump_to = {href=/api/v3/work_packages, method=POST},
                change_size = {href=/api/v3/work_packages, method=POST},
                previous_by_offset = {href=/api/v3/work_packages, method=POST},
                next_by_offset = {href=/api/v3/work_packages, method=POST},
                representations = [
                    null
                    ]
            )
    ...
    def testPortfolioCollectionModelAllOfLinks(self):
        """Test PortfolioCollectionModelAllOfLinks"""
