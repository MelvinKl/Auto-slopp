...
class TestStorageCollectionModelAllOfLinks(unittest.TestCase):
    """StorageCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageCollectionModelAllOfLinks:
        """Test StorageCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageCollectionModelAllOfLinks`
        """
        model = StorageCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testStorageCollectionModelAllOfLinks(self):
        """Test StorageCollectionModelAllOfLinks"""
