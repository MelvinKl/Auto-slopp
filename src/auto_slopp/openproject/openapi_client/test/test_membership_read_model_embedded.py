...
class TestMembershipReadModelEmbedded(unittest.TestCase):
    """MembershipReadModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipReadModelEmbedded:
        """Test MembershipReadModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipReadModelEmbedded`
        """
        model = MembershipReadModelEmbedded()
        if include_optional:
    ...
    def testMembershipReadModelEmbedded(self):
        """Test MembershipReadModelEmbedded"""
