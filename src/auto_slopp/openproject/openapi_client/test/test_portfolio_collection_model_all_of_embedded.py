...
class TestPortfolioCollectionModelAllOfEmbedded(unittest.TestCase):
    """PortfolioCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioCollectionModelAllOfEmbedded:
        """Test PortfolioCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioCollectionModelAllOfEmbedded`
        """
        model = PortfolioCollectionModelAllOfEmbedded()
        if include_optional:
            return PortfolioCollectionModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testPortfolioCollectionModelAllOfEmbedded(self):
        """Test PortfolioCollectionModelAllOfEmbedded"""
