...
class TestListReminders200ResponseEmbedded(unittest.TestCase):
    """ListReminders200ResponseEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListReminders200ResponseEmbedded:
        """Test ListReminders200ResponseEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListReminders200ResponseEmbedded`
        """
        model = ListReminders200ResponseEmbedded()
        if include_optional:
            return ListReminders200ResponseEmbedded(
                elements = [
                    auto_slopp.openproject.openapi_client.models.reminder_model.ReminderModel(
                        id = 1, 
                        note = '', 
                        remind_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        _links = auto_slopp.openproject.openapi_client.models.reminder_model__links.ReminderModel__links(
                            self = null, 
                            creator = null, 
                            remindable = null, ), )
                    ]
    ...
    def testListReminders200ResponseEmbedded(self):
        """Test ListReminders200ResponseEmbedded"""
