...
class TestDayModelLinks(unittest.TestCase):
    """DayModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayModelLinks:
        """Test DayModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayModelLinks`
        """
        model = DayModelLinks()
        if include_optional:
            return DayModelLinks(
                ...
                week_day = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return DayModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
