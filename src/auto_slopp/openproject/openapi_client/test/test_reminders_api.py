...
class TestRemindersApi(unittest.TestCase):
    ...
    def test_create_work_package_reminder(self) -> None:
        """Test case for create_work_package_reminder
    ...
    def test_list_reminders(self) -> None:
        """Test case for list_reminders

        List all active reminders
        """
        pass

    def test_list_work_package_reminders(self) -> None:
        """Test case for list_work_package_reminders
