...
class TestMembershipsApi(unittest.TestCase):
    ...
    def test_form_create_membership(self) -> None:
        """Test case for form_create_membership

        Form create membership
        """
        pass

    def test_form_update_membership(self) -> None:
        """Test case for form_update_membership
    ...
    def test_get_membership_schema(self) -> None:
        """Test case for get_membership_schema

        Schema membership
        """
        pass

    def test_get_memberships_available_projects(self) -> None:
        """Test case for get_memberships_available_projects
