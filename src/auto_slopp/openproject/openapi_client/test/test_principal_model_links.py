...
class TestPrincipalModelLinks(unittest.TestCase):
    """PrincipalModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrincipalModelLinks:
        """Test PrincipalModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrincipalModelLinks`
        """
        model = PrincipalModelLinks()
        if include_optional:
    ...
    def testPrincipalModelLinks(self):
        """Test PrincipalModelLinks"""
