...
class TestPlaceholderUserCollectionModelAllOfLinks(unittest.TestCase):
    """PlaceholderUserCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserCollectionModelAllOfLinks:
        """Test PlaceholderUserCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserCollectionModelAllOfLinks`
        """
        model = PlaceholderUserCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testPlaceholderUserCollectionModelAllOfLinks(self):
        """Test PlaceholderUserCollectionModelAllOfLinks"""
