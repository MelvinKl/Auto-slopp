...
class TestGroupWriteModelLinks(unittest.TestCase):
    """GroupWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupWriteModelLinks:
        """Test GroupWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupWriteModelLinks`
        """
        model = GroupWriteModelLinks()
        if include_optional:
    ...
    def testGroupWriteModelLinks(self):
        """Test GroupWriteModelLinks"""
