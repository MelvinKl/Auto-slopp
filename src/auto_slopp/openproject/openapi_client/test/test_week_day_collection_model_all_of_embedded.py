...
class TestWeekDayCollectionModelAllOfEmbedded(unittest.TestCase):
    """WeekDayCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionModelAllOfEmbedded:
        """Test WeekDayCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionModelAllOfEmbedded`
        """
        model = WeekDayCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testWeekDayCollectionModelAllOfEmbedded(self):
        """Test WeekDayCollectionModelAllOfEmbedded"""
