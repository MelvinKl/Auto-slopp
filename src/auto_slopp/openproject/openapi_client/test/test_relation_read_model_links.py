...
class TestRelationReadModelLinks(unittest.TestCase):
    """RelationReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationReadModelLinks:
        """Test RelationReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationReadModelLinks`
        """
        model = RelationReadModelLinks()
        if include_optional:
            return RelationReadModelLinks(
                ...
                var_from = {href=/api/v3/work_packages, method=POST},
                to = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return RelationReadModelLinks(
        )
    ...
    def testRelationReadModelLinks(self):
        """Test RelationReadModelLinks"""
