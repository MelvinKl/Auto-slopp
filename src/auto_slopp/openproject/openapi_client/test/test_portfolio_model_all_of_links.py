...
class TestPortfolioModelAllOfLinks(unittest.TestCase):
    """PortfolioModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioModelAllOfLinks:
        """Test PortfolioModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioModelAllOfLinks`
        """
        model = PortfolioModelAllOfLinks()
        if include_optional:
            return PortfolioModelAllOfLinks(
                ...
                favor = {href=/api/v3/work_packages, method=POST},
                disfavor = {href=/api/v3/work_packages, method=POST},
                create_work_package = {href=/api/v3/work_packages, method=POST},
                create_work_package_immediately = {href=/api/v3/work_packages, method=POST},
                var_self = {href=/api/v3/work_packages, method=POST},
                categories = {href=/api/v3/work_packages, method=POST},
                types = {href=/api/v3/work_packages, method=POST},
                versions = {href=/api/v3/work_packages, method=POST},
                memberships = {href=/api/v3/work_packages, method=POST},
                work_packages = {href=/api/v3/work_packages, method=POST},
                parent = {href=/api/v3/work_packages, method=POST},
                status = {href=/api/v3/work_packages, method=POST},
                storages = [
                    null
                    ],
                project_storages = {href=/api/v3/work_packages, method=POST},
                ancestors = [
                    null
                    ]
            )
    ...
    def testPortfolioModelAllOfLinks(self):
        """Test PortfolioModelAllOfLinks"""
