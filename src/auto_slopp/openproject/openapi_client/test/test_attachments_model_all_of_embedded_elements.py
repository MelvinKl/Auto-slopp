...
class TestAttachmentsModelAllOfEmbeddedElements(unittest.TestCase):
    """AttachmentsModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsModelAllOfEmbeddedElements:
        """Test AttachmentsModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsModelAllOfEmbeddedElements`
        """
        model = AttachmentsModelAllOfEmbeddedElements()
        if include_optional:
            return AttachmentsModelAllOfEmbeddedElements(
                ...
                status = 'uploaded',
                content_type = '',
                digest = auto_slopp.openproject.openapi_client.models.attachment_model_digest.AttachmentModel_digest(
                    algorithm = '', 
                    hash = '', ),
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                links = auto_slopp.openproject.openapi_client.models.attachment_model__links.AttachmentModel__links(
                    delete = null, 
                    self = null, 
                    container = null, 
                    author = null, 
    ...
    def testAttachmentsModelAllOfEmbeddedElements(self):
        """Test AttachmentsModelAllOfEmbeddedElements"""
