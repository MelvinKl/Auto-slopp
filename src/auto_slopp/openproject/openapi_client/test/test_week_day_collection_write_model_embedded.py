...
class TestWeekDayCollectionWriteModelEmbedded(unittest.TestCase):
    """WeekDayCollectionWriteModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionWriteModelEmbedded:
        """Test WeekDayCollectionWriteModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionWriteModelEmbedded`
        """
        model = WeekDayCollectionWriteModelEmbedded()
        if include_optional:
    ...
    def testWeekDayCollectionWriteModelEmbedded(self):
        """Test WeekDayCollectionWriteModelEmbedded"""
