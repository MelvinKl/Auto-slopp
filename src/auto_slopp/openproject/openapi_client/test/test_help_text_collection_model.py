...
class TestHelpTextCollectionModel(unittest.TestCase):
    """HelpTextCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelpTextCollectionModel:
        """Test HelpTextCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelpTextCollectionModel`
        """
        model = HelpTextCollectionModel()
        if include_optional:
            return HelpTextCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.help_text_collection_model_all_of__links.HelpTextCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.help_text_collection_model_all_of__embedded.HelpTextCollectionModel_allOf__embedded(
                    elements = [
                        {_type=HelpText, id=1, attribute=id, scope=WorkPackage, caption=Some plain text caption, helpText={format=markdown, raw=Help text for id attribute., html=<p>Help text for id attribute.</p>}, _links={self={href=/api/v3/help_texts/1}, editText={href=/admin/attribute_help_texts/1/edit, type=text/html}, attachments={href=/api/v3/help_texts/1/attachments}, addAttachment={href=/api/v3/help_texts/1/attachments, method=post}}}
                        ], )
            )
        else:
            return HelpTextCollectionModel(
    ...
    def testHelpTextCollectionModel(self):
        """Test HelpTextCollectionModel"""
