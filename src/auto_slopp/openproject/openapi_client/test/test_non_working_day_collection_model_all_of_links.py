...
class TestNonWorkingDayCollectionModelAllOfLinks(unittest.TestCase):
    """NonWorkingDayCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonWorkingDayCollectionModelAllOfLinks:
        """Test NonWorkingDayCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonWorkingDayCollectionModelAllOfLinks`
        """
        model = NonWorkingDayCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testNonWorkingDayCollectionModelAllOfLinks(self):
        """Test NonWorkingDayCollectionModelAllOfLinks"""
