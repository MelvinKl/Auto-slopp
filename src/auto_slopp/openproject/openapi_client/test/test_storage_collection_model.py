...
class TestStorageCollectionModel(unittest.TestCase):
    """StorageCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageCollectionModel:
        """Test StorageCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageCollectionModel`
        """
        model = StorageCollectionModel()
        if include_optional:
            return StorageCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.storage_collection_model_all_of__links.StorageCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.storage_collection_model_all_of__embedded.StorageCollectionModel_allOf__embedded(
                    elements = [
                        auto_slopp.openproject.openapi_client.models.storage_read_model.StorageReadModel(
                            id = 56, 
                            _type = 'Storage', 
                            name = '', 
                            storage_audience = '', 
    ...
    def testStorageCollectionModel(self):
        """Test StorageCollectionModel"""
