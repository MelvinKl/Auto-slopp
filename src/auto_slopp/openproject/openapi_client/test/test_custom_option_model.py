...
class TestCustomOptionModel(unittest.TestCase):
    """CustomOptionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomOptionModel:
        """Test CustomOptionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomOptionModel`
        """
        model = CustomOptionModel()
        if include_optional:
            return CustomOptionModel(
                id = 56,
                value = '',
                links = auto_slopp.openproject.openapi_client.models.custom_option_model__links.CustomOptionModel__links(
                    self = null, )
            )
        else:
            return CustomOptionModel(
    ...
    def testCustomOptionModel(self):
        """Test CustomOptionModel"""
