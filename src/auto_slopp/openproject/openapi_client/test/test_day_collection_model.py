...
class TestDayCollectionModel(unittest.TestCase):
    """DayCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayCollectionModel:
        """Test DayCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayCollectionModel`
        """
        model = DayCollectionModel()
        if include_optional:
            return DayCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.day_collection_model_all_of__links.DayCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.day_collection_model_all_of__embedded.DayCollectionModel_allOf__embedded(
                    elements = [
                        {_type=Day, date=2022-12-25, name=Sunday (Christmas), working=false, _links={self={href=/api/v3/days/2022-12-25}, nonWorkingReasons=[{href=/api/v3/days/week/7, title=Sunday}, {href=/api/v3/days/non_working/2022-12-25, title=Christmas}], weekday={href=/api/v3/days/week/7, title=Sunday}}}
                        ], )
            )
        else:
            return DayCollectionModel(
    ...
    def testDayCollectionModel(self):
        """Test DayCollectionModel"""
