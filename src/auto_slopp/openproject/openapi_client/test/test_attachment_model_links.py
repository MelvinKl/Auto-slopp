...
class TestAttachmentModelLinks(unittest.TestCase):
    """AttachmentModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentModelLinks:
        """Test AttachmentModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentModelLinks`
        """
        model = AttachmentModelLinks()
        if include_optional:
            return AttachmentModelLinks(
                ...
                download_location = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return AttachmentModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testAttachmentModelLinks(self):
        """Test AttachmentModelLinks"""
