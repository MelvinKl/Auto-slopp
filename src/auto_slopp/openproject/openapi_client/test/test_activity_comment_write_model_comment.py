...
class TestActivityCommentWriteModelComment(unittest.TestCase):
    """ActivityCommentWriteModelComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCommentWriteModelComment:
        """Test ActivityCommentWriteModelComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCommentWriteModelComment`
        """
        model = ActivityCommentWriteModelComment()
        if include_optional:
            return ActivityCommentWriteModelComment(
                raw = ''
            )
        else:
            return ActivityCommentWriteModelComment(
    ...
    def testActivityCommentWriteModelComment(self):
        """Test ActivityCommentWriteModelComment"""
