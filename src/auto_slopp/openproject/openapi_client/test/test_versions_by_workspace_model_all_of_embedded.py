...
class TestVersionsByWorkspaceModelAllOfEmbedded(unittest.TestCase):
    """VersionsByWorkspaceModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionsByWorkspaceModelAllOfEmbedded:
        """Test VersionsByWorkspaceModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionsByWorkspaceModelAllOfEmbedded`
        """
        model = VersionsByWorkspaceModelAllOfEmbedded()
        if include_optional:
            return VersionsByWorkspaceModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testVersionsByWorkspaceModelAllOfEmbedded(self):
        """Test VersionsByWorkspaceModelAllOfEmbedded"""
