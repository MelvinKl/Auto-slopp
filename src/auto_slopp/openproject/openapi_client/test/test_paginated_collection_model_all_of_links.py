...
class TestPaginatedCollectionModelAllOfLinks(unittest.TestCase):
    """PaginatedCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedCollectionModelAllOfLinks:
        """Test PaginatedCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedCollectionModelAllOfLinks`
        """
        model = PaginatedCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testPaginatedCollectionModelAllOfLinks(self):
        """Test PaginatedCollectionModelAllOfLinks"""
