...
class TestProjectStorageCollectionModelAllOfLinks(unittest.TestCase):
    """ProjectStorageCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectStorageCollectionModelAllOfLinks:
        """Test ProjectStorageCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectStorageCollectionModelAllOfLinks`
        """
        model = ProjectStorageCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testProjectStorageCollectionModelAllOfLinks(self):
        """Test ProjectStorageCollectionModelAllOfLinks"""
