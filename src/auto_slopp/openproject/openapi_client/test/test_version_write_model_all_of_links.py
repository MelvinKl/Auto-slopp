...
class TestVersionWriteModelAllOfLinks(unittest.TestCase):
    """VersionWriteModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionWriteModelAllOfLinks:
        """Test VersionWriteModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionWriteModelAllOfLinks`
        """
        model = VersionWriteModelAllOfLinks()
        if include_optional:
            return VersionWriteModelAllOfLinks(
    ...
    def testVersionWriteModelAllOfLinks(self):
        """Test VersionWriteModelAllOfLinks"""
