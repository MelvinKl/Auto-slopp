...
class TestActivityModelLinks(unittest.TestCase):
    """ActivityModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityModelLinks:
        """Test ActivityModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityModelLinks`
        """
        model = ActivityModelLinks()
        if include_optional:
            return ActivityModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                work_package = {href=/api/v3/work_packages, method=POST},
                ...
                emoji_reactions = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return ActivityModelLinks(
        )
    ...
    def testActivityModelLinks(self):
        """Test ActivityModelLinks"""
