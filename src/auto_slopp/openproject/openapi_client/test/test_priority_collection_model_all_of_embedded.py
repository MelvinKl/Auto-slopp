...
class TestPriorityCollectionModelAllOfEmbedded(unittest.TestCase):
    """PriorityCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityCollectionModelAllOfEmbedded:
        """Test PriorityCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityCollectionModelAllOfEmbedded`
        """
        model = PriorityCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testPriorityCollectionModelAllOfEmbedded(self):
        """Test PriorityCollectionModelAllOfEmbedded"""
