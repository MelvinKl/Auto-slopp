...
class TestTimeEntryCollectionModelAllOfLinks(unittest.TestCase):
    """TimeEntryCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryCollectionModelAllOfLinks:
        """Test TimeEntryCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryCollectionModelAllOfLinks`
        """
        model = TimeEntryCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testTimeEntryCollectionModelAllOfLinks(self):
        """Test TimeEntryCollectionModelAllOfLinks"""
