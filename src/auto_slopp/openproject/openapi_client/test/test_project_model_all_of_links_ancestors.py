...
class TestProjectModelAllOfLinksAncestors(unittest.TestCase):
    """ProjectModelAllOfLinksAncestors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectModelAllOfLinksAncestors:
        """Test ProjectModelAllOfLinksAncestors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectModelAllOfLinksAncestors`
        """
        model = ProjectModelAllOfLinksAncestors()
        if include_optional:
            return ProjectModelAllOfLinksAncestors(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testProjectModelAllOfLinksAncestors(self):
        """Test ProjectModelAllOfLinksAncestors"""
