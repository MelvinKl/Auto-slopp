    ...
    def make_instance(self, include_optional) -> EmojiReactionsModel:
        ...
        if include_optional:
            return EmojiReactionsModel(
                ...
                total = 0,
                count = 0,
                embedded = auto_slopp.openproject.openapi_client.models.emoji_reactions_model__embedded.EmojiReactions_Model__embedded(
                    elements = [
                ...
                links = auto_slopp.openproject.openapi_client.models.emoji_reactions_model__links.EmojiReactions_Model__links(
                    self = null, )
            )
        else:
            return EmojiReactionsModel(
