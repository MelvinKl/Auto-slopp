...
class TestNotificationModelLinks(unittest.TestCase):
    """NotificationModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationModelLinks:
        """Test NotificationModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationModelLinks`
        """
        model = NotificationModelLinks()
        if include_optional:
            return NotificationModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                read_ian = {href=/api/v3/work_packages, method=POST},
                unread_ian = {href=/api/v3/work_packages, method=POST},
                project = {href=/api/v3/work_packages, method=POST},
                actor = {href=/api/v3/work_packages, method=POST},
                resource = {href=/api/v3/work_packages, method=POST},
    ...
    def testNotificationModelLinks(self):
        """Test NotificationModelLinks"""
