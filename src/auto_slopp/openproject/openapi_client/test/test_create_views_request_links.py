...
class TestCreateViewsRequestLinks(unittest.TestCase):
    """CreateViewsRequestLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateViewsRequestLinks:
        """Test CreateViewsRequestLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateViewsRequestLinks`
        """
        model = CreateViewsRequestLinks()
        if include_optional:
            return CreateViewsRequestLinks(
                query = auto_slopp.openproject.openapi_client.models.create_views_request__links_query.Create_views_request__links_query(
                    href = '', )
            )
        else:
            return CreateViewsRequestLinks(
    ...
    def testCreateViewsRequestLinks(self):
        """Test CreateViewsRequestLinks"""
