...
class TestEmojiReactionsModelLinks(unittest.TestCase):
    """EmojiReactionsModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiReactionsModelLinks:
        """Test EmojiReactionsModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiReactionsModelLinks`
        """
        model = EmojiReactionsModelLinks()
        if include_optional:
            return EmojiReactionsModelLinks(
    ...
    def testEmojiReactionsModelLinks(self):
        """Test EmojiReactionsModelLinks"""
