...
class TestSchemaModelLinks(unittest.TestCase):
    """SchemaModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaModelLinks:
        """Test SchemaModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemaModelLinks`
        """
        model = SchemaModelLinks()
        if include_optional:
