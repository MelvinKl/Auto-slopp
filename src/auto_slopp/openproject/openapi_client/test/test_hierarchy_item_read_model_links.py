...
class TestHierarchyItemReadModelLinks(unittest.TestCase):
    """HierarchyItemReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyItemReadModelLinks:
        """Test HierarchyItemReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyItemReadModelLinks`
        """
        model = HierarchyItemReadModelLinks()
        if include_optional:
            return HierarchyItemReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                parent = {href=/api/v3/work_packages, method=POST},
                children = [
                    null
                    ],
                branch = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return HierarchyItemReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testHierarchyItemReadModelLinks(self):
        """Test HierarchyItemReadModelLinks"""
