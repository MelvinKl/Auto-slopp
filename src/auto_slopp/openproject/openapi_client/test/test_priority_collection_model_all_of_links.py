...
class TestPriorityCollectionModelAllOfLinks(unittest.TestCase):
    """PriorityCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityCollectionModelAllOfLinks:
        """Test PriorityCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityCollectionModelAllOfLinks`
        """
        model = PriorityCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testPriorityCollectionModelAllOfLinks(self):
        """Test PriorityCollectionModelAllOfLinks"""
