...
class TestValuesPropertyModel(unittest.TestCase):
    """ValuesPropertyModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuesPropertyModel:
        """Test ValuesPropertyModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuesPropertyModel`
        """
        model = ValuesPropertyModel()
        if include_optional:
            return ValuesPropertyModel(
                type = 'Values::Property',
                var_property = '',
                value = '',
                links = auto_slopp.openproject.openapi_client.models.values_property_model__links.ValuesPropertyModel__links(
                    self = null, 
                    schema = null, )
            )
        else:
    ...
    def testValuesPropertyModel(self):
        """Test ValuesPropertyModel"""
