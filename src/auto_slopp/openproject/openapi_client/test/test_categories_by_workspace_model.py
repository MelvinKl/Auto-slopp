...
class TestCategoriesByWorkspaceModel(unittest.TestCase):
    """CategoriesByWorkspaceModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoriesByWorkspaceModel:
        """Test CategoriesByWorkspaceModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoriesByWorkspaceModel`
        """
        model = CategoriesByWorkspaceModel()
        if include_optional:
            return CategoriesByWorkspaceModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.categories_by_workspace_model_all_of__links.Categories_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.categories_by_workspace_model_all_of__embedded.Categories_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testCategoriesByWorkspaceModel(self):
        """Test CategoriesByWorkspaceModel"""
