...
class TestAttachmentsModelAllOfLinks(unittest.TestCase):
    """AttachmentsModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsModelAllOfLinks:
        """Test AttachmentsModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsModelAllOfLinks`
        """
        model = AttachmentsModelAllOfLinks()
        if include_optional:
    ...
    def testAttachmentsModelAllOfLinks(self):
        """Test AttachmentsModelAllOfLinks"""
