...
class TestHelpTextCollectionModelAllOfEmbedded(unittest.TestCase):
    """HelpTextCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelpTextCollectionModelAllOfEmbedded:
        """Test HelpTextCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelpTextCollectionModelAllOfEmbedded`
        """
        model = HelpTextCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testHelpTextCollectionModelAllOfEmbedded(self):
        """Test HelpTextCollectionModelAllOfEmbedded"""
