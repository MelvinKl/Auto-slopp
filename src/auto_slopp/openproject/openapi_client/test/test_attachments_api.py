...
class TestAttachmentsApi(unittest.TestCase):
    ...
    def test_add_attachment_to_meeting(self) -> None:
        """Test case for add_attachment_to_meeting

        Add attachment to meeting
        """
        pass

    def test_add_attachment_to_post(self) -> None:
        """Test case for add_attachment_to_post

        Add attachment to post
        """
        pass

    def test_add_attachment_to_wiki_page(self) -> None:
        """Test case for add_attachment_to_wiki_page

        Add attachment to wiki page
        """
        pass

    def test_create_activity_attachment(self) -> None:
        """Test case for create_activity_attachment
    ...
    def test_create_work_package_attachment(self) -> None:
        """Test case for create_work_package_attachment
    ...
    def test_list_activity_attachments(self) -> None:
        """Test case for list_activity_attachments

        List attachments by activity
        """
        pass

    def test_list_attachments_by_meeting(self) -> None:
        """Test case for list_attachments_by_meeting

        List attachments by meeting
        """
        pass

    def test_list_attachments_by_post(self) -> None:
        """Test case for list_attachments_by_post

        List attachments by post
        """
        pass

    def test_list_attachments_by_wiki_page(self) -> None:
        """Test case for list_attachments_by_wiki_page

        List attachments by wiki page
        """
        pass

    def test_list_work_package_attachments(self) -> None:
        """Test case for list_work_package_attachments

        List attachments by work package
        """
        pass

    def test_view_attachment(self) -> None:
        """Test case for view_attachment
