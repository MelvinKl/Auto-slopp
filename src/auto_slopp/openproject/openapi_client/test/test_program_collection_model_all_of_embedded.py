...
class TestProgramCollectionModelAllOfEmbedded(unittest.TestCase):
    """ProgramCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramCollectionModelAllOfEmbedded:
        """Test ProgramCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramCollectionModelAllOfEmbedded`
        """
        model = ProgramCollectionModelAllOfEmbedded()
        if include_optional:
            return ProgramCollectionModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testProgramCollectionModelAllOfEmbedded(self):
        """Test ProgramCollectionModelAllOfEmbedded"""
