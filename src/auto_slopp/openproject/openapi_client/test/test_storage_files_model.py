...
class TestStorageFilesModel(unittest.TestCase):
    """StorageFilesModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFilesModel:
        """Test StorageFilesModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFilesModel`
        """
        ...
        if include_optional:
            return StorageFilesModel(
                type = 'StorageFiles',
                files = [
                    {id=42, name=readme.md, _type=StorageFile, location=/readme.md, _links={self={href=urn:openproject-org:api:v3:storages:storage_file:no_link_provided}}}
                    ],
                parent = {id=42, name=readme.md, _type=StorageFile, location=/readme.md, _links={self={href=urn:openproject-org:api:v3:storages:storage_file:no_link_provided}}},
                ancestors = [
                    {id=42, name=readme.md, _type=StorageFile, location=/readme.md, _links={self={href=urn:openproject-org:api:v3:storages:storage_file:no_link_provided}}}
                    ],
                links = auto_slopp.openproject.openapi_client.models.storage_file_model_all_of__links.StorageFileModel_allOf__links(
                    self = null, )
            )
        else:
            return StorageFilesModel(
    ...
    def testStorageFilesModel(self):
        """Test StorageFilesModel"""
