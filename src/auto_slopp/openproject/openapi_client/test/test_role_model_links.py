...
class TestRoleModelLinks(unittest.TestCase):
    """RoleModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleModelLinks:
        """Test RoleModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleModelLinks`
        """
        model = RoleModelLinks()
        if include_optional:
