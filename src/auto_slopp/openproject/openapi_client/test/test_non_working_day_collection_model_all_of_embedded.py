...
class TestNonWorkingDayCollectionModelAllOfEmbedded(unittest.TestCase):
    """NonWorkingDayCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonWorkingDayCollectionModelAllOfEmbedded:
        """Test NonWorkingDayCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonWorkingDayCollectionModelAllOfEmbedded`
        """
        model = NonWorkingDayCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testNonWorkingDayCollectionModelAllOfEmbedded(self):
        """Test NonWorkingDayCollectionModelAllOfEmbedded"""
