...
class TestUserCollectionModelAllOfLinks(unittest.TestCase):
    """UserCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCollectionModelAllOfLinks:
        """Test UserCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCollectionModelAllOfLinks`
        """
        model = UserCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testUserCollectionModelAllOfLinks(self):
        """Test UserCollectionModelAllOfLinks"""
