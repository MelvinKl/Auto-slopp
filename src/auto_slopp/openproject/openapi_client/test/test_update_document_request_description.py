...
class TestUpdateDocumentRequestDescription(unittest.TestCase):
    """UpdateDocumentRequestDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDocumentRequestDescription:
        """Test UpdateDocumentRequestDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDocumentRequestDescription`
        """
        model = UpdateDocumentRequestDescription()
        if include_optional:
            return UpdateDocumentRequestDescription(
                raw = ''
            )
        else:
            return UpdateDocumentRequestDescription(
    ...
    def testUpdateDocumentRequestDescription(self):
        """Test UpdateDocumentRequestDescription"""
