...
class TestCreateViewsRequestLinksQuery(unittest.TestCase):
    """CreateViewsRequestLinksQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateViewsRequestLinksQuery:
        """Test CreateViewsRequestLinksQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateViewsRequestLinksQuery`
        """
        model = CreateViewsRequestLinksQuery()
        if include_optional:
    ...
    def testCreateViewsRequestLinksQuery(self):
        """Test CreateViewsRequestLinksQuery"""
