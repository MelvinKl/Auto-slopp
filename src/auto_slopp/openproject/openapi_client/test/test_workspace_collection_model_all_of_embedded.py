...
class TestWorkspaceCollectionModelAllOfEmbedded(unittest.TestCase):
    """WorkspaceCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCollectionModelAllOfEmbedded:
        """Test WorkspaceCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCollectionModelAllOfEmbedded`
        """
        model = WorkspaceCollectionModelAllOfEmbedded()
        if include_optional:
            return WorkspaceCollectionModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testWorkspaceCollectionModelAllOfEmbedded(self):
        """Test WorkspaceCollectionModelAllOfEmbedded"""
