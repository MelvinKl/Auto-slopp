...
class TestActivityModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActivityModel:
        """Test ActivityModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityModel`
        """
        model = ActivityModel()
        if include_optional:
            return ActivityModel(
                ...
                id = 1,
                version = 1,
                comment = {format=markdown, raw=I am formatted!, html=I am formatted!},
                details = [
                    {format=markdown, raw=I am formatted!, html=I am formatted!}
                    ],
                internal = True,
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                embedded = auto_slopp.openproject.openapi_client.models.activity_model__embedded.ActivityModel__embedded(
                    attachments = null, 
                    work_package = null, 
                    emoji_reactions = null, ),
                links = auto_slopp.openproject.openapi_client.models.activity_model__links.ActivityModel__links(
                    self = null, 
                    work_package = null, 
                    user = null, 
                    update = null, 
