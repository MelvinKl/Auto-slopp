...
class TestQueryCreateForm(unittest.TestCase):
    """QueryCreateForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryCreateForm:
        """Test QueryCreateForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryCreateForm`
        """
        model = QueryCreateForm()
        if include_optional:
