...
class TestMembershipCollectionModelAllOfEmbedded(unittest.TestCase):
    """MembershipCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipCollectionModelAllOfEmbedded:
        """Test MembershipCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipCollectionModelAllOfEmbedded`
        """
        model = MembershipCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testMembershipCollectionModelAllOfEmbedded(self):
        """Test MembershipCollectionModelAllOfEmbedded"""
