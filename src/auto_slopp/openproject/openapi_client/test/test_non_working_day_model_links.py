...
class TestNonWorkingDayModelLinks(unittest.TestCase):
    """NonWorkingDayModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonWorkingDayModelLinks:
        """Test NonWorkingDayModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonWorkingDayModelLinks`
        """
        model = NonWorkingDayModelLinks()
        if include_optional:
    ...
    def testNonWorkingDayModelLinks(self):
        """Test NonWorkingDayModelLinks"""
