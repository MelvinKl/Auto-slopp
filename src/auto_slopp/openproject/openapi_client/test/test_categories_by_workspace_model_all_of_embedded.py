...
class TestCategoriesByWorkspaceModelAllOfEmbedded(unittest.TestCase):
    """CategoriesByWorkspaceModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoriesByWorkspaceModelAllOfEmbedded:
        """Test CategoriesByWorkspaceModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoriesByWorkspaceModelAllOfEmbedded`
        """
        model = CategoriesByWorkspaceModelAllOfEmbedded()
        if include_optional:
            return CategoriesByWorkspaceModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testCategoriesByWorkspaceModelAllOfEmbedded(self):
        """Test CategoriesByWorkspaceModelAllOfEmbedded"""
