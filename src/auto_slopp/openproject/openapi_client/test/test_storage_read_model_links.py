...
class TestStorageReadModelLinks(unittest.TestCase):
    """StorageReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageReadModelLinks:
        """Test StorageReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageReadModelLinks`
        """
        model = StorageReadModelLinks()
        if include_optional:
            return StorageReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                type = {href=/api/v3/work_packages, method=POST},
                authentication_method = {href=/api/v3/work_packages, method=POST},
                origin = {href=/api/v3/work_packages, method=POST},
                open = {href=/api/v3/work_packages, method=POST},
                authorization_state = {href=/api/v3/work_packages, method=POST},
                authorize = {href=/api/v3/work_packages, method=POST},
                oauth_application = {href=/api/v3/work_packages, method=POST},
                oauth_client_credentials = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return StorageReadModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testStorageReadModelLinks(self):
        """Test StorageReadModelLinks"""
