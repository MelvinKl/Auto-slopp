...
class TestWorkPackageFormModelEmbedded(unittest.TestCase):
    """WorkPackageFormModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageFormModelEmbedded:
        """Test WorkPackageFormModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageFormModelEmbedded`
        """
        model = WorkPackageFormModelEmbedded()
        if include_optional:
            return WorkPackageFormModelEmbedded(
                payload = auto_slopp.openproject.openapi_client.models.work_package_write_model.WorkPackageWriteModel(
                    subject = '', 
                    description = null, 
                    ...
                    _links = auto_slopp.openproject.openapi_client.models.work_package_write_model__links.WorkPackageWriteModel__links(
                        category = null, 
                        type = null, 
                        priority = null, 
                        project = null, 
                        ...
                        version = null, 
                        parent = null, ), 
                    _meta = auto_slopp.openproject.openapi_client.models.work_package_write_model__meta.WorkPackageWriteModel__meta(
                        validate_custom_fields = True, ), ),
                var_schema = auto_slopp.openproject.openapi_client.models.work_package_schema_model.WorkPackageSchemaModel(
                    _type = 'Schema', 
                    _dependencies = [
                        ''
                        ], 
                    ...
                    version = , 
                    priority = , 
                    _links = auto_slopp.openproject.openapi_client.models.work_package_schema_model__links.WorkPackageSchemaModel__links(
                        self = null, ), ),
                validation_errors = auto_slopp.openproject.openapi_client.models.validation_errors.validationErrors()
            )
        else:
            return WorkPackageFormModelEmbedded(
        )
    ...
    def testWorkPackageFormModelEmbedded(self):
        """Test WorkPackageFormModelEmbedded"""
