...
class TestFileLinkWriteModelLinks(unittest.TestCase):
    """FileLinkWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkWriteModelLinks:
        """Test FileLinkWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkWriteModelLinks`
        """
        model = FileLinkWriteModelLinks()
        if include_optional:
    ...
    def testFileLinkWriteModelLinks(self):
        """Test FileLinkWriteModelLinks"""
