...
class TestStatusCollectionModel(unittest.TestCase):
    """StatusCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCollectionModel:
        """Test StatusCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCollectionModel`
        """
        model = StatusCollectionModel()
        if include_optional:
            return StatusCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.collection_links.CollectionLinks(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.status_collection_model_all_of__embedded.StatusCollectionModel_allOf__embedded(
                    elements = [
    ...
    def testStatusCollectionModel(self):
        """Test StatusCollectionModel"""
