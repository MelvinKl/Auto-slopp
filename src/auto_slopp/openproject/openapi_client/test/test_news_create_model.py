...
class TestNewsCreateModel(unittest.TestCase):
    """NewsCreateModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewsCreateModel:
        """Test NewsCreateModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewsCreateModel`
        """
        model = NewsCreateModel()
        if include_optional:
            return NewsCreateModel(
                title = '',
                summary = '',
                description = {format=markdown, raw=I am formatted!, html=I am formatted!},
                links = auto_slopp.openproject.openapi_client.models.news_create_model__links.NewsCreateModel__links(
                    project = null, )
            )
        else:
            return NewsCreateModel(
