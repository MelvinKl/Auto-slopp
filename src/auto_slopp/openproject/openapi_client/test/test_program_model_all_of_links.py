...
class TestProgramModelAllOfLinks(unittest.TestCase):
    """ProgramModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramModelAllOfLinks:
        """Test ProgramModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramModelAllOfLinks`
        """
        model = ProgramModelAllOfLinks()
        if include_optional:
            return ProgramModelAllOfLinks(
    ...
    def testProgramModelAllOfLinks(self):
        """Test ProgramModelAllOfLinks"""
