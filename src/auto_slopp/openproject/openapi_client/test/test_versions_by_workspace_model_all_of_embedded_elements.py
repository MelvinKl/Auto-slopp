...
class TestVersionsByWorkspaceModelAllOfEmbeddedElements(unittest.TestCase):
    """VersionsByWorkspaceModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionsByWorkspaceModelAllOfEmbeddedElements:
        """Test VersionsByWorkspaceModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionsByWorkspaceModelAllOfEmbeddedElements`
        """
        model = VersionsByWorkspaceModelAllOfEmbeddedElements()
        if include_optional:
            return VersionsByWorkspaceModelAllOfEmbeddedElements(
                id = 1,
                type = 'Version',
                name = '',
    ...
    def testVersionsByWorkspaceModelAllOfEmbeddedElements(self):
        """Test VersionsByWorkspaceModelAllOfEmbeddedElements"""
