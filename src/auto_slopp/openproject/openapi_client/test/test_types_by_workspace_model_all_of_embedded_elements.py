...
class TestTypesByWorkspaceModelAllOfEmbeddedElements(unittest.TestCase):
    """TypesByWorkspaceModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesByWorkspaceModelAllOfEmbeddedElements:
        """Test TypesByWorkspaceModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesByWorkspaceModelAllOfEmbeddedElements`
        """
        model = TypesByWorkspaceModelAllOfEmbeddedElements()
        if include_optional:
            return TypesByWorkspaceModelAllOfEmbeddedElements(
                id = 0,
                name = '',
                color = '',
                position = 56,
                ...
                links = auto_slopp.openproject.openapi_client.models.type_model__links.TypeModel__links(
                    self = null, )
            )
        else:
            return TypesByWorkspaceModelAllOfEmbeddedElements(
    ...
    def testTypesByWorkspaceModelAllOfEmbeddedElements(self):
        """Test TypesByWorkspaceModelAllOfEmbeddedElements"""
