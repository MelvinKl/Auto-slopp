...
class TestDocumentModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentModel:
        """Test DocumentModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentModel`
        """
        model = DocumentModel()
        if include_optional:
            return DocumentModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.document_model__links.DocumentModel__links(
                    self = null, 
                    project = null, 
                    attachments = null, )
            )
