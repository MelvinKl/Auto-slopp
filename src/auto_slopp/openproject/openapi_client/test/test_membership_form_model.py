...
class TestMembershipFormModel(unittest.TestCase):
    """MembershipFormModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipFormModel:
        """Test MembershipFormModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipFormModel`
        """
        model = MembershipFormModel()
        if include_optional:
            return MembershipFormModel(
                type = 'Form',
                embedded = auto_slopp.openproject.openapi_client.models.membership_form_model__embedded.MembershipFormModel__embedded(
                    payload = auto_slopp.openproject.openapi_client.models.membership_write_model.MembershipWriteModel(
                        _links = auto_slopp.openproject.openapi_client.models.membership_write_model__links.MembershipWriteModel__links(
                            principal = null, 
                            roles = [
                                null
                                ], 
                            project = null, ), 
                        _meta = auto_slopp.openproject.openapi_client.models.membership_write_model__meta.MembershipWriteModel__meta(
                            notification_message = null, 
                            send_notification = True, ), ), 
                    schema = null, 
                    validation_error = auto_slopp.openproject.openapi_client.models.membership_form_model__embedded_validation_error.MembershipFormModel__embedded_validationError(
                        base = auto_slopp.openproject.openapi_client.models.error_response.ErrorResponse(
                            _embedded = auto_slopp.openproject.openapi_client.models.error_response__embedded.ErrorResponse__embedded(
                                details = auto_slopp.openproject.openapi_client.models.error_response__embedded_details.ErrorResponse__embedded_details(
                                    attribute = 'project', ), ), 
                            _type = 'Error', 
                            error_identifier = 'urn:openproject-org:api:v3:errors:PropertyConstraintViolation', 
                            message = 'Project can't be blank.', ), 
                        principal = auto_slopp.openproject.openapi_client.models.error_response.ErrorResponse(
                            _type = 'Error', 
                            error_identifier = 'urn:openproject-org:api:v3:errors:PropertyConstraintViolation', 
                            message = 'Project can't be blank.', ), ), ),
                links = auto_slopp.openproject.openapi_client.models.membership_form_model__links.MembershipFormModel__links(
                    self = null, 
                    validate = [
                        null
                        ], 
    ...
    def testMembershipFormModel(self):
        """Test MembershipFormModel"""
