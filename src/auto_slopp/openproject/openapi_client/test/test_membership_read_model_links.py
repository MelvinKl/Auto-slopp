...
class TestMembershipReadModelLinks(unittest.TestCase):
    """MembershipReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipReadModelLinks:
        """Test MembershipReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipReadModelLinks`
        """
        model = MembershipReadModelLinks()
        if include_optional:
            return MembershipReadModelLinks(
                ...
                principal = {href=/api/v3/work_packages, method=POST},
                roles = [
                    null
                    ]
            )
    ...
    def testMembershipReadModelLinks(self):
        """Test MembershipReadModelLinks"""
