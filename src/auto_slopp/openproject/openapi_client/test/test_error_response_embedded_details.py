...
class TestErrorResponseEmbeddedDetails(unittest.TestCase):
    """ErrorResponseEmbeddedDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorResponseEmbeddedDetails:
        """Test ErrorResponseEmbeddedDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorResponseEmbeddedDetails`
        """
        model = ErrorResponseEmbeddedDetails()
        if include_optional:
    ...
    def testErrorResponseEmbeddedDetails(self):
        """Test ErrorResponseEmbeddedDetails"""
