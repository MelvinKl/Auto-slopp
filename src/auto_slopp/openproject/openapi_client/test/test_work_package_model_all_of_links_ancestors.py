...
class TestWorkPackageModelAllOfLinksAncestors(unittest.TestCase):
    """WorkPackageModelAllOfLinksAncestors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageModelAllOfLinksAncestors:
        """Test WorkPackageModelAllOfLinksAncestors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageModelAllOfLinksAncestors`
        """
        model = WorkPackageModelAllOfLinksAncestors()
        if include_optional:
            return WorkPackageModelAllOfLinksAncestors(
                href = '',
                title = '',
                templated = True,
                method = 'GET',
    ...
    def testWorkPackageModelAllOfLinksAncestors(self):
        """Test WorkPackageModelAllOfLinksAncestors"""
