...
class TestWorkPackagesModelAllOfLinks(unittest.TestCase):
    """WorkPackagesModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackagesModelAllOfLinks:
        """Test WorkPackagesModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackagesModelAllOfLinks`
        """
        model = WorkPackagesModelAllOfLinks()
        if include_optional:
    ...
    def testWorkPackagesModelAllOfLinks(self):
        """Test WorkPackagesModelAllOfLinks"""
