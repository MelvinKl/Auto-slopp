...
class TestPlaceholderUserCollectionModel(unittest.TestCase):
    """PlaceholderUserCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserCollectionModel:
        """Test PlaceholderUserCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserCollectionModel`
        """
        model = PlaceholderUserCollectionModel()
        if include_optional:
            return PlaceholderUserCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.placeholder_user_collection_model_all_of__links.PlaceholderUserCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.placeholder_user_collection_model_all_of__embedded.PlaceholderUserCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testPlaceholderUserCollectionModel(self):
        """Test PlaceholderUserCollectionModel"""
