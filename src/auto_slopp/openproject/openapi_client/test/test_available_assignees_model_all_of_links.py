...
class TestAvailableAssigneesModelAllOfLinks(unittest.TestCase):
    """AvailableAssigneesModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableAssigneesModelAllOfLinks:
        """Test AvailableAssigneesModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableAssigneesModelAllOfLinks`
        """
        model = AvailableAssigneesModelAllOfLinks()
        if include_optional:
    ...
    def testAvailableAssigneesModelAllOfLinks(self):
        """Test AvailableAssigneesModelAllOfLinks"""
