...
class TestNewsModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NewsModel:
        """Test NewsModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewsModel`
        """
        model = NewsModel()
        if include_optional:
            return NewsModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.news_model__links.NewsModel__links(
                    self = null, 
                    project = null, 
                    author = null, 
