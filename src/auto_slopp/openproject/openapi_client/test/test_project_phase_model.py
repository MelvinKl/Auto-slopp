...
class TestProjectPhaseModel(unittest.TestCase):
    """ProjectPhaseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseModel:
        """Test ProjectPhaseModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseModel`
        """
        ...
        if include_optional:
            return ProjectPhaseModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.project_phase_model__links.ProjectPhaseModel__links(
                    self = null, 
                    definition = null, 
                    project = null, )
            )
    ...
    def testProjectPhaseModel(self):
        """Test ProjectPhaseModel"""
