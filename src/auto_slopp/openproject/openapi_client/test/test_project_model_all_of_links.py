...
class TestProjectModelAllOfLinks(unittest.TestCase):
    """ProjectModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectModelAllOfLinks:
        """Test ProjectModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectModelAllOfLinks`
        """
        model = ProjectModelAllOfLinks()
        if include_optional:
            return ProjectModelAllOfLinks(
    ...
    def testProjectModelAllOfLinks(self):
        """Test ProjectModelAllOfLinks"""
