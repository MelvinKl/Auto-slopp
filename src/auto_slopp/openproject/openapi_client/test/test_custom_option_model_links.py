...
class TestCustomOptionModelLinks(unittest.TestCase):
    """CustomOptionModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomOptionModelLinks:
        """Test CustomOptionModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomOptionModelLinks`
        """
        model = CustomOptionModelLinks()
        if include_optional:
    ...
    def testCustomOptionModelLinks(self):
        """Test CustomOptionModelLinks"""
