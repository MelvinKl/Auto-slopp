...
class TestStorageFileModelAllOfLinks(unittest.TestCase):
    """StorageFileModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFileModelAllOfLinks:
        """Test StorageFileModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFileModelAllOfLinks`
        """
        model = StorageFileModelAllOfLinks()
        if include_optional:
    ...
    def testStorageFileModelAllOfLinks(self):
        """Test StorageFileModelAllOfLinks"""
