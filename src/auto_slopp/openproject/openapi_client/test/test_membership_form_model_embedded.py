...
class TestMembershipFormModelEmbedded(unittest.TestCase):
    """MembershipFormModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipFormModelEmbedded:
        """Test MembershipFormModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipFormModelEmbedded`
        """
        model = MembershipFormModelEmbedded()
        if include_optional:
    ...
    def testMembershipFormModelEmbedded(self):
        """Test MembershipFormModelEmbedded"""
