...
class TestStatusCollectionModelAllOfEmbedded(unittest.TestCase):
    """StatusCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCollectionModelAllOfEmbedded:
        """Test StatusCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCollectionModelAllOfEmbedded`
        """
        model = StatusCollectionModelAllOfEmbedded()
        if include_optional:
            return StatusCollectionModelAllOfEmbedded(
                elements = [
                    auto_slopp.openproject.openapi_client.models.status_model.StatusModel(
                        _type = 'Status', 
                        id = 1, 
                        name = '', 
                        is_closed = True, 
                        ...
                        position = 56, 
                        _links = auto_slopp.openproject.openapi_client.models.status_model__links.StatusModel__links(
                            self = null, ), )
                    ]
            )
        else:
    ...
    def testStatusCollectionModelAllOfEmbedded(self):
        """Test StatusCollectionModelAllOfEmbedded"""
