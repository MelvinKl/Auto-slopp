...
class TestTypesByWorkspaceModelAllOfLinks(unittest.TestCase):
    """TypesByWorkspaceModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesByWorkspaceModelAllOfLinks:
        """Test TypesByWorkspaceModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesByWorkspaceModelAllOfLinks`
        """
        model = TypesByWorkspaceModelAllOfLinks()
        if include_optional:
            return TypesByWorkspaceModelAllOfLinks(
    ...
    def testTypesByWorkspaceModelAllOfLinks(self):
        """Test TypesByWorkspaceModelAllOfLinks"""
