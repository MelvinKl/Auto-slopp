...
class TestPrincipalCollectionModel(unittest.TestCase):
    """PrincipalCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrincipalCollectionModel:
        """Test PrincipalCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrincipalCollectionModel`
        """
        model = PrincipalCollectionModel()
        if include_optional:
            return PrincipalCollectionModel(
                ...
                page_size = 0,
                offset = 0,
                embedded = auto_slopp.openproject.openapi_client.models.principal_collection_model_all_of__embedded.PrincipalCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testPrincipalCollectionModel(self):
        """Test PrincipalCollectionModel"""
