...
class TestProjectPhaseModelLinks(unittest.TestCase):
    """ProjectPhaseModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseModelLinks:
        """Test ProjectPhaseModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseModelLinks`
        """
        model = ProjectPhaseModelLinks()
        if include_optional:
            return ProjectPhaseModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                definition = {href=/api/v3/work_packages, method=POST},
    ...
    def testProjectPhaseModelLinks(self):
        """Test ProjectPhaseModelLinks"""
