...
class TestProjectStorageCollectionModel(unittest.TestCase):
    """ProjectStorageCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectStorageCollectionModel:
        """Test ProjectStorageCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectStorageCollectionModel`
        """
        model = ProjectStorageCollectionModel()
        if include_optional:
            return ProjectStorageCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.project_storage_collection_model_all_of__links.ProjectStorageCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.project_storage_collection_model_all_of__embedded.ProjectStorageCollectionModel_allOf__embedded(
                    elements = [
                        {_type=ProjectStorage, id=1337, projectFolderMode=manual, createdAt=2023-01-20T14:30:00.368Z, updatedAt=2023-05-23T11:57:48.618Z, _links={self={href=/api/v3/project_storages/23}, projectFolder={href=/api/v3/storages/81/files/30}, creator={title=Darth Vader, href=/api/v3/users/3}, project={title=Death Star 3.0, href=/api/v3/projects/11}, storage={title=Palpatine's Data Vault, href=/api/v3/storages/81}, open={href=/api/v3/storages/81/open}, openWithConnectionEnsured={href=/api/v3/storages/81/open}}}
                        ], )
            )
        else:
            return ProjectStorageCollectionModel(
    ...
    def testProjectStorageCollectionModel(self):
        """Test ProjectStorageCollectionModel"""
