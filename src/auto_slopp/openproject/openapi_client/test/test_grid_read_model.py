...
class TestGridReadModel(unittest.TestCase):
    """GridReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridReadModel:
        """Test GridReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridReadModel`
        """
        model = GridReadModel()
        if include_optional:
            return GridReadModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.grid_read_model__links.GridReadModel__links(
                    self = null, 
                    attachments = null, 
                    add_attachment = null, 
                    scope = null, 
