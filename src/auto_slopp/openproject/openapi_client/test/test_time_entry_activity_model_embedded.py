...
class TestTimeEntryActivityModelEmbedded(unittest.TestCase):
    """TimeEntryActivityModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryActivityModelEmbedded:
        """Test TimeEntryActivityModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryActivityModelEmbedded`
        """
        model = TimeEntryActivityModelEmbedded()
        if include_optional:
    ...
    def testTimeEntryActivityModelEmbedded(self):
        """Test TimeEntryActivityModelEmbedded"""
