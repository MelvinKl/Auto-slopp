...
class TestStorageFileModel(unittest.TestCase):
    """StorageFileModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageFileModel:
        """Test StorageFileModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageFileModel`
        """
        model = StorageFileModel()
        if include_optional:
