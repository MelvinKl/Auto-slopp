    ...
    def make_instance(self, include_optional) -> ListAvailableParentProjectCandidatesModel:
        ...
        if include_optional:
            return ListAvailableParentProjectCandidatesModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.list_available_parent_project_candidates_model_all_of__links.List_available_parent_project_candidatesModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.list_available_parent_project_candidates_model_all_of__embedded.List_available_parent_project_candidatesModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
