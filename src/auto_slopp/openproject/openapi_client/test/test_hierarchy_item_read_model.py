...
class TestHierarchyItemReadModel(unittest.TestCase):
    """HierarchyItemReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyItemReadModel:
        """Test HierarchyItemReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyItemReadModel`
        """
        model = HierarchyItemReadModel()
        if include_optional:
            return HierarchyItemReadModel(
                type = 'HierarchyItem',
                id = 56,
                label = '',
                short = '',
                ...
                formatted_weight = '',
                depth = 56,
                links = auto_slopp.openproject.openapi_client.models.hierarchy_item_read_model__links.HierarchyItemReadModel__links(
                    self = null, 
                    parent = null, 
                    children = [
                        null
    ...
    def testHierarchyItemReadModel(self):
        """Test HierarchyItemReadModel"""
