...
class TestNonWorkingDayCollectionModel(unittest.TestCase):
    """NonWorkingDayCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonWorkingDayCollectionModel:
        """Test NonWorkingDayCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonWorkingDayCollectionModel`
        """
        model = NonWorkingDayCollectionModel()
        if include_optional:
            return NonWorkingDayCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.non_working_day_collection_model_all_of__links.NonWorkingDayCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.non_working_day_collection_model_all_of__embedded.NonWorkingDayCollectionModel_allOf__embedded(
                    elements = [
                        {_type=NonWorkingDay, date=2022-12-25, name=Christmas, _links={self={href=/api/v3/days/non_working/2022-12-25, title=Christmas}}}
                        ], )
            )
        else:
            return NonWorkingDayCollectionModel(
    ...
    def testNonWorkingDayCollectionModel(self):
        """Test NonWorkingDayCollectionModel"""
