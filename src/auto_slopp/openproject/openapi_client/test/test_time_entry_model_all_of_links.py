...
class TestTimeEntryModelAllOfLinks(unittest.TestCase):
    """TimeEntryModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryModelAllOfLinks:
        """Test TimeEntryModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryModelAllOfLinks`
        """
        model = TimeEntryModelAllOfLinks()
        if include_optional:
            return TimeEntryModelAllOfLinks(
                ...
                entity = {href=/api/v3/work_packages, method=POST},
                user = {href=/api/v3/work_packages, method=POST},
                activity = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return TimeEntryModelAllOfLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testTimeEntryModelAllOfLinks(self):
        """Test TimeEntryModelAllOfLinks"""
