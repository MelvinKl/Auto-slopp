...
class TestTypesApi(unittest.TestCase):
    ...
    def test_list_all_types(self) -> None:
        """Test case for list_all_types

        List all Types
        """
        pass

    def test_list_types_available_in_a_project(self) -> None:
        """Test case for list_types_available_in_a_project
