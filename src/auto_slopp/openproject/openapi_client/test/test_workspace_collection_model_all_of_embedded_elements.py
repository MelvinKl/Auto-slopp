...
class TestWorkspaceCollectionModelAllOfEmbeddedElements(unittest.TestCase):
    """WorkspaceCollectionModelAllOfEmbeddedElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceCollectionModelAllOfEmbeddedElements:
        """Test WorkspaceCollectionModelAllOfEmbeddedElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceCollectionModelAllOfEmbeddedElements`
        """
        model = WorkspaceCollectionModelAllOfEmbeddedElements()
        if include_optional:
            return WorkspaceCollectionModelAllOfEmbeddedElements(
                type = 'Project',
                id = 1,
                identifier = '',
                name = '',
                ...
                links = auto_slopp.openproject.openapi_client.models.project_model_all_of__links.ProjectModel_allOf__links(
                    update = null, 
    ...
    def testWorkspaceCollectionModelAllOfEmbeddedElements(self):
        """Test WorkspaceCollectionModelAllOfEmbeddedElements"""
