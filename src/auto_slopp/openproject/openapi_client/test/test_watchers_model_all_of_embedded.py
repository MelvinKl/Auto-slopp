...
class TestWatchersModelAllOfEmbedded(unittest.TestCase):
    """WatchersModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchersModelAllOfEmbedded:
        """Test WatchersModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchersModelAllOfEmbedded`
        """
        model = WatchersModelAllOfEmbedded()
        if include_optional:
    ...
    def testWatchersModelAllOfEmbedded(self):
        """Test WatchersModelAllOfEmbedded"""
