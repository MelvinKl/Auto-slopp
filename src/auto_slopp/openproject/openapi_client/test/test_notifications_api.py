...
class TestNotificationsApi(unittest.TestCase):
    ...
    def test_unread_notification(self) -> None:
        """Test case for unread_notification

        Unread notification
        """
        pass

    def test_unread_notifications(self) -> None:
        """Test case for unread_notifications

        Unread all notifications
        """
        pass

    def test_view_notification(self) -> None:
    ...
    def test_view_notification_detail(self) -> None:
        """Test case for view_notification_detail
