...
class TestVersionCollectionModelAllOfEmbedded(unittest.TestCase):
    """VersionCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionCollectionModelAllOfEmbedded:
        """Test VersionCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionCollectionModelAllOfEmbedded`
        """
        model = VersionCollectionModelAllOfEmbedded()
        if include_optional:
            return VersionCollectionModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testVersionCollectionModelAllOfEmbedded(self):
        """Test VersionCollectionModelAllOfEmbedded"""
