...
class TestWatchersModel(unittest.TestCase):
    """WatchersModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchersModel:
        """Test WatchersModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchersModel`
        """
        model = WatchersModel()
        if include_optional:
            return WatchersModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.watchers_model_all_of__links.WatchersModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.watchers_model_all_of__embedded.WatchersModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
