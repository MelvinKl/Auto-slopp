...
class TestProjectPhaseDefinitionCollectionModelAllOfEmbedded(unittest.TestCase):
    """ProjectPhaseDefinitionCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseDefinitionCollectionModelAllOfEmbedded:
        """Test ProjectPhaseDefinitionCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseDefinitionCollectionModelAllOfEmbedded`
        """
        model = ProjectPhaseDefinitionCollectionModelAllOfEmbedded()
        if include_optional:
            return ProjectPhaseDefinitionCollectionModelAllOfEmbedded(
                elements = [
    ...
    def testProjectPhaseDefinitionCollectionModelAllOfEmbedded(self):
        """Test ProjectPhaseDefinitionCollectionModelAllOfEmbedded"""
