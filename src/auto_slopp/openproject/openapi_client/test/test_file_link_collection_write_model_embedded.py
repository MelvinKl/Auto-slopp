...
class TestFileLinkCollectionWriteModelEmbedded(unittest.TestCase):
    """FileLinkCollectionWriteModelEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkCollectionWriteModelEmbedded:
        """Test FileLinkCollectionWriteModelEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkCollectionWriteModelEmbedded`
        """
        model = FileLinkCollectionWriteModelEmbedded()
        if include_optional:
            return FileLinkCollectionWriteModelEmbedded(
                elements = [
                    {originData={id=5503, name=logo.png, mimeType=image/png, size=16042, createdAt=2021-12-19T09:42:10.170Z, lastModifiedAt=2021-12-20T14:00:13.987Z, createdByName=Luke Skywalker, lastModifiedByName=Anakin Skywalker}, _links={storageUrl={href=https://nextcloud.my-deathstar.org}}}
                    ]
            )
        else:
            return FileLinkCollectionWriteModelEmbedded(
    ...
    def testFileLinkCollectionWriteModelEmbedded(self):
        """Test FileLinkCollectionWriteModelEmbedded"""
