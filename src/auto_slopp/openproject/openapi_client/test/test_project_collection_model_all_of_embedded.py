...
class TestProjectCollectionModelAllOfEmbedded(unittest.TestCase):
    """ProjectCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectCollectionModelAllOfEmbedded:
        """Test ProjectCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCollectionModelAllOfEmbedded`
        """
        model = ProjectCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testProjectCollectionModelAllOfEmbedded(self):
        """Test ProjectCollectionModelAllOfEmbedded"""
