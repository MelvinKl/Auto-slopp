...
class TestUserCollectionModelAllOfEmbedded(unittest.TestCase):
    """UserCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCollectionModelAllOfEmbedded:
        """Test UserCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCollectionModelAllOfEmbedded`
        """
        model = UserCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testUserCollectionModelAllOfEmbedded(self):
        """Test UserCollectionModelAllOfEmbedded"""
