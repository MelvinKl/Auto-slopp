...
class TestGridWriteModel(unittest.TestCase):
    """GridWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridWriteModel:
        """Test GridWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridWriteModel`
        """
        model = GridWriteModel()
        if include_optional:
            return GridWriteModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.grid_write_model__links.GridWriteModel__links(
                    scope = null, )
            )
        else:
            return GridWriteModel(
