...
class TestWorkspacesApi(unittest.TestCase):
    ...
    def test_favorite_workspace(self) -> None:
        """Test case for favorite_workspace

        Favorite Workspace
        """
        pass

    def test_list_types_available_in_a_workspace(self) -> None:
        """Test case for list_types_available_in_a_workspace

        List types available in a workspace
        """
        pass

    def test_unfavorite_workspace(self) -> None:
        """Test case for unfavorite_workspace

        Unfavorite Workspace
        """
        pass

    def test_view_workspace_schema(self) -> None:
        """Test case for view_workspace_schema
