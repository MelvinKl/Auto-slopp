...
class TestEmojiReactionModelLinks(unittest.TestCase):
    """EmojiReactionModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiReactionModelLinks:
        """Test EmojiReactionModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiReactionModelLinks`
        """
        model = EmojiReactionModelLinks()
        if include_optional:
            return EmojiReactionModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
                reactable = {href=/api/v3/work_packages, method=POST},
                reacting_users = [
                    null
                    ]
            )
    ...
    def testEmojiReactionModelLinks(self):
        """Test EmojiReactionModelLinks"""
