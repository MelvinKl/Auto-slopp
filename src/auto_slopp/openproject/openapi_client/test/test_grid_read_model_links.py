...
class TestGridReadModelLinks(unittest.TestCase):
    """GridReadModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridReadModelLinks:
        """Test GridReadModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridReadModelLinks`
        """
        model = GridReadModelLinks()
        if include_optional:
            return GridReadModelLinks(
                ...
                scope = {href=/api/v3/work_packages, method=POST},
    ...
    def testGridReadModelLinks(self):
        """Test GridReadModelLinks"""
