...
class TestTypesByWorkspaceModel(unittest.TestCase):
    """TypesByWorkspaceModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesByWorkspaceModel:
        """Test TypesByWorkspaceModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesByWorkspaceModel`
        """
        model = TypesByWorkspaceModel()
        if include_optional:
            return TypesByWorkspaceModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.types_by_workspace_model_all_of__links.Types_by_WorkspaceModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.types_by_workspace_model_all_of__embedded.Types_by_WorkspaceModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testTypesByWorkspaceModel(self):
        """Test TypesByWorkspaceModel"""
