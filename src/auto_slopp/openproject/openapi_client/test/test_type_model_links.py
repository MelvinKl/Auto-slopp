...
class TestTypeModelLinks(unittest.TestCase):
    """TypeModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeModelLinks:
        """Test TypeModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeModelLinks`
        """
        model = TypeModelLinks()
        if include_optional:
