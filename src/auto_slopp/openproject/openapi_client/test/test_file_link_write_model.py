...
class TestFileLinkWriteModel(unittest.TestCase):
    """FileLinkWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkWriteModel:
        """Test FileLinkWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkWriteModel`
        """
        model = FileLinkWriteModel()
        if include_optional:
    ...
    def testFileLinkWriteModel(self):
        """Test FileLinkWriteModel"""
