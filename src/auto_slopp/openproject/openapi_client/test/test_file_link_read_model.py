...
class TestFileLinkReadModel(unittest.TestCase):
    """FileLinkReadModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkReadModel:
        """Test FileLinkReadModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkReadModel`
        """
        model = FileLinkReadModel()
        if include_optional:
            return FileLinkReadModel(
                ...
                origin_data = auto_slopp.openproject.openapi_client.models.file_link_origin_data_model.FileLinkOriginDataModel(
                    id = '', 
                    name = '', 
                    mime_type = '', 
                    size = 0, 
                ...
                embedded = auto_slopp.openproject.openapi_client.models.file_link_read_model__embedded.FileLinkReadModel__embedded(
                    storage = auto_slopp.openproject.openapi_client.models.storage_read_model.StorageReadModel(
                        id = 56, 
                        _type = 'Storage', 
                        name = '', 
                        storage_audience = '', 
                        ...
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        configured = True, 
                        _embedded = auto_slopp.openproject.openapi_client.models.storage_read_model__embedded.StorageReadModel__embedded(
                            oauth_application = {id=1337, _type=OAuthApplication, name=Vader's secure OAuth app, clientId=O5h6WObhMg1Z8IcLHRE3_LMh4jJYmmca2V6OTFSv8DA, confidential=true, createdAt=2022-12-07T12:56:42.626Z, updatedAt=2022-12-07T12:56:42.626Z, scopes=[api_v3], _links={self={href=/api/v3/oauth_applications/1337}, owner={href=/api/v3/users/13, title=Darth Vader}, integration={href=/api/v3/storages/42, title=Death Star Cloud}, redirectUri=[{href=https://death-star.cloud.tools/index.php/apps/integration_openproject/oauth-redirect}]}}, 
                            oauth_client_credentials = {id=1337, _type=OAuthClientCredentials, clientId=O5h6WObhMg1Z8IcLHRE3_LMh4jJYmmca2V6OTFSv8DA, confidential=true, createdAt=2022-12-07T12:56:42.836Z, updatedAt=2022-12-07T12:56:42.836Z, _links={self={href=/api/v3/oauth_client_credentials/1337}, integration={href=/api/v3/storages/42, title=Death Star Cloud}}}, ), 
                        _links = auto_slopp.openproject.openapi_client.models.storage_read_model__links.StorageReadModel__links(
                            self = null, 
                            type = null, 
                            ...
                            authorize = null, ), ), ),
                links = auto_slopp.openproject.openapi_client.models.file_link_read_model__links.FileLinkReadModel__links(
                    self = null, 
                    storage = null, 
                    container = null, 
                    creator = null, 
                    ...
                    status = null, 
                    origin_open = null, 
                    static_origin_open = null, 
                    origin_open_location = null, 
                    static_origin_open_location = null, 
                    static_origin_download = null, )
            )
        else:
            return FileLinkReadModel(
        )
    ...
    def testFileLinkReadModel(self):
        """Test FileLinkReadModel"""
