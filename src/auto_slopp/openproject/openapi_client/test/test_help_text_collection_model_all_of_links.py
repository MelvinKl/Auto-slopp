...
class TestHelpTextCollectionModelAllOfLinks(unittest.TestCase):
    """HelpTextCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelpTextCollectionModelAllOfLinks:
        """Test HelpTextCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelpTextCollectionModelAllOfLinks`
        """
        model = HelpTextCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testHelpTextCollectionModelAllOfLinks(self):
        """Test HelpTextCollectionModelAllOfLinks"""
