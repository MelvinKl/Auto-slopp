...
class TestWeekDayCollectionModel(unittest.TestCase):
    """WeekDayCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionModel:
        """Test WeekDayCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionModel`
        """
        model = WeekDayCollectionModel()
        if include_optional:
            return WeekDayCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.week_day_collection_model_all_of__links.WeekDayCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.week_day_collection_model_all_of__embedded.WeekDayCollectionModel_allOf__embedded(
                    elements = [
                        {_type=WeekDay, day=5, name=Friday, working=false, _links={self={href=/api/v3/day/week/5, title=Friday}}}
                        ], )
            )
        else:
            return WeekDayCollectionModel(
    ...
    def testWeekDayCollectionModel(self):
        """Test WeekDayCollectionModel"""
