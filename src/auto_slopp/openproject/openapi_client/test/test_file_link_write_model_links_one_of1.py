...
class TestFileLinkWriteModelLinksOneOf1(unittest.TestCase):
    """FileLinkWriteModelLinksOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkWriteModelLinksOneOf1:
        """Test FileLinkWriteModelLinksOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkWriteModelLinksOneOf1`
        """
        model = FileLinkWriteModelLinksOneOf1()
        if include_optional:
            return FileLinkWriteModelLinksOneOf1(
                storage_url = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return FileLinkWriteModelLinksOneOf1(
                storage_url = {href=/api/v3/work_packages, method=POST},
    ...
    def testFileLinkWriteModelLinksOneOf1(self):
        """Test FileLinkWriteModelLinksOneOf1"""
