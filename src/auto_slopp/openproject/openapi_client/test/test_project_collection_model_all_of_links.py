...
class TestProjectCollectionModelAllOfLinks(unittest.TestCase):
    """ProjectCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectCollectionModelAllOfLinks:
        """Test ProjectCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCollectionModelAllOfLinks`
        """
        model = ProjectCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testProjectCollectionModelAllOfLinks(self):
        """Test ProjectCollectionModelAllOfLinks"""
