...
class TestWeekDayCollectionModelAllOfLinks(unittest.TestCase):
    """WeekDayCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionModelAllOfLinks:
        """Test WeekDayCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionModelAllOfLinks`
        """
        model = WeekDayCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testWeekDayCollectionModelAllOfLinks(self):
        """Test WeekDayCollectionModelAllOfLinks"""
