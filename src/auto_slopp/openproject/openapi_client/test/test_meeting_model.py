...
class TestMeetingModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MeetingModel:
        """Test MeetingModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingModel`
        """
        model = MeetingModel()
        if include_optional:
            return MeetingModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.meeting_model__links.MeetingModel__links(
                    self = null, 
                    author = null, 
                    project = null, 
                    attachments = null, 
