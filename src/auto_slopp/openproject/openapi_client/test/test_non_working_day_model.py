...
class TestNonWorkingDayModel(unittest.TestCase):
    """NonWorkingDayModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonWorkingDayModel:
        """Test NonWorkingDayModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonWorkingDayModel`
        """
        ...
        if include_optional:
            return NonWorkingDayModel(
                ...
                name = '',
                links = auto_slopp.openproject.openapi_client.models.non_working_day_model__links.NonWorkingDayModel__links(
                    self = null, )
            )
        else:
            return NonWorkingDayModel(
    ...
    def testNonWorkingDayModel(self):
        """Test NonWorkingDayModel"""
