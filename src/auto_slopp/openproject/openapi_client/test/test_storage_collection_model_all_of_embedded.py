...
class TestStorageCollectionModelAllOfEmbedded(unittest.TestCase):
    """StorageCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageCollectionModelAllOfEmbedded:
        """Test StorageCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageCollectionModelAllOfEmbedded`
        """
        model = StorageCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testStorageCollectionModelAllOfEmbedded(self):
        """Test StorageCollectionModelAllOfEmbedded"""
