...
class TestWorkScheduleApi(unittest.TestCase):
    """WorkScheduleApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WorkScheduleApi()

    def tearDown(self) -> None:
        pass

    def test_create_non_working_day(self) -> None:
        """Test case for create_non_working_day

        Creates a non-working day (NOT IMPLEMENTED)
        """
        pass

    def test_delete_non_working_day(self) -> None:
        """Test case for delete_non_working_day

        Removes a non-working day (NOT IMPLEMENTED)
        """
        pass

    def test_list_days(self) -> None:
        """Test case for list_days

        Lists days
        """
        pass

    def test_list_non_working_days(self) -> None:
        """Test case for list_non_working_days

        Lists all non working days
        """
        pass

    def test_list_week_days(self) -> None:
        """Test case for list_week_days

        Lists week days
        """
        pass

    def test_update_non_working_day(self) -> None:
        """Test case for update_non_working_day

        Update a non-working day attributes (NOT IMPLEMENTED)
        """
        pass

    def test_update_week_day(self) -> None:
        """Test case for update_week_day

        Update a week day attributes (NOT IMPLEMENTED)
        """
        pass

    def test_update_week_days(self) -> None:
        """Test case for update_week_days

        Update week days (NOT IMPLEMENTED)
        """
        pass

    def test_view_day(self) -> None:
        """Test case for view_day

        View day
        """
        pass

    def test_view_non_working_day(self) -> None:
        """Test case for view_non_working_day

        View a non-working day
        """
        pass

    def test_view_week_day(self) -> None:
        """Test case for view_week_day
