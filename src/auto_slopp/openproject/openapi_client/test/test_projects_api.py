...
class TestProjectsApi(unittest.TestCase):
    ...
    def test_create_project_copy(self) -> None:
        """Test case for create_project_copy
    ...
    def test_favorite_project(self) -> None:
        """Test case for favorite_project

        Favorite Project
        """
        pass

    def test_list_available_parent_project_candidates(self) -> None:
        """Test case for list_available_parent_project_candidates
    ...
    def test_list_projects_with_version(self) -> None:
        """Test case for list_projects_with_version

        List projects having version
        """
        pass

    def test_list_workspaces_with_version(self) -> None:
        """Test case for list_workspaces_with_version

        List workspaces having version
        """
        pass

    def test_project_copy_form(self) -> None:
        """Test case for project_copy_form

        Project copy form
        """
        pass

    def test_project_create_form(self) -> None:
        """Test case for project_create_form
    ...
    def test_project_update_form(self) -> None:
        """Test case for project_update_form

        Project update form
        """
        pass

    def test_unfavorite_project(self) -> None:
        """Test case for unfavorite_project
    ...
    def test_view_project(self) -> None:
        """Test case for view_project

        View project
        """
        pass

    def test_view_project_configuration(self) -> None:
        """Test case for view_project_configuration

        View project configuration
        """
        pass

    def test_view_project_schema(self) -> None:
        """Test case for view_project_schema

        View project schema
        """
        pass

    def test_view_project_status(self) -> None:
        """Test case for view_project_status
