...
class TestQuerySortByModel(unittest.TestCase):
    """QuerySortByModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuerySortByModel:
        """Test QuerySortByModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuerySortByModel`
        """
        model = QuerySortByModel()
        if include_optional:
