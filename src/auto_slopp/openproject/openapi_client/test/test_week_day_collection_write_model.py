...
class TestWeekDayCollectionWriteModel(unittest.TestCase):
    """WeekDayCollectionWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayCollectionWriteModel:
        """Test WeekDayCollectionWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayCollectionWriteModel`
        """
        model = WeekDayCollectionWriteModel()
        if include_optional:
            return WeekDayCollectionWriteModel(
                type = 'Collection',
                embedded = auto_slopp.openproject.openapi_client.models.week_day_collection_write_model__embedded.WeekDayCollectionWriteModel__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testWeekDayCollectionWriteModel(self):
        """Test WeekDayCollectionWriteModel"""
