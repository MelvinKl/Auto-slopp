...
class TestErrorResponseEmbedded(unittest.TestCase):
    """ErrorResponseEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorResponseEmbedded:
        """Test ErrorResponseEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorResponseEmbedded`
        """
        model = ErrorResponseEmbedded()
        if include_optional:
    ...
    def testErrorResponseEmbedded(self):
        """Test ErrorResponseEmbedded"""
