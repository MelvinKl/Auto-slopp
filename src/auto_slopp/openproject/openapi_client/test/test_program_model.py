...
class TestProgramModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProgramModel:
        """Test ProgramModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramModel`
        """
        model = ProgramModel()
        if include_optional:
            return ProgramModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.program_model_all_of__links.ProgramModel_allOf__links(
                    update = null, 
