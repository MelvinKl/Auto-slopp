...
class TestTimeEntryModel(unittest.TestCase):
    """TimeEntryModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryModel:
        """Test TimeEntryModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryModel`
        """
        ...
        if include_optional:
            return TimeEntryModel(
                ...
                spent_on = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                hours = '',
                ongoing = True,
                ...
                links = auto_slopp.openproject.openapi_client.models.time_entry_model_all_of__links.TimeEntryModel_allOf__links(
                    self = null, 
