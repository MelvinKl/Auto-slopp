...
class TestAttachmentModelDigest(unittest.TestCase):
    """AttachmentModelDigest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentModelDigest:
        """Test AttachmentModelDigest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentModelDigest`
        """
        model = AttachmentModelDigest()
        if include_optional:
            return AttachmentModelDigest(
                algorithm = '',
                hash = ''
            )
        else:
    ...
    def testAttachmentModelDigest(self):
        """Test AttachmentModelDigest"""
