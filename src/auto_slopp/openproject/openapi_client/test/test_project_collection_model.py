...
class TestProjectCollectionModel(unittest.TestCase):
    """ProjectCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectCollectionModel:
        """Test ProjectCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCollectionModel`
        """
        model = ProjectCollectionModel()
        if include_optional:
            return ProjectCollectionModel(
                ...
                page_size = 0,
                offset = 0,
                embedded = auto_slopp.openproject.openapi_client.models.project_collection_model_all_of__embedded.ProjectCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testProjectCollectionModel(self):
        """Test ProjectCollectionModel"""
