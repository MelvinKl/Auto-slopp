...
class TestHierarchyItemCollectionModelAllOfEmbedded(unittest.TestCase):
    """HierarchyItemCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyItemCollectionModelAllOfEmbedded:
        """Test HierarchyItemCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyItemCollectionModelAllOfEmbedded`
        """
        model = HierarchyItemCollectionModelAllOfEmbedded()
        if include_optional:
            return HierarchyItemCollectionModelAllOfEmbedded(
                elements = [
    ...
    def testHierarchyItemCollectionModelAllOfEmbedded(self):
        """Test HierarchyItemCollectionModelAllOfEmbedded"""
