...
class TestWeekDayWriteModel(unittest.TestCase):
    """WeekDayWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeekDayWriteModel:
        """Test WeekDayWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeekDayWriteModel`
        """
        model = WeekDayWriteModel()
        if include_optional:
    ...
    def testWeekDayWriteModel(self):
        """Test WeekDayWriteModel"""
