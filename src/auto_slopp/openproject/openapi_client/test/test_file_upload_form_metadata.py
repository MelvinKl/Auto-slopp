...
class TestFileUploadFormMetadata(unittest.TestCase):
    """FileUploadFormMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileUploadFormMetadata:
        """Test FileUploadFormMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileUploadFormMetadata`
        """
        model = FileUploadFormMetadata()
        if include_optional:
            return FileUploadFormMetadata(
                file_name = ''
            )
        else:
            return FileUploadFormMetadata(
    ...
    def testFileUploadFormMetadata(self):
        """Test FileUploadFormMetadata"""
