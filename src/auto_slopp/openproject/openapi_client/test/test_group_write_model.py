...
class TestGroupWriteModel(unittest.TestCase):
    """GroupWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupWriteModel:
        """Test GroupWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupWriteModel`
        """
        model = GroupWriteModel()
        if include_optional:
            return GroupWriteModel(
                name = '',
                links = auto_slopp.openproject.openapi_client.models.group_write_model__links.GroupWriteModel__links(
                    members = [
                        null
                        ], )
            )
