...
class TestMembershipWriteModelMeta(unittest.TestCase):
    """MembershipWriteModelMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipWriteModelMeta:
        """Test MembershipWriteModelMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipWriteModelMeta`
        """
        model = MembershipWriteModelMeta()
        if include_optional:
            return MembershipWriteModelMeta(
                notification_message = {format=markdown, raw=I am formatted!, html=I am formatted!},
    ...
    def testMembershipWriteModelMeta(self):
        """Test MembershipWriteModelMeta"""
