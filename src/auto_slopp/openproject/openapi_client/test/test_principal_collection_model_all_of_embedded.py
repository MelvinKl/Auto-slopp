...
class TestPrincipalCollectionModelAllOfEmbedded(unittest.TestCase):
    """PrincipalCollectionModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrincipalCollectionModelAllOfEmbedded:
        """Test PrincipalCollectionModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrincipalCollectionModelAllOfEmbedded`
        """
        model = PrincipalCollectionModelAllOfEmbedded()
        if include_optional:
    ...
    def testPrincipalCollectionModelAllOfEmbedded(self):
        """Test PrincipalCollectionModelAllOfEmbedded"""
