...
class TestWorkPackageWriteModelLinks(unittest.TestCase):
    """WorkPackageWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageWriteModelLinks:
        """Test WorkPackageWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageWriteModelLinks`
        """
        model = WorkPackageWriteModelLinks()
        if include_optional:
            return WorkPackageWriteModelLinks(
    ...
    def testWorkPackageWriteModelLinks(self):
        """Test WorkPackageWriteModelLinks"""
