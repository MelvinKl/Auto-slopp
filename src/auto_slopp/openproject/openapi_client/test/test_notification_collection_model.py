    ...
    def make_instance(self, include_optional) -> NotificationCollectionModel:
        ...
        if include_optional:
            return NotificationCollectionModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.notification_collection_model_all_of__links.NotificationCollectionModel_allOf__links(
                    self = null, 
                    jump_to = null, 
                    change_size = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.notification_collection_model_all_of__embedded.NotificationCollectionModel_allOf__embedded(
                    elements = [
                        auto_slopp.openproject.openapi_client.models.notification_model.NotificationModel(
                            _type = 'Notification', 
                            id = 1, 
                            reason = 'assigned', 
                            read_ian = True, 
                            details = [
                                auto_slopp.openproject.openapi_client.models.values_property_model.ValuesPropertyModel(
                                    _type = 'Values::Property', 
                                    property = '', 
                                    value = '', 
                                    _links = auto_slopp.openproject.openapi_client.models.values_property_model__links.ValuesPropertyModel__links(
                                        self = null, 
                                        schema = null, ), )
                                ], 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            _embedded = auto_slopp.openproject.openapi_client.models.notification_model__embedded.NotificationModel__embedded(
                                actor = null, 
                                project = null, 
                            ...
                            _links = auto_slopp.openproject.openapi_client.models.notification_model__links.NotificationModel__links(
                                self = null, 
                                read_ian = null, 
                                unread_ian = null, 
                                project = null, 
                    ...
                    details_schemas = [
                        auto_slopp.openproject.openapi_client.models.schema_model.SchemaModel(
                            _type = 'Schema', 
                            _dependencies = [
                                ''
                                ], 
                            _links = auto_slopp.openproject.openapi_client.models.schema_model__links.SchemaModel__links(
                                self = null, ), )
                        ], )
            )
        else:
