    ...
    def make_instance(self, include_optional) -> MembershipWriteModel:
        ...
        if include_optional:
            return MembershipWriteModel(
                links = auto_slopp.openproject.openapi_client.models.membership_write_model__links.MembershipWriteModel__links(
                    principal = null, 
                    roles = [
                        null
                        ], 
                    project = null, ),
                meta = auto_slopp.openproject.openapi_client.models.membership_write_model__meta.MembershipWriteModel__meta(
