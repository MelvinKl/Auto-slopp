...
class TestRelationWriteModelLinks(unittest.TestCase):
    """RelationWriteModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationWriteModelLinks:
        """Test RelationWriteModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationWriteModelLinks`
        """
        model = RelationWriteModelLinks()
        if include_optional:
            return RelationWriteModelLinks(
    ...
    def testRelationWriteModelLinks(self):
        """Test RelationWriteModelLinks"""
