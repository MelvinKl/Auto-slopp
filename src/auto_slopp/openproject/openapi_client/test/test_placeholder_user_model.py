...
class TestPlaceholderUserModel(unittest.TestCase):
    """PlaceholderUserModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserModel:
        """Test PlaceholderUserModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserModel`
        """
        model = PlaceholderUserModel()
        if include_optional:
            return PlaceholderUserModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.placeholder_user_model_all_of__links.PlaceholderUserModel_allOf__links(
                    show_user = null, 
                    delete = null, 
    ...
    def testPlaceholderUserModel(self):
        """Test PlaceholderUserModel"""
