...
class TestDayCollectionModelAllOfLinks(unittest.TestCase):
    """DayCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayCollectionModelAllOfLinks:
        """Test DayCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayCollectionModelAllOfLinks`
        """
        model = DayCollectionModelAllOfLinks()
        if include_optional:
    ...
    def testDayCollectionModelAllOfLinks(self):
        """Test DayCollectionModelAllOfLinks"""
