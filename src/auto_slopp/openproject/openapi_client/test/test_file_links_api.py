...
class TestFileLinksApi(unittest.TestCase):
    ...
    def test_get_project_storage(self) -> None:
        """Test case for get_project_storage
    ...
    def test_open_project_storage(self) -> None:
        """Test case for open_project_storage

        Open the project storage
        """
        pass

    def test_open_storage(self) -> None:
        """Test case for open_storage
