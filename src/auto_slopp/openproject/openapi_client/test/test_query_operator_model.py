...
class TestQueryOperatorModel(unittest.TestCase):
    """QueryOperatorModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryOperatorModel:
        """Test QueryOperatorModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryOperatorModel`
        """
        model = QueryOperatorModel()
        if include_optional:
    ...
    def testQueryOperatorModel(self):
        """Test QueryOperatorModel"""
