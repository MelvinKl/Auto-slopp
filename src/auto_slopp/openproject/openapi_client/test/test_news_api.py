...
class TestNewsApi(unittest.TestCase):
    ...
    def test_delete_news(self) -> None:
        """Test case for delete_news

        Delete news
        """
        pass

    def test_list_news(self) -> None:
        """Test case for list_news

        List News
        """
        pass

    def test_update_news(self) -> None:
    ...
    def test_view_news(self) -> None:
        """Test case for view_news
