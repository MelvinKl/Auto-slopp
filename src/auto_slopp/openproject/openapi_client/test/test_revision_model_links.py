...
class TestRevisionModelLinks(unittest.TestCase):
    """RevisionModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionModelLinks:
        """Test RevisionModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionModelLinks`
        """
        model = RevisionModelLinks()
        if include_optional:
            return RevisionModelLinks(
                ...
                show_revision = {href=/api/v3/work_packages, method=POST}
            )
        else:
            return RevisionModelLinks(
                var_self = {href=/api/v3/work_packages, method=POST},
    ...
    def testRevisionModelLinks(self):
        """Test RevisionModelLinks"""
