...
class TestPriorityCollectionModel(unittest.TestCase):
    """PriorityCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriorityCollectionModel:
        """Test PriorityCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriorityCollectionModel`
        """
        model = PriorityCollectionModel()
        if include_optional:
            return PriorityCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.priority_collection_model_all_of__links.PriorityCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.priority_collection_model_all_of__embedded.PriorityCollectionModel_allOf__embedded(
                    elements = [
                        {_type=Priority, _links={self={href=/api/v3/priorities/1, title=Low}}, id=1, name=Low, position=1, isDefault=false, isActive=true}
                        ], )
            )
        else:
            return PriorityCollectionModel(
    ...
    def testPriorityCollectionModel(self):
        """Test PriorityCollectionModel"""
