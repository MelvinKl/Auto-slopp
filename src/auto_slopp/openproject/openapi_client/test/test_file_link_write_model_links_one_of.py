...
class TestFileLinkWriteModelLinksOneOf(unittest.TestCase):
    """FileLinkWriteModelLinksOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkWriteModelLinksOneOf:
        """Test FileLinkWriteModelLinksOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkWriteModelLinksOneOf`
        """
        model = FileLinkWriteModelLinksOneOf()
        if include_optional:
    ...
    def testFileLinkWriteModelLinksOneOf(self):
        """Test FileLinkWriteModelLinksOneOf"""
