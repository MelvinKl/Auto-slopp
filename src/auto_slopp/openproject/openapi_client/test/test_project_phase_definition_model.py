...
class TestProjectPhaseDefinitionModel(unittest.TestCase):
    """ProjectPhaseDefinitionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseDefinitionModel:
        """Test ProjectPhaseDefinitionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseDefinitionModel`
        """
        model = ProjectPhaseDefinitionModel()
        if include_optional:
            return ProjectPhaseDefinitionModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.project_phase_definition_model__links.ProjectPhaseDefinitionModel__links(
                    self = null, )
            )
        else:
            return ProjectPhaseDefinitionModel(
    ...
    def testProjectPhaseDefinitionModel(self):
        """Test ProjectPhaseDefinitionModel"""
