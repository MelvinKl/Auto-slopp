    ...
    def make_instance(self, include_optional) -> MembershipReadModel:
        ...
        if include_optional:
            return MembershipReadModel(
                ...
                embedded = auto_slopp.openproject.openapi_client.models.membership_read_model__embedded.MembershipReadModel__embedded(
                    project = null, 
                    principal = null, 
                    roles = [
                        {_type=Role, id=3, name=Manager, _links={self={href=/api/v3/roles/3, title=Manager}}}
                        ], ),
                links = auto_slopp.openproject.openapi_client.models.membership_read_model__links.MembershipReadModel__links(
                    self = null, 
                    schema = null, 
                    update = null, 
