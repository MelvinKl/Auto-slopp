...
class TestCategoriesApi(unittest.TestCase):
    ...
    def test_list_categories_of_a_project(self) -> None:
        """Test case for list_categories_of_a_project

        List categories of a project
        """
        pass

    def test_list_categories_of_a_workspace(self) -> None:
        """Test case for list_categories_of_a_workspace
