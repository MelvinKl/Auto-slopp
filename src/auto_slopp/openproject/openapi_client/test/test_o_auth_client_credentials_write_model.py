...
class TestOAuthClientCredentialsWriteModel(unittest.TestCase):
    """OAuthClientCredentialsWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthClientCredentialsWriteModel:
        """Test OAuthClientCredentialsWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthClientCredentialsWriteModel`
        """
        model = OAuthClientCredentialsWriteModel()
        if include_optional:
    ...
    def testOAuthClientCredentialsWriteModel(self):
        """Test OAuthClientCredentialsWriteModel"""
