...
class TestPlaceholderUserCreateModel(unittest.TestCase):
    """PlaceholderUserCreateModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceholderUserCreateModel:
        """Test PlaceholderUserCreateModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceholderUserCreateModel`
        """
        model = PlaceholderUserCreateModel()
        if include_optional:
    ...
    def testPlaceholderUserCreateModel(self):
        """Test PlaceholderUserCreateModel"""
