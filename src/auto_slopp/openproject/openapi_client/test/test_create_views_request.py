...
class TestCreateViewsRequest(unittest.TestCase):
    """CreateViewsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateViewsRequest:
        """Test CreateViewsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateViewsRequest`
        """
        model = CreateViewsRequest()
        if include_optional:
            return CreateViewsRequest(
                links = auto_slopp.openproject.openapi_client.models.create_views_request__links.Create_views_request__links(
    ...
    def testCreateViewsRequest(self):
        """Test CreateViewsRequest"""
