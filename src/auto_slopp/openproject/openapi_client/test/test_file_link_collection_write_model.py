...
class TestFileLinkCollectionWriteModel(unittest.TestCase):
    """FileLinkCollectionWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileLinkCollectionWriteModel:
        """Test FileLinkCollectionWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileLinkCollectionWriteModel`
        """
        model = FileLinkCollectionWriteModel()
        if include_optional:
            return FileLinkCollectionWriteModel(
                embedded = auto_slopp.openproject.openapi_client.models.file_link_collection_write_model__embedded.FileLinkCollectionWriteModel__embedded(
                    elements = [
    ...
    def testFileLinkCollectionWriteModel(self):
        """Test FileLinkCollectionWriteModel"""
