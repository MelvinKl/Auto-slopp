...
class TestGridCollectionModel(unittest.TestCase):
    """GridCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridCollectionModel:
        """Test GridCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridCollectionModel`
        """
        model = GridCollectionModel()
        if include_optional:
            return GridCollectionModel(
                ...
                page_size = 0,
                offset = 1,
                embedded = auto_slopp.openproject.openapi_client.models.grid_collection_model_all_of__embedded.GridCollectionModel_allOf__embedded(
                    elements = [
                        auto_slopp.openproject.openapi_client.models.grid_read_model.GridReadModel(
                            _type = 'Grid', 
                            id = 1, 
                            row_count = 1, 
                            column_count = 1, 
                            widgets = [
                                auto_slopp.openproject.openapi_client.models.grid_widget_model.GridWidgetModel(
                                    _type = 'GridWidget', 
                                    id = 1, 
                                    identifier = '', 
                                    start_row = 1, 
                            ...
                            _links = auto_slopp.openproject.openapi_client.models.grid_read_model__links.GridReadModel__links(
                                self = null, 
                                attachments = null, 
                                add_attachment = null, 
                                scope = null, 
    ...
    def testGridCollectionModel(self):
        """Test GridCollectionModel"""
