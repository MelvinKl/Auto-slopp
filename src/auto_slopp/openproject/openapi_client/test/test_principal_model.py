...
class TestPrincipalModel(unittest.TestCase):
    """PrincipalModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrincipalModel:
        """Test PrincipalModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrincipalModel`
        """
        ...
        if include_optional:
            return PrincipalModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.principal_model__links.PrincipalModel__links(
                    self = null, 
                    memberships = null, )
            )
        else:
