...
class TestProjectStorageModel(unittest.TestCase):
    """ProjectStorageModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectStorageModel:
        """Test ProjectStorageModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectStorageModel`
        """
        model = ProjectStorageModel()
        if include_optional:
            return ProjectStorageModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.project_storage_model__links.ProjectStorageModel__links(
                    self = null, 
                    creator = null, 
                    storage = null, 
                    project = null, 
                    project_folder = null, 
                    open = null, 
                    open_with_connection_ensured = null, )
            )
        else:
            return ProjectStorageModel(
                type = 'ProjectStorage',
    ...
    def testProjectStorageModel(self):
        """Test ProjectStorageModel"""
