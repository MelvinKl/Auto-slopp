...
class TestProjectPhaseDefinitionCollectionModel(unittest.TestCase):
    """ProjectPhaseDefinitionCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPhaseDefinitionCollectionModel:
        """Test ProjectPhaseDefinitionCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPhaseDefinitionCollectionModel`
        """
        model = ProjectPhaseDefinitionCollectionModel()
        if include_optional:
            return ProjectPhaseDefinitionCollectionModel(
                type = 'Collection',
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.project_phase_definition_collection_model_all_of__links.ProjectPhaseDefinitionCollectionModel_allOf__links(
                    self = null, ),
                page_size = 0,
                offset = 0,
                embedded = auto_slopp.openproject.openapi_client.models.project_phase_definition_collection_model_all_of__embedded.ProjectPhaseDefinitionCollectionModel_allOf__embedded(
                    elements = [
                        {_type=ProjectPhaseDefinition, id=1337, name=Initiating, startGate=true, startGateName=Before Initiating, finishGate=true, finishGateName=null, createdAt=2023-01-20T14:30:00.368Z, updatedAt=2023-05-23T11:57:48.618Z, _links={self={href=/api/v3/project_phase_definitions/23}}}
                        ], )
            )
        else:
            return ProjectPhaseDefinitionCollectionModel(
    ...
    def testProjectPhaseDefinitionCollectionModel(self):
        """Test ProjectPhaseDefinitionCollectionModel"""
