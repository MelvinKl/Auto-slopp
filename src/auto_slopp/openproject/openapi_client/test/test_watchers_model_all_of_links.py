...
class TestWatchersModelAllOfLinks(unittest.TestCase):
    """WatchersModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchersModelAllOfLinks:
        """Test WatchersModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchersModelAllOfLinks`
        """
        model = WatchersModelAllOfLinks()
        if include_optional:
    ...
    def testWatchersModelAllOfLinks(self):
        """Test WatchersModelAllOfLinks"""
