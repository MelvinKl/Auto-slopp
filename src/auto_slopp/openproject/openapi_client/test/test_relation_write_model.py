...
class TestRelationWriteModel(unittest.TestCase):
    """RelationWriteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationWriteModel:
        """Test RelationWriteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationWriteModel`
        """
        model = RelationWriteModel()
        if include_optional:
            return RelationWriteModel(
                type = 'relates',
                description = '',
                lag = 0,
                links = auto_slopp.openproject.openapi_client.models.relation_write_model__links.RelationWriteModel__links(
                    to = null, )
            )
        else:
            return RelationWriteModel(
    ...
    def testRelationWriteModel(self):
        """Test RelationWriteModel"""
