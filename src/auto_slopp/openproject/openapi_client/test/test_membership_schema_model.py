...
class TestMembershipSchemaModel(unittest.TestCase):
    """MembershipSchemaModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MembershipSchemaModel:
        """Test MembershipSchemaModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MembershipSchemaModel`
        """
        model = MembershipSchemaModel()
        if include_optional:
            return MembershipSchemaModel(
                ...
                links = auto_slopp.openproject.openapi_client.models.schema_model__links.SchemaModel__links(
                    self = null, ),
                ...
                updated_at = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                notification_message = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                ...
                project = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                principal = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
                    ...
                    placeholder = '', 
                    _links = auto_slopp.openproject.openapi_client.models._links._links(), ),
                roles = auto_slopp.openproject.openapi_client.models.schema_property_model.SchemaPropertyModel(
                    type = '', 
                    name = '', 
                    required = True, 
                    has_default = True, 
    ...
    def testMembershipSchemaModel(self):
        """Test MembershipSchemaModel"""
