...
class TestExecuteCustomActionRequest(unittest.TestCase):
    """ExecuteCustomActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteCustomActionRequest:
        """Test ExecuteCustomActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteCustomActionRequest`
        """
        model = ExecuteCustomActionRequest()
        if include_optional:
            return ExecuteCustomActionRequest(
                links = auto_slopp.openproject.openapi_client.models.execute_custom_action_request__links.Execute_custom_action_request__links(
                    work_package = auto_slopp.openproject.openapi_client.models.execute_custom_action_request__links_work_package.Execute_custom_action_request__links_workPackage(
                        href = '', ), ),
                lock_version = ''
            )
        else:
    ...
    def testExecuteCustomActionRequest(self):
        """Test ExecuteCustomActionRequest"""
