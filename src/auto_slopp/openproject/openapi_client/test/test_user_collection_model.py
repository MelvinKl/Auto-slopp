...
class TestUserCollectionModel(unittest.TestCase):
    """UserCollectionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCollectionModel:
        """Test UserCollectionModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserCollectionModel`
        """
        ...
        if include_optional:
            return UserCollectionModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.user_collection_model_all_of__links.UserCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.user_collection_model_all_of__embedded.UserCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
    ...
    def testUserCollectionModel(self):
        """Test UserCollectionModel"""
