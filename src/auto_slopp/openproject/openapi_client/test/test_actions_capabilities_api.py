...
class TestActionsCapabilitiesApi(unittest.TestCase):
    """ActionsCapabilitiesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ActionsCapabilitiesApi()
    ...
    def test_view_action(self) -> None:
        """Test case for view_action

        View action
        """
        pass

    def test_view_capabilities(self) -> None:
        """Test case for view_capabilities

        View capabilities
        """
        pass

    def test_view_global_context(self) -> None:
        """Test case for view_global_context
