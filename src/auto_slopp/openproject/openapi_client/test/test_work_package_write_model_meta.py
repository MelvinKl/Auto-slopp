...
class TestWorkPackageWriteModelMeta(unittest.TestCase):
    """WorkPackageWriteModelMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageWriteModelMeta:
        """Test WorkPackageWriteModelMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageWriteModelMeta`
        """
        model = WorkPackageWriteModelMeta()
        if include_optional:
            return WorkPackageWriteModelMeta(
    ...
    def testWorkPackageWriteModelMeta(self):
        """Test WorkPackageWriteModelMeta"""
