...
class TestWorkPackageSchemaModelLinks(unittest.TestCase):
    """WorkPackageSchemaModelLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkPackageSchemaModelLinks:
        """Test WorkPackageSchemaModelLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkPackageSchemaModelLinks`
        """
        model = WorkPackageSchemaModelLinks()
        if include_optional:
            return WorkPackageSchemaModelLinks(
    ...
    def testWorkPackageSchemaModelLinks(self):
        """Test WorkPackageSchemaModelLinks"""
