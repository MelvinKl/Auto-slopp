...
class TestTypesByWorkspaceModelAllOfEmbedded(unittest.TestCase):
    """TypesByWorkspaceModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesByWorkspaceModelAllOfEmbedded:
        """Test TypesByWorkspaceModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesByWorkspaceModelAllOfEmbedded`
        """
        model = TypesByWorkspaceModelAllOfEmbedded()
        if include_optional:
            return TypesByWorkspaceModelAllOfEmbedded(
                elements = [
                    null
                    ]
            )
    ...
    def testTypesByWorkspaceModelAllOfEmbedded(self):
        """Test TypesByWorkspaceModelAllOfEmbedded"""
