    ...
    def make_instance(self, include_optional) -> GroupCollectionModel:
        ...
        if include_optional:
            return GroupCollectionModel(
                ...
                total = 0,
                count = 0,
                links = auto_slopp.openproject.openapi_client.models.group_collection_model_all_of__links.GroupCollectionModel_allOf__links(
                    self = null, ),
                embedded = auto_slopp.openproject.openapi_client.models.group_collection_model_all_of__embedded.GroupCollectionModel_allOf__embedded(
                    elements = [
                        null
                        ], )
            )
