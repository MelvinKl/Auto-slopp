...
class TestRelationCollectionModelAllOfLinks(unittest.TestCase):
    """RelationCollectionModelAllOfLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationCollectionModelAllOfLinks:
        """Test RelationCollectionModelAllOfLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationCollectionModelAllOfLinks`
        """
        model = RelationCollectionModelAllOfLinks()
        if include_optional:
            return RelationCollectionModelAllOfLinks(
    ...
    def testRelationCollectionModelAllOfLinks(self):
        """Test RelationCollectionModelAllOfLinks"""
