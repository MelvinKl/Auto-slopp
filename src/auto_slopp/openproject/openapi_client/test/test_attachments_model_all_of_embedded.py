...
class TestAttachmentsModelAllOfEmbedded(unittest.TestCase):
    """AttachmentsModelAllOfEmbedded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsModelAllOfEmbedded:
        """Test AttachmentsModelAllOfEmbedded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsModelAllOfEmbedded`
        """
        model = AttachmentsModelAllOfEmbedded()
        if include_optional:
    ...
    def testAttachmentsModelAllOfEmbedded(self):
        """Test AttachmentsModelAllOfEmbedded"""
