...
class TestCreateWorkPackageReminderRequest(unittest.TestCase):
    """CreateWorkPackageReminderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWorkPackageReminderRequest:
        """Test CreateWorkPackageReminderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWorkPackageReminderRequest`
        """
        model = CreateWorkPackageReminderRequest()
        if include_optional:
            return CreateWorkPackageReminderRequest(
    ...
    def testCreateWorkPackageReminderRequest(self):
        """Test CreateWorkPackageReminderRequest"""
