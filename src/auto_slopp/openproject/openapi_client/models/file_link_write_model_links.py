...
FILELINKWRITEMODELLINKS_ONE_OF_SCHEMAS = ["FileLinkWriteModelLinksOneOf", "FileLinkWriteModelLinksOneOf1"]

class FileLinkWriteModelLinks(BaseModel):
    """
    FileLinkWriteModelLinks
    """
    # data type: FileLinkWriteModelLinksOneOf
    oneof_schema_1_validator: Optional[FileLinkWriteModelLinksOneOf] = None
    # data type: FileLinkWriteModelLinksOneOf1
    oneof_schema_2_validator: Optional[FileLinkWriteModelLinksOneOf1] = None
    actual_instance: Optional[Union[FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1]] = None
    one_of_schemas: Set[str] = { "FileLinkWriteModelLinksOneOf", "FileLinkWriteModelLinksOneOf1" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = FileLinkWriteModelLinks.model_construct()
        error_messages = []
        match = 0
        # validate data type: FileLinkWriteModelLinksOneOf
        if not isinstance(v, FileLinkWriteModelLinksOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FileLinkWriteModelLinksOneOf`")
        else:
            match += 1
        # validate data type: FileLinkWriteModelLinksOneOf1
        if not isinstance(v, FileLinkWriteModelLinksOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FileLinkWriteModelLinksOneOf1`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in FileLinkWriteModelLinks with oneOf schemas: FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in FileLinkWriteModelLinks with oneOf schemas: FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into FileLinkWriteModelLinksOneOf
        try:
            instance.actual_instance = FileLinkWriteModelLinksOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into FileLinkWriteModelLinksOneOf1
        try:
            instance.actual_instance = FileLinkWriteModelLinksOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into FileLinkWriteModelLinks with oneOf schemas: FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FileLinkWriteModelLinks with oneOf schemas: FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FileLinkWriteModelLinksOneOf, FileLinkWriteModelLinksOneOf1]]:
