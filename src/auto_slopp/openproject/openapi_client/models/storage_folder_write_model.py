...
class StorageFolderWriteModel(BaseModel):
    """
    StorageFolderWriteModel
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the folder to be created")
    parent_id: StrictStr = Field(description="Unique identifier of the parent folder in which the new folder should be created in", alias="parentId")
