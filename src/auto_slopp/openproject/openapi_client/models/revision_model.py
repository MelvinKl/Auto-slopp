...
class RevisionModel(BaseModel):
    ...
    RevisionModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Revision's id, assigned by OpenProject")
    identifier: StrictStr = Field(description="The raw SCM identifier of the revision (e.g. full SHA hash)")
    formatted_identifier: StrictStr = Field(description="The SCM identifier of the revision, formatted (e.g. shortened unambiguous SHA hash). May be identical to identifier in many cases", alias="formattedIdentifier")
    author_name: StrictStr = Field(description="The name of the author that committed this revision. Note that this name is retrieved from the repository and does not identify a user in OpenProject.", alias="authorName")
    message: Formattable = Field(description="The commit message of the revision")
    created_at: datetime = Field(description="The time this revision was committed to the repository", alias="createdAt")
    links: Optional[RevisionModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "identifier", "formattedIdentifier", "authorName", "message", "createdAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formattedIdentifier": obj.get("formattedIdentifier"),
            "authorName": obj.get("authorName"),
            "message": Formattable.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "createdAt": obj.get("createdAt"),
            "_links": RevisionModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
