...
class ListAvailableParentProjectCandidatesModel(BaseModel):
    """
    ...
    links: ListAvailableParentProjectCandidatesModelAllOfLinks = Field(alias="_links")
    embedded: ListAvailableParentProjectCandidatesModelAllOfEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_type", "total", "count", "_links", "_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_links": ListAvailableParentProjectCandidatesModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_embedded": ListAvailableParentProjectCandidatesModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
