...
class CreateWorkPackageReminderRequest(BaseModel):
    """
    CreateWorkPackageReminderRequest
    """ # noqa: E501
    remind_at: datetime = Field(description="The date and time when the reminder is due", alias="remindAt")
    note: Optional[StrictStr] = Field(default=None, description="The note of the reminder")
    __properties: ClassVar[List[str]] = ["remindAt", "note"]
