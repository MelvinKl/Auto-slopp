...
class DayCollectionModelAllOfEmbedded(BaseModel):
    """
    DayCollectionModelAllOfEmbedded
    """ # noqa: E501
    elements: List[DayModel] = Field(description="The array of days. Each day has a name and a working status indicating if it is a working or a non-working day.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [DayModel.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
