...
class RelationWriteModel(BaseModel):
    """
    RelationWriteModel
    """ # noqa: E501
    type: StrictStr = Field(description="The relation type.")
    ...
    links: RelationWriteModelLinks = Field(alias="_links")
    __properties: ClassVar[List[str]] = ["type", "description", "lag", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lag": obj.get("lag"),
            "_links": RelationWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
