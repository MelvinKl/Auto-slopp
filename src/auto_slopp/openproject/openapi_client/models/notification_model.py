...
class NotificationModel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Notification id")
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the notification")
    read_ian: Optional[StrictBool] = Field(default=None, description="Whether the notification is marked as read", alias="readIAN")
    details: Optional[List[ValuesPropertyModel]] = Field(default=None, description="A list of objects including detailed information about the notification.")
    created_at: Optional[datetime] = Field(default=None, description="The time the notification was created at", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="The time the notification was last updated", alias="updatedAt")
    embedded: Optional[NotificationModelEmbedded] = Field(default=None, alias="_embedded")
    links: Optional[NotificationModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "reason", "readIAN", "details", "createdAt", "updatedAt", "_embedded", "_links"]
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['assigned', 'commented', 'created', 'dateAlert', 'mentioned', 'prioritized', 'processed', 'responsible', 'subscribed', 'scheduled', 'watched']):
            raise ValueError("must be one of enum values ('assigned', 'commented', 'created', 'dateAlert', 'mentioned', 'prioritized', 'processed', 'responsible', 'subscribed', 'scheduled', 'watched')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "readIAN": obj.get("readIAN"),
            "details": [ValuesPropertyModel.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "_embedded": NotificationModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": NotificationModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
