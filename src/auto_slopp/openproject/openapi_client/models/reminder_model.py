...
class ReminderModel(BaseModel):
    ...
    ReminderModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Reminder id")
    note: Optional[StrictStr] = Field(default=None, description="The note of the reminder")
    remind_at: Optional[datetime] = Field(default=None, description="The date and time when the reminder is due", alias="remindAt")
    links: Optional[ReminderModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "note", "remindAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": ReminderModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
