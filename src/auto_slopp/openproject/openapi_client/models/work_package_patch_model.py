...
class WorkPackagePatchModel(BaseModel):
    """
    WorkPackagePatchModel
    """ # noqa: E501
    subject: Optional[StrictStr] = Field(default=None, description="Work package subject")
    ...
    ignore_non_working_days: Optional[StrictBool] = Field(default=None, description="When scheduling, whether or not to ignore the non working days being defined. A work package with the flag set to true will be allowed to be scheduled to a non working day.", alias="ignoreNonWorkingDays")
    links: Optional[WorkPackageWriteModelLinks] = Field(default=None, alias="_links")
    meta: Optional[WorkPackageWriteModelMeta] = Field(default=None, alias="_meta")
    lock_version: StrictInt = Field(description="The version of the item as used for optimistic locking", alias="lockVersion")
    __properties: ClassVar[List[str]] = ["subject", "description", "scheduleManually", "startDate", "dueDate", "estimatedTime", "duration", "ignoreNonWorkingDays", "_links", "_meta", "lockVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": WorkPackageWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_meta": WorkPackageWriteModelMeta.from_dict(obj["_meta"]) if obj.get("_meta") is not None else None,
