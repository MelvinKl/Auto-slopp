...
class MembershipFormModel(BaseModel):
    """
    MembershipFormModel
    """ # noqa: E501
    type: StrictStr = Field(alias="_type")
    embedded: MembershipFormModelEmbedded = Field(alias="_embedded")
    links: MembershipFormModelLinks = Field(alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type"),
            "_embedded": MembershipFormModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": MembershipFormModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
