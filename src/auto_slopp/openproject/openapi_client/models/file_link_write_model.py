...
class FileLinkWriteModel(BaseModel):
    """
    FileLinkWriteModel
    """ # noqa: E501
    origin_data: FileLinkOriginDataModel = Field(alias="originData")
    links: FileLinkWriteModelLinks = Field(alias="_links")
    __properties: ClassVar[List[str]] = ["originData", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": FileLinkWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
