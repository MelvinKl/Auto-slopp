...
class RelationReadModel(BaseModel):
    """
    RelationReadModel
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    id: Optional[StrictInt] = Field(default=None, description="Relation ID")
    name: Optional[StrictStr] = Field(default=None, description="The internationalised name of this type of relation")
    type: Optional[StrictStr] = Field(default=None, description="The relation type.")
    reverse_type: Optional[StrictStr] = Field(default=None, description="The type of relation from the perspective of the related work package.", alias="reverseType")
    description: Optional[StrictStr] = Field(default=None, description="A descriptive text for the relation.")
    lag: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The lag in days between closing of `from` and start of `to`")
    embedded: Optional[RelationReadModelEmbedded] = Field(default=None, alias="_embedded")
    links: Optional[RelationReadModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "name", "type", "reverseType", "description", "lag", "_embedded", "_links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['relates', 'duplicates', 'duplicated', 'blocks', 'blocked', 'precedes', 'follows', 'includes', 'partof', 'requires', 'required']):
            raise ValueError("must be one of enum values ('relates', 'duplicates', 'duplicated', 'blocks', 'blocked', 'precedes', 'follows', 'includes', 'partof', 'requires', 'required')")
        return value

    @field_validator('reverse_type')
    def reverse_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "reverseType": obj.get("reverseType"),
            "description": obj.get("description"),
            "lag": obj.get("lag"),
            "_embedded": RelationReadModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": RelationReadModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
