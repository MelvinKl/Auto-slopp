...
class ActivityCommentWriteModel(BaseModel):
    """
    ActivityCommentWriteModel
    """ # noqa: E501
    comment: Optional[ActivityCommentWriteModelComment] = None
    internal: Optional[StrictBool] = Field(default=False, description="Determines whether this comment is internal. This is only available to users with `add_internal_comments` permission. It defaults to `false`, if unset.")
    __properties: ClassVar[List[str]] = ["comment", "internal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comment": ActivityCommentWriteModelComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
