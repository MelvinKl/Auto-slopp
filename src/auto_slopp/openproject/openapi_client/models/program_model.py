...
class ProgramModel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Programs' id")
    identifier: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    active: Optional[StrictBool] = Field(default=None, description="Indicates whether the program is currently active or already archived")
    favorited: Optional[StrictBool] = Field(default=None, description="Indicates whether the program is favorited by the current user")
    status_explanation: Optional[Formattable] = Field(default=None, description="A text detailing and explaining why the program has the reported status", alias="statusExplanation")
    public: Optional[StrictBool] = Field(default=None, description="Indicates whether the program is accessible for everybody")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Time of the most recent change to the program", alias="updatedAt")
    links: Optional[ProgramModelAllOfLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": ProgramModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
