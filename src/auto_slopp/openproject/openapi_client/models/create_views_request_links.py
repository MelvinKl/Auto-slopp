...
class CreateViewsRequestLinks(BaseModel):
    """
    CreateViewsRequestLinks
    """ # noqa: E501
    query: Optional[CreateViewsRequestLinksQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": CreateViewsRequestLinksQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
