...
class PortfolioCollectionModel(BaseModel):
    """
    PortfolioCollectionModel
    """ # noqa: E501
    type: StrictStr = Field(alias="_type")
    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="The total amount of elements available in the collection.")
    count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Actual amount of elements in this response.")
    links: PortfolioCollectionModelAllOfLinks = Field(alias="_links")
    page_size: Annotated[int, Field(strict=True, ge=0)] = Field(description="The amount of elements per page. If not set by the request this value defaults to the server's system settings.", alias="pageSize")
    offset: Annotated[int, Field(strict=True, ge=0)] = Field(description="The page offset indicating on which page the element collection starts.")
    embedded: PortfolioCollectionModelAllOfEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_type", "total", "count", "_links", "pageSize", "offset", "_embedded"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortfolioCollectionModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortfolioCollectionModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_links": PortfolioCollectionModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "pageSize": obj.get("pageSize"),
            "offset": obj.get("offset"),
            "_embedded": PortfolioCollectionModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
