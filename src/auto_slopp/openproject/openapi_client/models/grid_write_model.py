...
class GridWriteModel(BaseModel):
    """
    GridWriteModel
    """ # noqa: E501
    row_count: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The number of rows the grid has", alias="rowCount")
    column_count: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The number of columns the grid has", alias="columnCount")
    widgets: Optional[List[GridWidgetModel]] = Field(default=None, description="The set of `GridWidget`s selected for the grid.  # Conditions  - The widgets must not overlap.")
    links: Optional[GridWriteModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["rowCount", "columnCount", "widgets", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": GridWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
