...
class WorkPackageFormModelEmbedded(BaseModel):
    """
    WorkPackageFormModelEmbedded
    """ # noqa: E501
    payload: Optional[WorkPackageWriteModel] = None
    var_schema: Optional[WorkPackageSchemaModel] = Field(default=None, alias="schema")
    validation_errors: Optional[Dict[str, Any]] = Field(default=None, description="All validation errors, where the key is the faulty property. The object is empty, if the request body is valid.", alias="validationErrors")
    __properties: ClassVar[List[str]] = ["payload", "schema", "validationErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": WorkPackageWriteModel.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
            "schema": WorkPackageSchemaModel.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
