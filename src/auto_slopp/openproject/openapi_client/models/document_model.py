...
class DocumentModel(BaseModel):
    ...
    DocumentModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Document's id")
    title: Optional[StrictStr] = Field(default=None, description="The title chosen for the document")
    description: Optional[Formattable] = Field(default=None, description="A text describing the document")
    created_at: Optional[datetime] = Field(default=None, description="The time the document was created at", alias="createdAt")
    links: Optional[DocumentModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "title", "description", "createdAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": DocumentModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
