...
class ListReminders200Response(BaseModel):
    """
    ...
    embedded: ListReminders200ResponseEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_type", "total", "count", "_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_embedded": ListReminders200ResponseEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
