...
class MembershipReadModelEmbedded(BaseModel):
    """
    MembershipReadModelEmbedded
    """ # noqa: E501
    project: Optional[MembershipReadModelEmbeddedProject] = None
    principal: Optional[MembershipReadModelEmbeddedPrincipal] = None
    roles: Optional[List[RoleModel]] = None
    __properties: ClassVar[List[str]] = ["project", "principal", "roles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": MembershipReadModelEmbeddedProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "principal": MembershipReadModelEmbeddedPrincipal.from_dict(obj["principal"]) if obj.get("principal") is not None else None,
            "roles": [RoleModel.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
