...
class PriorityModel(BaseModel):
    ...
    PriorityModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Priority id")
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Priority name")
    position: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Sort index of the priority")
    is_default: Optional[StrictBool] = Field(default=None, description="Indicates whether this is the default value", alias="isDefault")
    is_active: Optional[StrictBool] = Field(default=None, description="Indicates whether the priority is available", alias="isActive")
    links: Optional[PriorityModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "name", "position", "isDefault", "isActive", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": PriorityModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
