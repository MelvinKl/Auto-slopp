...
class ErrorResponseEmbedded(BaseModel):
    """
    ErrorResponseEmbedded
    """ # noqa: E501
    details: Optional[ErrorResponseEmbeddedDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": ErrorResponseEmbeddedDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
