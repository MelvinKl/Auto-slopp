...
class CategoriesByWorkspaceModelAllOfEmbeddedElements(BaseModel):
    """
    Collection of Categories
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Category id")
    name: Optional[StrictStr] = Field(default=None, description="Category name")
    links: Optional[CategoryModelLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "_links": CategoryModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
