...
class GroupModel(BaseModel):
    ...
    links: GroupModelAllOfLinks = Field(alias="_links")
    embedded: GroupModelAllOfEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_type", "id", "name", "createdAt", "updatedAt", "_links", "_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": GroupModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_embedded": GroupModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
