...
class GroupModelAllOfEmbedded(BaseModel):
    """
    GroupModelAllOfEmbedded
    """ # noqa: E501
    members: Optional[List[UserModel]] = Field(default=None, description="Embedded list of members.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [UserModel.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
