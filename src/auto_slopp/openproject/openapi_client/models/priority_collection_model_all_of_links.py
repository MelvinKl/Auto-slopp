...
class PriorityCollectionModelAllOfLinks(BaseModel):
    """
    PriorityCollectionModelAllOfLinks
    """ # noqa: E501
    var_self: PriorityCollectionModelAllOfLinksSelf = Field(alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": PriorityCollectionModelAllOfLinksSelf.from_dict(obj["self"]) if obj.get("self") is not None else None
        })
        return _obj
