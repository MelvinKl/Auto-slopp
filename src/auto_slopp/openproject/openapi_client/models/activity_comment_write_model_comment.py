...
class ActivityCommentWriteModelComment(BaseModel):
    """
    ActivityCommentWriteModelComment
    """ # noqa: E501
    raw: Optional[StrictStr] = Field(default=None, description="The raw content of the comment")
    __properties: ClassVar[List[str]] = ["raw"]
