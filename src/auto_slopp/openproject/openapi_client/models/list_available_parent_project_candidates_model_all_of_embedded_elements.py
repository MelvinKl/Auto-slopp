...
class ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements(BaseModel):
    """
    ListAvailableParentProjectCandidatesModelAllOfEmbeddedElements
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Portfolios' id")
    identifier: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    active: Optional[StrictBool] = Field(default=None, description="Indicates whether the portfolio is currently active or already archived")
    favorited: Optional[StrictBool] = Field(default=None, description="Indicates whether the portfolio is favorited by the current user")
    status_explanation: Optional[Formattable] = Field(default=None, description="A text detailing and explaining why the portfolio has the reported status", alias="statusExplanation")
    public: Optional[StrictBool] = Field(default=None, description="Indicates whether the portfolio is accessible for everybody")
    description: Optional[Formattable] = None
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Time of the most recent change to the portfolio", alias="updatedAt")
    links: Optional[PortfolioModelAllOfLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "identifier", "name", "active", "favorited", "statusExplanation", "public", "description", "createdAt", "updatedAt", "_links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Portfolio']):
            raise ValueError("must be one of enum values ('Portfolio')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusExplanation": Formattable.from_dict(obj["statusExplanation"]) if obj.get("statusExplanation") is not None else None,
            "public": obj.get("public"),
            "description": Formattable.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "_links": PortfolioModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
