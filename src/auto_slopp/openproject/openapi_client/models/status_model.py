...
class StatusModel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Status id")
    name: Optional[StrictStr] = Field(default=None, description="Status name")
    is_closed: Optional[StrictBool] = Field(default=None, description="Indicates, whether work package of this status are considered closed", alias="isClosed")
    color: Optional[StrictStr] = Field(default=None, description="The color of the status")
    is_default: Optional[StrictBool] = Field(default=None, description="True, if this status is the default status for new work packages", alias="isDefault")
    is_readonly: Optional[StrictBool] = Field(default=None, description="Indicates, whether work package of this status are readonly", alias="isReadonly")
    excluded_from_totals: Optional[StrictBool] = Field(default=None, description="Indicates, whether work package of this status are excluded from totals of `Work`, `Remaining work`, and `% Complete` in a hierarchy.", alias="excludedFromTotals")
    default_done_ratio: Optional[Annotated[int, Field(le=100, strict=True, ge=0)]] = Field(default=None, description="The percentageDone being applied when changing to this status", alias="defaultDoneRatio")
    position: Optional[StrictInt] = Field(default=None, description="Sort index of the status")
    links: Optional[StatusModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "name", "isClosed", "color", "isDefault", "isReadonly", "excludedFromTotals", "defaultDoneRatio", "position", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludedFromTotals": obj.get("excludedFromTotals"),
            "defaultDoneRatio": obj.get("defaultDoneRatio"),
            "position": obj.get("position"),
            "_links": StatusModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
