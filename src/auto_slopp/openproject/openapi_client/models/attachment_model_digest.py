...
class AttachmentModelDigest(BaseModel):
    """
    A checksum for the files content
    """ # noqa: E501
    algorithm: StrictStr = Field(description="The algorithm used to generate the digest.")
    hash: StrictStr = Field(description="The hexadecimal representation of the digested hash value.")
    __properties: ClassVar[List[str]] = ["algorithm", "hash"]
