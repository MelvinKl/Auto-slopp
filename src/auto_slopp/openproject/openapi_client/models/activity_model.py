...
class ActivityModel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Activity id")
    version: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Activity version")
    comment: Optional[Formattable] = None
    details: Optional[List[Formattable]] = None
    internal: Optional[StrictBool] = Field(default=None, description="Whether this activity is internal (only visible to users with view_internal_comments permission)")
    created_at: Optional[datetime] = Field(default=None, description="Time of creation", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="Time of update", alias="updatedAt")
    embedded: Optional[ActivityModelEmbedded] = Field(default=None, alias="_embedded")
    links: Optional[ActivityModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "version", "comment", "details", "internal", "createdAt", "updatedAt", "_embedded", "_links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Activity::Comment']):
            raise ValueError("must be one of enum values ('Activity::Comment')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [Formattable.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "internal": obj.get("internal"),
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "_embedded": ActivityModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": ActivityModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
