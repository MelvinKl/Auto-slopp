...
class WorkPackageWriteModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["subject", "description", "scheduleManually", "startDate", "dueDate", "estimatedTime", "duration", "ignoreNonWorkingDays", "_links", "_meta"]
