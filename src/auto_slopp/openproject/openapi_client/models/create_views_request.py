...
class CreateViewsRequest(BaseModel):
    """
    CreateViewsRequest
    """ # noqa: E501
    links: Optional[CreateViewsRequestLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": CreateViewsRequestLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
