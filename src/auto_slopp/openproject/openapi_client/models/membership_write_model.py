...
class MembershipWriteModel(BaseModel):
    """
    MembershipWriteModel
    """ # noqa: E501
    links: MembershipWriteModelLinks = Field(alias="_links")
    meta: Optional[MembershipWriteModelMeta] = Field(default=None, alias="_meta")
    __properties: ClassVar[List[str]] = ["_links", "_meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": MembershipWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_meta": MembershipWriteModelMeta.from_dict(obj["_meta"]) if obj.get("_meta") is not None else None
        })
        return _obj
