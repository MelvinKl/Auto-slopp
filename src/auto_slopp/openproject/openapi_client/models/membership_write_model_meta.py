...
class MembershipWriteModelMeta(BaseModel):
    """
    MembershipWriteModelMeta
    """ # noqa: E501
    notification_message: Optional[Formattable] = Field(default=None, description="A customised notification message, which will overwrite the standard notification.", alias="notificationMessage")
    send_notification: Optional[StrictBool] = Field(default=True, description="Set to false, if no notification should get sent.", alias="sendNotification")
    __properties: ClassVar[List[str]] = ["notificationMessage", "sendNotification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notificationMessage": Formattable.from_dict(obj["notificationMessage"]) if obj.get("notificationMessage") is not None else None,
