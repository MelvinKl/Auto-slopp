...
class WikiPageModel(BaseModel):
    """
    WikiPageModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="Identifier of this wiki page")
    title: StrictStr = Field(description="The wiki page's title")
    links: Optional[WikiPageModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "title", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "_links": WikiPageModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
