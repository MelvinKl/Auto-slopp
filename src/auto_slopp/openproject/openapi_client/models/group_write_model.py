...
class GroupWriteModel(BaseModel):
    ...
    GroupWriteModel
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The new group name.")
    links: Optional[GroupWriteModelLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "_links": GroupWriteModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
