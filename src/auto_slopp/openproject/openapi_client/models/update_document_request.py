...
class UpdateDocumentRequest(BaseModel):
    ...
    description: Optional[UpdateDocumentRequestDescription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "description": UpdateDocumentRequestDescription.from_dict(obj["description"]) if obj.get("description") is not None else None
        })
        return _obj
