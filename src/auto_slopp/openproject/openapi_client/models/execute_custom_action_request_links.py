...
class ExecuteCustomActionRequestLinks(BaseModel):
    """
    ExecuteCustomActionRequestLinks
    """ # noqa: E501
    work_package: Optional[ExecuteCustomActionRequestLinksWorkPackage] = Field(default=None, alias="workPackage")
    __properties: ClassVar[List[str]] = ["workPackage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workPackage": ExecuteCustomActionRequestLinksWorkPackage.from_dict(obj["workPackage"]) if obj.get("workPackage") is not None else None
        })
        return _obj
