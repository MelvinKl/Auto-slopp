...
class EmojiReactionModel(BaseModel):
    """
    EmojiReactionModel
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    id: Optional[StrictStr] = Field(default=None, description="Emoji reaction id (format: reactable_id-reaction)")
    reaction: Optional[StrictStr] = Field(default=None, description="The reaction identifier")
    emoji: Optional[StrictStr] = Field(default=None, description="The emoji character")
    reactions_count: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Number of users who reacted with this emoji", alias="reactionsCount")
    first_reaction_at: Optional[datetime] = Field(default=None, description="Time of the first reaction", alias="firstReactionAt")
    links: Optional[EmojiReactionModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "id", "reaction", "emoji", "reactionsCount", "firstReactionAt", "_links"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['EmojiReaction']):
            raise ValueError("must be one of enum values ('EmojiReaction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstReactionAt": obj.get("firstReactionAt"),
            "_links": EmojiReactionModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
