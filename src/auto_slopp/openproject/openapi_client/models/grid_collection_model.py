...
class GridCollectionModel(BaseModel):
    """
    GridCollectionModel
    """ # noqa: E501
    ...
    embedded: GridCollectionModelAllOfEmbedded = Field(alias="_embedded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_embedded": GridCollectionModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
