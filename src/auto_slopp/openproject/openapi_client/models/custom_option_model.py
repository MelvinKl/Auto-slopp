...
class CustomOptionModel(BaseModel):
    """
    CustomOptionModel
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The identifier")
    value: Optional[StrictStr] = Field(default=None, description="The value defined for this custom option")
    links: Optional[CustomOptionModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "value", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "value": obj.get("value"),
            "_links": CustomOptionModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
