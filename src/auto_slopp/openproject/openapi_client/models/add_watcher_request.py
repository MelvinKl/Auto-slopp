...
class AddWatcherRequest(BaseModel):
    ...
    AddWatcherRequest
    """ # noqa: E501
    user: Optional[ExecuteCustomActionRequestLinksWorkPackage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": ExecuteCustomActionRequestLinksWorkPackage.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
