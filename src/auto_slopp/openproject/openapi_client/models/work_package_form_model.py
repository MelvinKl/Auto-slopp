...
class WorkPackageFormModel(BaseModel):
    """
    ...
    embedded: Optional[WorkPackageFormModelEmbedded] = Field(default=None, alias="_embedded")
    links: Optional[WorkPackageFormModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "_embedded", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type"),
            "_embedded": WorkPackageFormModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": WorkPackageFormModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
