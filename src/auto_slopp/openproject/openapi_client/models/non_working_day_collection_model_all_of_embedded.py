...
class NonWorkingDayCollectionModelAllOfEmbedded(BaseModel):
    """
    NonWorkingDayCollectionModelAllOfEmbedded
    """ # noqa: E501
    elements: List[NonWorkingDayModel] = Field(description="The array of non working days. Each day has a name and a date.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [NonWorkingDayModel.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
