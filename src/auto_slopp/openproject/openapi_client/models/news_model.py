...
class NewsModel(BaseModel):
    ...
    NewsModel
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="News' id")
    title: Optional[StrictStr] = Field(default=None, description="The headline of the news")
    summary: Optional[StrictStr] = Field(default=None, description="A short summary")
    description: Optional[Formattable] = Field(default=None, description="The main body of the news with all the details")
    created_at: Optional[datetime] = Field(default=None, description="The time the news was created at", alias="createdAt")
    links: Optional[NewsModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "title", "summary", "description", "createdAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": NewsModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
