...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    embedded: Optional[ErrorResponseEmbedded] = Field(default=None, alias="_embedded")
    type: StrictStr = Field(alias="_type")
    error_identifier: StrictStr = Field(alias="errorIdentifier")
    message: StrictStr
    __properties: ClassVar[List[str]] = ["_embedded", "_type", "errorIdentifier", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": ErrorResponseEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_type": obj.get("_type"),
