...
class EmojiReactionsModel(BaseModel):
    """
    EmojiReactionsModel
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="_type")
    total: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Total number of emoji reactions")
    count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of emoji reactions in this response")
    embedded: Optional[EmojiReactionsModelEmbedded] = Field(default=None, alias="_embedded")
    links: Optional[EmojiReactionsModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["_type", "total", "count", "_embedded", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_embedded": EmojiReactionsModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "_links": EmojiReactionsModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
