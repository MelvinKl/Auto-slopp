...
class BudgetModel(BaseModel):
    ...
    BudgetModel
    """ # noqa: E501
    links: Optional[BudgetModelLinks] = Field(default=None, alias="_links")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BudgetModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BudgetModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "_links": BudgetModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
