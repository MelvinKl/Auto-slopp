...
class FileLinkCollectionWriteModel(BaseModel):
    """
    FileLinkCollectionWriteModel
    """ # noqa: E501
    embedded: FileLinkCollectionWriteModelEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": FileLinkCollectionWriteModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
