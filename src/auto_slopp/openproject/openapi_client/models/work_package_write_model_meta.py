...
class WorkPackageWriteModelMeta(BaseModel):
    """
    Meta information for the work package request
    """ # noqa: E501
    validate_custom_fields: Optional[StrictBool] = Field(default=False, description="When set to true, explicitly validates all required custom fields on the work package, regardless of whether they are provided in the request body. This overrides the default behavior where only custom fields included in the request are validated. Use this parameter when you need to ensure all required custom fields have valid values before allowing the update to proceed.", alias="validateCustomFields")
    __properties: ClassVar[List[str]] = ["validateCustomFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validateCustomFields": obj.get("validateCustomFields") if obj.get("validateCustomFields") is not None else False
        })
        return _obj
