...
class ProjectModel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Projects' id")
    identifier: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    active: Optional[StrictBool] = Field(default=None, description="Indicates whether the project is currently active or already archived")
    favorited: Optional[StrictBool] = Field(default=None, description="Indicates whether the project is favorited by the current user")
    status_explanation: Optional[Formattable] = Field(default=None, description="A text detailing and explaining why the project has the reported status", alias="statusExplanation")
    public: Optional[StrictBool] = Field(default=None, description="Indicates whether the project is accessible for everybody")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Time of the most recent change to the project", alias="updatedAt")
    links: Optional[ProjectModelAllOfLinks] = Field(default=None, alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": ProjectModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
