...
class WeekDayCollectionWriteModel(BaseModel):
    """
    WeekDayCollectionWriteModel
    """ # noqa: E501
    type: StrictStr = Field(alias="_type")
    embedded: WeekDayCollectionWriteModelEmbedded = Field(alias="_embedded")
    __properties: ClassVar[List[str]] = ["_type", "_embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type"),
            "_embedded": WeekDayCollectionWriteModelEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
