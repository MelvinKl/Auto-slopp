...
class PlaceholderUserCollectionModel(BaseModel):
    """
    ...
    links: PlaceholderUserCollectionModelAllOfLinks = Field(alias="_links")
    embedded: PlaceholderUserCollectionModelAllOfEmbedded = Field(alias="_embedded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_links": PlaceholderUserCollectionModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_embedded": PlaceholderUserCollectionModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
