...
class TypesByWorkspaceModelAllOfEmbeddedElements(BaseModel):
    """
    Collection of Types
    """ # noqa: E501
    id: Annotated[int, Field(strict=True, gt=0)] = Field(description="Type id")
    name: StrictStr = Field(description="Type name")
    color: StrictStr = Field(description="The color used to represent this type")
    position: StrictInt = Field(description="Sort index of the type")
    is_default: StrictBool = Field(description="Is this type active by default in new projects?", alias="isDefault")
    is_milestone: StrictBool = Field(description="Do work packages of this type represent a milestone?", alias="isMilestone")
    created_at: datetime = Field(description="Time of creation", alias="createdAt")
    updated_at: datetime = Field(description="Time of the most recent change to the user", alias="updatedAt")
    links: Optional[TypeModelLinks] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["id", "name", "color", "position", "isDefault", "isMilestone", "createdAt", "updatedAt", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isMilestone": obj.get("isMilestone"),
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "_links": TypeModelLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj
