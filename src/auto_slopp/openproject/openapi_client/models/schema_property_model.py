...
class SchemaPropertyModel(BaseModel):
    ...
    SchemaPropertyModel
    """ # noqa: E501
    type: StrictStr = Field(description="The resource type for this property.")
    name: StrictStr = Field(description="The name of the property.")
    required: StrictBool = Field(description="Indicates, if the property is required for submitting a request of this schema.")
    has_default: StrictBool = Field(description="Indicates, if the property has a default.", alias="hasDefault")
    writable: StrictBool = Field(description="Indicates, if the property is writable when sending a request of this schema.")
    options: Optional[Dict[str, Any]] = Field(default=None, description="Additional options for the property.")
    location: Optional[StrictStr] = Field(default='', description="Defines the json path where the property is located in the payload.")
    placeholder: Optional[StrictStr] = Field(default=None, description="A placeholder for the property to display if the property has no value.")
    links: Optional[Dict[str, Any]] = Field(default=None, description="Useful links for this property (e.g. an endpoint to fetch allowed values)", alias="_links")
    __properties: ClassVar[List[str]] = ["type", "name", "required", "hasDefault", "writable", "options", "location", "placeholder", "_links"]
