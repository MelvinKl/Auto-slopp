...
class FileLinkCollectionReadModel(BaseModel):
    """
    ...
    links: FileLinkCollectionReadModelAllOfLinks = Field(alias="_links")
    page_size: Annotated[int, Field(strict=True, ge=0)] = Field(description="Amount of elements that a response will hold.", alias="pageSize")
    offset: Annotated[int, Field(strict=True, ge=1)] = Field(description="The page number that is requested from paginated collection.")
    embedded: Optional[FileLinkCollectionReadModelAllOfEmbedded] = Field(default=None, alias="_embedded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "count": obj.get("count"),
            "_links": FileLinkCollectionReadModelAllOfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "pageSize": obj.get("pageSize"),
            "offset": obj.get("offset"),
            "_embedded": FileLinkCollectionReadModelAllOfEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None
        })
        return _obj
