...
class CategoriesApi:
    ...
    @validate_call
    def list_categories_of_a_project(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose categories will be listed")],
        ...
        List all categories of a project This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/categories`](https://www.openproject.org/docs/api/endpoints/categories/#list-categories-of-a-workspace) 

        :param id: ID of the project whose categories will be listed (required)
        :type id: int
        ...
        _param = self._list_categories_of_a_project_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CategoriesByWorkspaceModel",
            '404': "ErrorResponse",
        }
    ...
    @validate_call
    def list_categories_of_a_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose categories will be listed")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CategoriesByWorkspaceModel]:
        """List categories of a project
    ...
    @validate_call
    def list_categories_of_a_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose categories will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_categories_of_a_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/categories',
    ...
    @validate_call
    def list_categories_of_a_workspace(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose categories will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the workspace whose categories will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_categories_of_a_workspace_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_categories_of_a_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose categories will be listed")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_categories_of_a_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose categories will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_categories_of_a_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspaces/{id}/categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_category(
        ...
        _param = self._view_category_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_category_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Category id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_category_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Category id")],
        _request_timeout: Union[
            None,
    ...
    def _view_category_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/categories/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
