...
class WorkPackagesApi:
    ...
    @validate_call
    def create_workspace_work_package(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        notify: Annotated[Optional[StrictBool], Field(description="Indicates whether change notifications (e.g. via E-Mail) should be sent. Note that this controls notifications for all users interested in changes to the work package (e.g. watchers, author and assignee), not just the current user.")] = None,
        work_package_model: Optional[WorkPackageModel] = None,
        ...
        _param = self._create_workspace_work_package_serialize(
            id=id,
            notify=notify,
            work_package_model=work_package_model,
            _request_auth=_request_auth,
    ...
    @validate_call
    def create_workspace_work_package_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        notify: Annotated[Optional[StrictBool], Field(description="Indicates whether change notifications (e.g. via E-Mail) should be sent. Note that this controls notifications for all users interested in changes to the work package (e.g. watchers, author and assignee), not just the current user.")] = None,
        work_package_model: Optional[WorkPackageModel] = None,
    ...
    @validate_call
    def create_workspace_work_package_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        notify: Annotated[Optional[StrictBool], Field(description="Indicates whether change notifications (e.g. via E-Mail) should be sent. Note that this controls notifications for all users interested in changes to the work package (e.g. watchers, author and assignee), not just the current user.")] = None,
        work_package_model: Optional[WorkPackageModel] = None,
    ...
    def _create_workspace_work_package_serialize(
        self,
        id,
        notify,
        work_package_model,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/workspaces/{id}/work_packages',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def form_create_work_package_in_workspace(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace in which the work package will be created")],
        work_package_write_model: Optional[WorkPackageWriteModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        This endpoint allows you to validation a new work package creation body in a specific workspace. It works similarly to the `/api/v3/work_packages/form` endpoint, but already specifies the work package's workspace in the path, so that it does not have to be defined in the request body.

        :param id: ID of the workspace in which the work package will be created (required)
        :type id: int
        :param work_package_write_model:
        :type work_package_write_model: WorkPackageWriteModel
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._form_create_work_package_in_workspace_serialize(
            id=id,
            work_package_write_model=work_package_write_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def form_create_work_package_in_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace in which the work package will be created")],
        work_package_write_model: Optional[WorkPackageWriteModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def form_create_work_package_in_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace in which the work package will be created")],
        work_package_write_model: Optional[WorkPackageWriteModel] = None,
        _request_timeout: Union[
    ...
    def _form_create_work_package_in_workspace_serialize(
        self,
        id,
        work_package_write_model,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/workspaces/{id}/work_packages/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def form_edit_work_package(
        ...
        When calling this endpoint, the client provides a single object containing the properties and links to be edited, in the body. The input is validated and a schema response is returned. If the validation errors of the response is empty, the same payload can be used to edit the work package.  Only the properties of the work package write model are allowed to set on a work package on editing.  When setting start date, finish date, and duration together, their correctness will be checked and a validation error will be returned if one value does not match with the two others. You can make the server compute a value: set only two values in the request and the third one will be computed and returned in the response. For instance, when sending `{ \"startDate\": \"2022-08-23\", duration: \"P2D\" }`, the response will include `{ \"dueDate\": \"2022-08-24\" }`.  **Custom Field Validation**    Required custom fields are only validated when they are explicitly provided in the request body. If a custom field is not included in the form request, it will not be validated, allowing clients to validate partial updates without triggering validation errors for unrelated required custom fields.  To override this behavior and validate all required custom fields regardless of whether they are included in the request, set `validateCustomFields` to `true` in the `_meta` object of the request body.
    ...
    def get_project_work_package_collection(
        ...
        Returns the collection of work packages that are related to the given project. This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/work_packages`](https://www.openproject.org/docs/api/endpoints/work-packages/#get-work-packages-of-workspace)
    ...
    @validate_call
    def get_workspace_work_package_collection(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        offset: Annotated[Optional[StrictInt], Field(description="Page number inside the requested collection.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of elements to display per page.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. If no filter is to be applied, the client should send an empty array (`[]`).")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        ...
        _param = self._get_workspace_work_package_collection_serialize(
            id=id,
            offset=offset,
            page_size=page_size,
            filters=filters,
    ...
    @validate_call
    def get_workspace_work_package_collection_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        offset: Annotated[Optional[StrictInt], Field(description="Page number inside the requested collection.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of elements to display per page.")] = None,
    ...
    @validate_call
    def get_workspace_work_package_collection_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        offset: Annotated[Optional[StrictInt], Field(description="Page number inside the requested collection.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of elements to display per page.")] = None,
    ...
    def _get_workspace_work_package_collection_serialize(
        self,
        id,
        offset,
        page_size,
    ...
    def project_available_assignees(
        ...
        Gets a list of users that can be assigned to work packages in the given project. This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/available_assignees`](https://www.openproject.org/docs/api/endpoints/work-packages/#workspace-available-assignees)
    ...
    def update_work_package(
        ...
        work_package_patch_model: Optional[WorkPackagePatchModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        When calling this endpoint the client provides a single object, containing the properties and links that it wants to change, in the body. Note that it is only allowed to provide properties or links supporting the **write** operation.  Additionally to the fields the client wants to change, it is mandatory to provide the value of `lockVersion` which was received by the `GET` request this change originates from.  The value of `lockVersion` is used to implement [optimistic locking](https://en.wikipedia.org/wiki/Optimistic_concurrency_control).  **Custom Field Validation**    Required custom fields are only validated when they are explicitly provided in the request body. If a custom field is not included in the update request, it will not be validated. This enables clients to update specific attributes independently without having to provide values for all required custom fields.  To override this behavior and validate all required custom fields regardless of whether they are included in the request, set `validateCustomFields` to `true` in the `_meta` object of the request body.
        ...
        :type notify: bool
        :param work_package_patch_model:
        :type work_package_patch_model: WorkPackagePatchModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_work_package_serialize(
            id=id,
            notify=notify,
            work_package_patch_model=work_package_patch_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_work_package_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if work_package_patch_model is not None:
            _body_params = work_package_patch_model
    ...
    @validate_call
    def workspace_available_assignees(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
        ...
        _param = self._workspace_available_assignees_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def workspace_available_assignees_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def workspace_available_assignees_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    def _workspace_available_assignees_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspaces/{id}/available_assignees',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
