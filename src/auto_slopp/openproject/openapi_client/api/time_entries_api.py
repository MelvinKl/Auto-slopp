...
class TimeEntriesApi:
    ...
    @validate_call
    def available_projects_for_time_entries(
        self,
        ...
        _param = self._available_projects_for_time_entries_serialize(
    ...
    @validate_call
    def available_projects_for_time_entries_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def available_projects_for_time_entries_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _available_projects_for_time_entries_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/time_entries/available_projects',
    ...
    def time_entry_create_form(
        ...
        _param = self._time_entry_create_form_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def time_entry_create_form_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def time_entry_create_form_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _time_entry_create_form_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/time_entries/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def time_entry_update_form(
        self,
        id: Annotated[StrictInt, Field(description="Time entries activity id")],
        body: Annotated[StrictInt, Field(description="Time entries activity id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: int
        :param body: Time entries activity id (required)
        :type body: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._time_entry_update_form_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def time_entry_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Time entries activity id")],
        body: Annotated[StrictInt, Field(description="Time entries activity id")],
        _request_timeout: Union[
    ...
    @validate_call
    def time_entry_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Time entries activity id")],
        body: Annotated[StrictInt, Field(description="Time entries activity id")],
        _request_timeout: Union[
    ...
    def _time_entry_update_form_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/time_entries/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_time_entry(
        ...
        _param = self._update_time_entry_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_time_entry_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Time entry id")],
        _request_timeout: Union[
            None,
    ...
    def _update_time_entry_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def view_time_entry_schema(
        ...
        _param = self._view_time_entry_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def view_time_entry_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def view_time_entry_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _view_time_entry_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/time_entries/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
