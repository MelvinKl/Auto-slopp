...
class ProjectPhasesApi:
    ...
    def get_project_phase(
        self,
        id: Annotated[StrictInt, Field(description="Project phase id")],
        ...
        :param id: Project phase id (required)
        :type id: int
        ...
        _param = self._get_project_phase_serialize(
            id=id,
    ...
    @validate_call
    def get_project_phase_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project phase id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_project_phase_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project phase id")],
        _request_timeout: Union[
            None,
    ...
    def _get_project_phase_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_phases/{id}',
