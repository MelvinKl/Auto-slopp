...
class WorkScheduleApi:
    ...
    def create_non_working_day(
        self,
        non_working_day_model: Optional[NonWorkingDayModel] = None,
        ...
        **(NOT IMPLEMENTED)** Marks a day as being a non-working day.  Note: creating a non-working day will not affect the start and finish dates of work packages but will affect their duration.
        ...
        :param non_working_day_model:
        :type non_working_day_model: NonWorkingDayModel
        ...
        _param = self._create_non_working_day_serialize(
            non_working_day_model=non_working_day_model,
    ...
    @validate_call
    def create_non_working_day_with_http_info(
        self,
        non_working_day_model: Optional[NonWorkingDayModel] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NonWorkingDayModel]:
        """Creates a non-working day (NOT IMPLEMENTED)
    ...
    @validate_call
    def create_non_working_day_without_preload_content(
        self,
        non_working_day_model: Optional[NonWorkingDayModel] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_non_working_day_serialize(
        self,
        ...
        if non_working_day_model is not None:
            _body_params = non_working_day_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/days/non_working',
    ...
    def delete_non_working_day(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **(NOT IMPLEMENTED)** Removes the non-working day at the given date.  Note: deleting a non-working day will not affect the start and finish dates of work packages but will affect their duration.
        ...
        :param var_date: The date of the non-working day to view in ISO 8601 format. (required)
        :type var_date: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_non_working_day_serialize(
            var_date=var_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_non_working_day_with_http_info(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_non_working_day_without_preload_content(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_non_working_day_serialize(
        self,
        var_date,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/days/non_working/{date}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_days(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.  Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + date: the inclusive date interval to scope days to look up. When   unspecified, default is from the beginning of current month to the end   of following month.    Example: `{ \"date\": { \"operator\": \"<>d\", \"values\": [\"2022-05-02\",\"2022-05-26\"] } }`   would return days between May 5 and May 26 2022, inclusive.  + working: when `true`, returns only the working days. When `false`,   returns only the non-working days (weekend days and non-working days).   When unspecified, returns both working and non-working days.    Example: `{ \"working\": { \"operator\": \"=\", \"values\": [\"t\"] } }`   would exclude non-working days from the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._list_days_serialize(
            filters=filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_days_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DayCollectionModel]:
        """Lists days
    ...
    @validate_call
    def list_days_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.  Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + date: the inclusive date interval to scope days to look up. When   unspecified, default is from the beginning of current month to the end   of following month.    Example: `{ \"date\": { \"operator\": \"<>d\", \"values\": [\"2022-05-02\",\"2022-05-26\"] } }`   would return days between May 5 and May 26 2022, inclusive.  + working: when `true`, returns only the working days. When `false`,   returns only the non-working days (weekend days and non-working days).   When unspecified, returns both working and non-working days.    Example: `{ \"working\": { \"operator\": \"=\", \"values\": [\"t\"] } }`   would exclude non-working days from the response.")] = None,
        _request_timeout: Union[
            None,
    ...
    def list_non_working_days(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.  Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + date: the inclusive date interval to scope days to look up. When   unspecified, default is from the beginning to the end of current year.    Example: `{ \"date\": { \"operator\": \"<>d\", \"values\": [\"2022-05-02\",\"2022-05-26\"] } }`   would return days between May 5 and May 26 2022, inclusive.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._list_non_working_days_serialize(
            filters=filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NonWorkingDayCollectionModel",
            '400': "ErrorResponse",
            '406': "str",
            '415': "ErrorResponse",
        }
    ...
    @validate_call
    def list_non_working_days_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.  Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + date: the inclusive date interval to scope days to look up. When   unspecified, default is from the beginning to the end of current year.    Example: `{ \"date\": { \"operator\": \"<>d\", \"values\": [\"2022-05-02\",\"2022-05-26\"] } }`   would return days between May 5 and May 26 2022, inclusive.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NonWorkingDayCollectionModel]:
        """Lists all non working days
    ...
    @validate_call
    def list_non_working_days_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions.  Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + date: the inclusive date interval to scope days to look up. When   unspecified, default is from the beginning to the end of current year.    Example: `{ \"date\": { \"operator\": \"<>d\", \"values\": [\"2022-05-02\",\"2022-05-26\"] } }`   would return days between May 5 and May 26 2022, inclusive.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_non_working_days_serialize(
        self,
        filters,
        _request_auth,
        _content_type,
    ...
    def list_week_days(
        ...
        _param = self._list_week_days_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_week_days_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WeekDayCollectionModel]:
        """Lists week days
    ...
    @validate_call
    def list_week_days_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_week_days_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/days/week',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_non_working_day(
        ...
        **(NOT IMPLEMENTED)** Update the non-working day information for a given date.
        ...
        _param = self._update_non_working_day_serialize(
            var_date=var_date,
            non_working_day_model=non_working_day_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_non_working_day_with_http_info(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        non_working_day_model: Optional[NonWorkingDayModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_non_working_day_without_preload_content(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        non_working_day_model: Optional[NonWorkingDayModel] = None,
        _request_timeout: Union[
    ...
    def _update_non_working_day_serialize(
        self,
        var_date,
        non_working_day_model,
        _request_auth,
    ...
    def update_week_day(
        self,
        day: Annotated[int, Field(le=7, strict=True, ge=1, description="The week day from 1 to 7. 1 is Monday. 7 is Sunday.")],
        week_day_write_model: Optional[WeekDayWriteModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **(NOT IMPLEMENTED)** Makes a week day a working or non-working day.  Note: changing a week day working attribute will not affect the start and finish dates of work packages but will affect their duration attribute.
        ...
        :param day: The week day from 1 to 7. 1 is Monday. 7 is Sunday. (required)
        :type day: int
        :param week_day_write_model:
        :type week_day_write_model: WeekDayWriteModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_week_day_serialize(
            day=day,
            week_day_write_model=week_day_write_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_week_day_with_http_info(
        self,
        day: Annotated[int, Field(le=7, strict=True, ge=1, description="The week day from 1 to 7. 1 is Monday. 7 is Sunday.")],
        week_day_write_model: Optional[WeekDayWriteModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_week_day_without_preload_content(
        self,
        day: Annotated[int, Field(le=7, strict=True, ge=1, description="The week day from 1 to 7. 1 is Monday. 7 is Sunday.")],
        week_day_write_model: Optional[WeekDayWriteModel] = None,
        _request_timeout: Union[
    ...
    def _update_week_day_serialize(
        self,
        day,
        ...
        # process the form parameters
        # process the body parameter
        if week_day_write_model is not None:
            _body_params = week_day_write_model
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v3/days/week/{day}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_week_days(
        self,
        week_day_collection_write_model: Optional[WeekDayCollectionWriteModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **(NOT IMPLEMENTED)** Update multiple week days with work schedule information.
        ...
        :param week_day_collection_write_model:
        :type week_day_collection_write_model: WeekDayCollectionWriteModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_week_days_serialize(
            week_day_collection_write_model=week_day_collection_write_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_week_days_with_http_info(
        self,
        week_day_collection_write_model: Optional[WeekDayCollectionWriteModel] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_week_days_without_preload_content(
        self,
        week_day_collection_write_model: Optional[WeekDayCollectionWriteModel] = None,
        _request_timeout: Union[
            None,
    ...
    def _update_week_days_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if week_day_collection_write_model is not None:
            _body_params = week_day_collection_write_model
    ...
    def view_day(
        ...
        _param = self._view_day_serialize(
            var_date=var_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_day_without_preload_content(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
    ...
    def _view_day_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/days/{date}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_non_working_day(
        ...
        _param = self._view_non_working_day_serialize(
            var_date=var_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_non_working_day_with_http_info(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_non_working_day_without_preload_content(
        self,
        var_date: Annotated[date, Field(description="The date of the non-working day to view in ISO 8601 format.")],
        _request_timeout: Union[
            None,
    ...
    def _view_non_working_day_serialize(
        self,
        var_date,
        _request_auth,
        _content_type,
    ...
    def view_week_day(
        ...
        _param = self._view_week_day_serialize(
            day=day,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_week_day_with_http_info(
        self,
        day: Annotated[int, Field(le=7, strict=True, ge=1, description="The week day from 1 to 7. 1 is Monday. 7 is Sunday.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_week_day_without_preload_content(
        self,
        day: Annotated[int, Field(le=7, strict=True, ge=1, description="The week day from 1 to 7. 1 is Monday. 7 is Sunday.")],
        _request_timeout: Union[
            None,
