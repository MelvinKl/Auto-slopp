...
class UsersApi:
    ...
    def _lock_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/users/{id}/lock',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def user_update_form(
        ...
        _param = self._user_update_form_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="User id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="User id")],
        _request_timeout: Union[
            None,
    ...
    def _user_update_form_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/users/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_user_schema(
        ...
        _param = self._view_user_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def view_user_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def view_user_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _view_user_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/users/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
