...
class UserPreferencesApi:
    ...
    def show_my_preferences(
        ...
        _param = self._show_my_preferences_serialize(
    ...
    @validate_call
    def show_my_preferences_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def show_my_preferences_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _show_my_preferences_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/my_preferences',
    ...
    def update_user_preferences(
        self,
        update_user_preferences_request: Optional[UpdateUserPreferencesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_user_preferences_request:
