...
class QuerySortBysApi:
    ...
    @validate_call
    def view_query_sort_by(
        self,
        id: Annotated[StrictStr, Field(description="QuerySortBy identifier. The identifier is a combination of the column identifier and the direction.")],
        ...
        _param = self._view_query_sort_by_serialize(
            id=id,
    ...
    @validate_call
    def view_query_sort_by_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="QuerySortBy identifier. The identifier is a combination of the column identifier and the direction.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_query_sort_by_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="QuerySortBy identifier. The identifier is a combination of the column identifier and the direction.")],
        _request_timeout: Union[
            None,
    ...
    def _view_query_sort_by_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/sort_bys/{id}',
