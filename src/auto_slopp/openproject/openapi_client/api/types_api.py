...
class TypesApi:
    ...
    def list_all_types(
        ...
        _param = self._list_all_types_serialize(
    ...
    @validate_call
    def list_all_types_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_all_types_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_types_available_in_a_project(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose types will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This endpoint lists the types that are *available* in a given project. This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/types`](https://www.openproject.org/docs/api/endpoints/types/#list-types-available-in-a-workspace)

        :param id: ID of the project whose types will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_types_available_in_a_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_types_available_in_a_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose types will be listed")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TypesByWorkspaceModel]:
        """List types available in a project
    ...
    @validate_call
    def list_types_available_in_a_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the project whose types will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_types_available_in_a_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_types_available_in_a_workspace(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose types will be listed")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the workspace whose types will be listed (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_types_available_in_a_workspace_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_types_available_in_a_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose types will be listed")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_types_available_in_a_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the workspace whose types will be listed")],
        _request_timeout: Union[
            None,
    ...
    def _list_types_available_in_a_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspaces/{id}/types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_type(
        self,
        id: Annotated[StrictInt, Field(description="Type id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._view_type_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_type_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Type id")],
        _request_timeout: Union[
            None,
