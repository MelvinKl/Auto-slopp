...
class TimeEntriesApi:
    ...
    def create_time_entry(
        self,
        time_entry_model: Optional[TimeEntryModel] = None,
        ...
        :param time_entry_model:
        :type time_entry_model: TimeEntryModel
        ...
        _param = self._create_time_entry_serialize(
            time_entry_model=time_entry_model,
    ...
    @validate_call
    def create_time_entry_with_http_info(
        self,
        time_entry_model: Optional[TimeEntryModel] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_time_entry_without_preload_content(
        self,
        time_entry_model: Optional[TimeEntryModel] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_time_entry_serialize(
        self,
        time_entry_model,
        _request_auth,
        _content_type,
        ...
        if time_entry_model is not None:
            _body_params = time_entry_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/time_entries',
    ...
    def delete_time_entry(
        self,
        id: Annotated[StrictInt, Field(description="Time entry id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_time_entry_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_time_entry_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Time entry id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_time_entry_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Time entry id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_time_entry_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/time_entries/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_time_entry(
        ...
        _param = self._get_time_entry_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_time_entry_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="time entry id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_time_entry_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="time entry id")],
        _request_timeout: Union[
            None,
    ...
    def list_time_entries(
        ...
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + hours: Sort by logged hours  + spent_on: Sort by spent on date  + created_at: Sort by time entry creation datetime  + updated_at: Sort by the time the time entry was updated last")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + entity_type: Filter time entries depending on the entity they are logged on. Can either be `WorkPackage` or `Meeting`.  + entity_id: Filter time entries for the specified entity IDs.  + project_id: Filter time entries by project  + user_id: Filter time entries by users  + ongoing: Filter to only recevie ongoing timers  + spent_on: Filter time entries by spent on date  + created_at: Filter time entries by creation datetime  + updated_at: Filter time entries by the last time they where updated  + activity_id: Filter time entries by time entry activity")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type page_size: int
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + hours: Sort by logged hours  + spent_on: Sort by spent on date  + created_at: Sort by time entry creation datetime  + updated_at: Sort by the time the time entry was updated last
        :type sort_by: str
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + entity_type: Filter time entries depending on the entity they are logged on. Can either be `WorkPackage` or `Meeting`.  + entity_id: Filter time entries for the specified entity IDs.  + project_id: Filter time entries by project  + user_id: Filter time entries by users  + ongoing: Filter to only recevie ongoing timers  + spent_on: Filter time entries by spent on date  + created_at: Filter time entries by creation datetime  + updated_at: Filter time entries by the last time they where updated  + activity_id: Filter time entries by time entry activity
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def list_time_entries_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TimeEntryCollectionModel]:
        """List time entries
