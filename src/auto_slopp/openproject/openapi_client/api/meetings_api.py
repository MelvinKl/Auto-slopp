...
class MeetingsApi:
    ...
    def view_meeting(
        self,
        id: Annotated[StrictInt, Field(description="Meeting identifier")],
        ...
        :param id: Meeting identifier (required)
        :type id: int
        ...
        _param = self._view_meeting_serialize(
            id=id,
    ...
    @validate_call
    def view_meeting_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Meeting identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_meeting_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Meeting identifier")],
        _request_timeout: Union[
            None,
    ...
    def _view_meeting_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/meetings/{id}',
