...
class CollectionsApi:
    ...
    @validate_call
    def view_aggregated_result(
        self,
        group_by: Annotated[Optional[StrictStr], Field(description="The column to group by. Note: Aggregation is as of now only supported by the work package collection. You can pass any column name as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        show_sums: Optional[StrictBool] = None,
        ...
        :param group_by: The column to group by. Note: Aggregation is as of now only supported by the work package collection. You can pass any column name as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.
        :type group_by: str
        :param show_sums: 
        :type show_sums: bool
        ...
        _param = self._view_aggregated_result_serialize(
            group_by=group_by,
            show_sums=show_sums,
    ...
    @validate_call
    def view_aggregated_result_with_http_info(
        self,
        group_by: Annotated[Optional[StrictStr], Field(description="The column to group by. Note: Aggregation is as of now only supported by the work package collection. You can pass any column name as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        show_sums: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def view_aggregated_result_without_preload_content(
        self,
        group_by: Annotated[Optional[StrictStr], Field(description="The column to group by. Note: Aggregation is as of now only supported by the work package collection. You can pass any column name as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        show_sums: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _view_aggregated_result_serialize(
        self,
        group_by,
        show_sums,
        _request_auth,
