...
class ProjectPhaseDefinitionsApi:
    ...
    @validate_call
    def get_project_phase_definition(
        self,
        id: Annotated[StrictInt, Field(description="Project phase definition id")],
        ...
        :param id: Project phase definition id (required)
        :type id: int
        ...
        _param = self._get_project_phase_definition_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectPhaseDefinitionModel",
            '404': "ErrorResponse",
        }
    ...
    @validate_call
    def get_project_phase_definition_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project phase definition id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectPhaseDefinitionModel]:
        """Get a project phase definition
    ...
    @validate_call
    def get_project_phase_definition_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project phase definition id")],
        _request_timeout: Union[
            None,
    ...
    def _get_project_phase_definition_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_phase_definitions/{id}',
    ...
    @validate_call
    def list_project_phase_definitions(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Returns a collection of all project phase definitions. The result set is always limited to only contain project phase definitions the client is allowed to see.
        ...
        _param = self._list_project_phase_definitions_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectPhaseDefinitionCollectionModel",
            '400': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_project_phase_definitions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectPhaseDefinitionCollectionModel]:
        """List project phase definitions
    ...
    @validate_call
    def list_project_phase_definitions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_project_phase_definitions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_phase_definitions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
