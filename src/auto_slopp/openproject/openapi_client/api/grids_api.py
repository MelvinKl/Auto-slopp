...
class GridsApi:
    ...
    def create_grid(
        self,
        grid_write_model: Optional[GridWriteModel] = None,
        ...
        Creates a new grid applying the attributes provided in the body. The constraints applied to the grid depend on the page the grid is placed in which is why the create form endpoint should be used to be guided when wanting to create a grid.

        :param grid_write_model:
        :type grid_write_model: GridWriteModel
        ...
        _param = self._create_grid_serialize(
            grid_write_model=grid_write_model,
    ...
    def _create_grid_serialize(
        ...
        if grid_write_model is not None:
            _body_params = grid_write_model
    ...
    def get_grid(
        self,
        id: Annotated[StrictInt, Field(description="Grid id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_grid_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_grid_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Grid id")],
        _request_timeout: Union[
            None,
    ...
    def grid_create_form(
        ...
        _param = self._grid_create_form_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def grid_create_form_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def grid_create_form_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _grid_create_form_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/grids/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def grid_update_form(
        self,
        id: Annotated[StrictInt, Field(description="ID of the grid being modified")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the grid being modified (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._grid_update_form_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def grid_update_form_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the grid being modified")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def grid_update_form_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the grid being modified")],
        _request_timeout: Union[
            None,
    ...
    def _grid_update_form_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/grids/{id}/form',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_grids(
        ...
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - page: Filter grid by work package")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type page_size: int
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - page: Filter grid by work package
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_grids_serialize(
            offset=offset,
            page_size=page_size,
            filters=filters,
            _request_auth=_request_auth,
    ...
    def list_grids_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GridCollectionModel]:
        """List grids
    ...
    @validate_call
    def list_grids_without_preload_content(
        self,
        offset: Annotated[Optional[StrictInt], Field(description="Page number inside the requested collection.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of elements to display per page.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - page: Filter grid by work package")] = None,
    ...
    def update_grid(
        ...
        Updates the given grid by applying the attributes provided in the body. The constraints applied to the grid depend on the page the grid is placed in which is why the create form endpoint should be used to be guided when wanting to update a grid.
