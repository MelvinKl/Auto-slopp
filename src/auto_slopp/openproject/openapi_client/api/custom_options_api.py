...
class CustomOptionsApi:
    ...
    @validate_call
    def view_custom_option(
        self,
        id: Annotated[StrictInt, Field(description="The custom option's identifier")],
        ...
        :param id: The custom option's identifier (required)
        :type id: int
        ...
        _param = self._view_custom_option_serialize(
            id=id,
    ...
    @validate_call
    def view_custom_option_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The custom option's identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_custom_option_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The custom option's identifier")],
        _request_timeout: Union[
            None,
    ...
    def _view_custom_option_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/custom_options/{id}',
