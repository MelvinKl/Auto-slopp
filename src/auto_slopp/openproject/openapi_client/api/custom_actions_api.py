...
class CustomActionsApi:
    ...
    def execute_custom_action(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to execute")],
        execute_custom_action_request: Optional[ExecuteCustomActionRequest] = None,
        ...
        A POST to this endpoint executes the custom action on the work package provided in the payload. The altered work package will be returned. In order to avoid executing  the custom action unbeknown to a change that has already taken place, the client has to provide the work package's current lockVersion.

        :param id: The id of the custom action to execute (required)
        :type id: int
        :param execute_custom_action_request:
        :type execute_custom_action_request: ExecuteCustomActionRequest
        ...
        _param = self._execute_custom_action_serialize(
            id=id,
            execute_custom_action_request=execute_custom_action_request,
    ...
    @validate_call
    def execute_custom_action_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to execute")],
        execute_custom_action_request: Optional[ExecuteCustomActionRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def execute_custom_action_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to execute")],
        execute_custom_action_request: Optional[ExecuteCustomActionRequest] = None,
        _request_timeout: Union[
    ...
    def _execute_custom_action_serialize(
        self,
        id,
        ...
        if execute_custom_action_request is not None:
            _body_params = execute_custom_action_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/custom_actions/{id}/execute',
    ...
    def get_custom_action(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to fetch")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The id of the custom action to fetch (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_custom_action_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_custom_action_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to fetch")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_custom_action_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the custom action to fetch")],
        _request_timeout: Union[
            None,
    ...
    def _get_custom_action_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/custom_actions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
