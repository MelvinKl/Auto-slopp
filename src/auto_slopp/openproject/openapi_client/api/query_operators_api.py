...
class QueryOperatorsApi:
    ...
    @validate_call
    def view_query_operator(
        self,
        id: Annotated[StrictStr, Field(description="QueryOperator id")],
        ...
        _param = self._view_query_operator_serialize(
            id=id,
    ...
    @validate_call
    def view_query_operator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="QueryOperator id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryOperatorModel]:
        """View Query Operator
    ...
    @validate_call
    def view_query_operator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="QueryOperator id")],
        _request_timeout: Union[
            None,
    ...
    def _view_query_operator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/operators/{id}',
