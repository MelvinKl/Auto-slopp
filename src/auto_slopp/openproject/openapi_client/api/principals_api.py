...
class PrincipalsApi:
    ...
    def create_placeholder_user(
        self,
        placeholder_user_create_model: Optional[PlaceholderUserCreateModel] = None,
        ...
        :param placeholder_user_create_model:
        :type placeholder_user_create_model: PlaceholderUserCreateModel
        ...
        _param = self._create_placeholder_user_serialize(
            placeholder_user_create_model=placeholder_user_create_model,
    ...
    @validate_call
    def create_placeholder_user_with_http_info(
        self,
        placeholder_user_create_model: Optional[PlaceholderUserCreateModel] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PlaceholderUserModel]:
        """Create placeholder user
    ...
    @validate_call
    def create_placeholder_user_without_preload_content(
        self,
        placeholder_user_create_model: Optional[PlaceholderUserCreateModel] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_placeholder_user_serialize(
        self,
        ...
        if placeholder_user_create_model is not None:
            _body_params = placeholder_user_create_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/placeholder_users',
    ...
    def create_user(
        self,
        user_create_model: Optional[UserCreateModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type user_create_model: UserCreateModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _create_user_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if user_create_model is not None:
            _body_params = user_create_model
    ...
    @validate_call
    def delete_placeholder_user(
        self,
        id: Annotated[StrictInt, Field(description="Placeholder user id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Placeholder user id (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_placeholder_user_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_placeholder_user_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Placeholder user id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_placeholder_user_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Placeholder user id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_placeholder_user_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/placeholder_users/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_placeholder_users(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - name: filters placeholder users by the name. - group: filters placeholder by the group it is contained in. - status: filters placeholder by the status it has.")] = None,
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - name: filters placeholder users by the name. - group: filters placeholder by the group it is contained in. - status: filters placeholder by the status it has.
        :type filters: str
        ...
        _param = self._list_placeholder_users_serialize(
            filters=filters,
            select=select,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_placeholder_users_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - name: filters placeholder users by the name. - group: filters placeholder by the group it is contained in. - status: filters placeholder by the status it has.")] = None,
        select: Annotated[Optional[StrictStr], Field(description="Comma separated list of properties to include.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrincipalCollectionModel]:
        """List placehoder users
    ...
    @validate_call
    def list_placeholder_users_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - name: filters placeholder users by the name. - group: filters placeholder by the group it is contained in. - status: filters placeholder by the status it has.")] = None,
        select: Annotated[Optional[StrictStr], Field(description="Comma separated list of properties to include.")] = None,
        _request_timeout: Union[
    ...
    def _list_placeholder_users_serialize(
        self,
        filters,
        select,
        _request_auth,
    ...
    def list_principals(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - type: filters principals by their type (*User*, *Group*, *PlaceholderUser*). - member: filters principals by the projects they are members in. - name: filters principals by the user or group name. - any_name_attribute: filters principals by the user or group first- and last name, email or login. - status: filters principals by their status number (active = *1*, registered = *2*, locked = *3*, invited = *4*)")] = None,
        select: Annotated[Optional[StrictStr], Field(description="Comma separated list of properties to include.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - type: filters principals by their type (*User*, *Group*, *PlaceholderUser*). - member: filters principals by the projects they are members in. - name: filters principals by the user or group name. - any_name_attribute: filters principals by the user or group first- and last name, email or login. - status: filters principals by their status number (active = *1*, registered = *2*, locked = *3*, invited = *4*)
        :type filters: str
        :param select: Comma separated list of properties to include.
        :type select: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def _list_principals_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/principals',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_users(
        ...
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + status: Status the user has  + group: Name of the group in which to-be-listed users are members.  + name: Filter users in whose first or last names, or email addresses the given string occurs.  + login: User's login")] = None,
        ...
        Lists users. Only administrators or users with the following global permission can access this resource: - `manage_user`

        :param offset: Page number inside the requested collection.
        :type offset: int
        :param page_size: Number of elements to display per page.
        :type page_size: int
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + status: Status the user has  + group: Name of the group in which to-be-listed users are members.  + name: Filter users in whose first or last names, or email addresses the given string occurs.  + login: User's login
        :type filters: str
    ...
    def list_users_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserCollectionModel]:
        """List Users
    ...
    def update_placeholder_user(
        ...
        _param = self._update_placeholder_user_serialize(
            id=id,
            placeholder_user_create_model=placeholder_user_create_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_placeholder_user_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Placeholder user id")],
        placeholder_user_create_model: Optional[PlaceholderUserCreateModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_placeholder_user_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Placeholder user id")],
        placeholder_user_create_model: Optional[PlaceholderUserCreateModel] = None,
        _request_timeout: Union[
    ...
    def _update_placeholder_user_serialize(
        self,
        id,
        placeholder_user_create_model,
        _request_auth,
    ...
    @validate_call
    def view_placeholder_user(
        self,
        id: Annotated[StrictStr, Field(description="The placeholder user id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The placeholder user id (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._view_placeholder_user_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_placeholder_user_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The placeholder user id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_placeholder_user_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The placeholder user id")],
        _request_timeout: Union[
            None,
    ...
    def _view_placeholder_user_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def view_user(
        self,
        id: Annotated[StrictStr, Field(description="User id. Use `me` to reference current user, if any.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._view_user_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_user_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="User id. Use `me` to reference current user, if any.")],
        _request_timeout: Union[
            None,
