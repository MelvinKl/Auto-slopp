...
class QueryFiltersApi:
    ...
    @validate_call
    def view_query_filter(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilter identifier")],
        ...
        _param = self._view_query_filter_serialize(
            id=id,
    ...
    @validate_call
    def view_query_filter_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilter identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_query_filter_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilter identifier")],
        _request_timeout: Union[
            None,
    ...
    def _view_query_filter_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/filters/{id}',
