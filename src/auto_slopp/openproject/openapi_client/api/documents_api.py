...
class DocumentsApi:
    ...
    def list_documents(
        ...
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by document creation datetime")] = None,
        ...
        :type page_size: int
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by document creation datetime
        :type sort_by: str
    ...
    def _list_documents_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/documents',
    ...
    def update_document(
        self,
        id: Annotated[StrictInt, Field(description="Document id")],
        update_document_request: Optional[UpdateDocumentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _update_document_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v3/documents/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def view_document(
        ...
        _param = self._view_document_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_document_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Document id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_document_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Document id")],
        _request_timeout: Union[
            None,
