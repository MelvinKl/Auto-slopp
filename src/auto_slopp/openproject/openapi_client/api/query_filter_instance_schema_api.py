...
class QueryFilterInstanceSchemaApi:
    ...
    @validate_call
    def list_query_filter_instance_schemas(
        self,
        ...
        _param = self._list_query_filter_instance_schemas_serialize(
    ...
    @validate_call
    def list_query_filter_instance_schemas_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_query_filter_instance_schemas_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_query_filter_instance_schemas_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/filter_instance_schemas',
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_project(
        self,
        ...
        Returns the list of QueryFilterInstanceSchemas defined for a query of the specified project.  This endpoint is deprecated and replaced by [`/api/v3/workspaces/{id}/queries/filter_instance_schemas`](https://www.openproject.org/docs/api/endpoints/query-filter-instance-schema/#list-query-filter-instance-schemas-for-workspace)
        ...
        _param = self._list_query_filter_instance_schemas_for_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _list_query_filter_instance_schemas_for_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/queries/filter_instance_schemas',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_workspace(
        self,
        ...
        _param = self._list_query_filter_instance_schemas_for_workspace_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_query_filter_instance_schemas_for_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    def _list_query_filter_instance_schemas_for_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspace/{id}/queries/filter_instance_schemas',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def view_query_filter_instance_schema(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilterInstanceSchema identifier. The identifier is the filter identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: QueryFilterInstanceSchema identifier. The identifier is the filter identifier. (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._view_query_filter_instance_schema_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QueryFilterInstanceSchemaModel",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def view_query_filter_instance_schema_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilterInstanceSchema identifier. The identifier is the filter identifier.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryFilterInstanceSchemaModel]:
        """View Query Filter Instance Schema
    ...
    @validate_call
    def view_query_filter_instance_schema_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="QueryFilterInstanceSchema identifier. The identifier is the filter identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _view_query_filter_instance_schema_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/queries/filter_instance_schemas/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
