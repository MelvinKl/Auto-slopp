...
class RemindersApi:
    ...
    def delete_reminder(
        self,
        id: Annotated[StrictInt, Field(description="Reminder ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Deletes an existing reminder.  A user can only delete their own active reminder.  **Required permission:** view work packages for the project the reminder is contained in.

        :param id: Reminder ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_reminder_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/reminders/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_reminders(
        ...
        _param = self._list_reminders_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_reminders_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_reminders_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_reminders_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/reminders',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_reminder(
        ...
        Updates an existing reminder.  A user can only update their own active reminder.  **Required permission:** view work packages for the project the reminder is contained in.

        :param id: Reminder ID (required)
        :type id: int
        :param update_reminder_request: (required)
        :type update_reminder_request: UpdateReminderRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_reminder_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_reminder_request is not None:
            _body_params = update_reminder_request
