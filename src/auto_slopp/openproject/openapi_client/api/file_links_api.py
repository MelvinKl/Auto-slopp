...
class FileLinksApi:
    ...
    def get_project_storage(
        self,
        id: Annotated[StrictInt, Field(description="Project storage id")],
        ...
        :param id: Project storage id (required)
        :type id: int
        ...
        _param = self._get_project_storage_serialize(
            id=id,
    ...
    @validate_call
    def get_project_storage_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project storage id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectStorageModel]:
        """Gets a project storage
    ...
    @validate_call
    def get_project_storage_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project storage id")],
        _request_timeout: Union[
            None,
    ...
    def _get_project_storage_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_storages/{id}',
    ...
    def list_project_storages(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - project_id - storage_id - storage_url")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  - project_id - storage_id - storage_url
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectStorageCollectionModel",
            '400': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def list_project_storages_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectStorageCollectionModel]:
        """Gets a list of project storages
    ...
    def _list_project_storages_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_storages',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def open_project_storage(
        ...
        _param = self._open_project_storage_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def open_project_storage_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project storage id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def open_project_storage_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project storage id")],
        _request_timeout: Union[
            None,
    ...
    def _open_project_storage_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/project_storages/{id}/open',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def open_storage(
        ...
        _param = self._open_storage_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def open_storage_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Storage id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def open_storage_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Storage id")],
        _request_timeout: Union[
            None,
    ...
    def _open_storage_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/storages/{id}/open',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
