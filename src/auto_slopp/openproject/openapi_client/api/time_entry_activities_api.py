...
class TimeEntryActivitiesApi:
    ...
    def get_time_entries_activity(
        ...
        _param = self._get_time_entries_activity_serialize(
            id=id,
    ...
    @validate_call
    def get_time_entries_activity_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Time entries activity id")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TimeEntryActivityModel]:
        """View time entries activity
    ...
    @validate_call
    def get_time_entries_activity_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Time entries activity id")],
        _request_timeout: Union[
            None,
    ...
    def _get_time_entries_activity_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/time_entries/activity/{id}',
