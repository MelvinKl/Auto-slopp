...
class RelationsApi:
    ...
    def create_relation(
        ...
        relation_write_model: Optional[RelationWriteModel] = None,
        ...
        :type id: int
        :param relation_write_model:
        :type relation_write_model: RelationWriteModel
        ...
        _param = self._create_relation_serialize(
            id=id,
            relation_write_model=relation_write_model,
    ...
    def _create_relation_serialize(
        ...
        if relation_write_model is not None:
            _body_params = relation_write_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/work_packages/{id}/relations',
    ...
    def delete_relation(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier of the relation resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The unique identifier of the relation resource (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_relation_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v3/relations/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_relation(
        self,
        id: Annotated[StrictInt, Field(description="Relation id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def list_relations(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Valid fields to filter by are:  - id - ID of relation - from - ID of work package from which the filtered relations emanates. - to - ID of work package to which this related points. - involved - ID of either the `from` or the `to` work package. - type - The type of relation to filter by, e.g. \"follows\".")] = None,
        ...
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Valid fields to filter by are:  - id - ID of relation - from - ID of work package from which the filtered relations emanates. - to - ID of work package to which this related points. - involved - ID of either the `from` or the `to` work package. - type - The type of relation to filter by, e.g. \"follows\".
        :type filters: str
    ...
    @validate_call
    def list_relations_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Valid fields to filter by are:  - id - ID of relation - from - ID of work package from which the filtered relations emanates. - to - ID of work package to which this related points. - involved - ID of either the `from` or the `to` work package. - type - The type of relation to filter by, e.g. \"follows\".")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RelationCollectionModel]:
        """List Relations
    ...
    @validate_call
    def list_relations_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Valid fields to filter by are:  - id - ID of relation - from - ID of work package from which the filtered relations emanates. - to - ID of work package to which this related points. - involved - ID of either the `from` or the `to` work package. - type - The type of relation to filter by, e.g. \"follows\".")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint.")] = None,
        _request_timeout: Union[
    ...
    def _list_relations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/relations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
