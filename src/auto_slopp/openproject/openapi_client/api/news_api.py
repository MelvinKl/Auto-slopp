...
class NewsApi:
    ...
    def create_news(
        self,
        news_create_model: Optional[NewsCreateModel] = None,
        ...
        :param news_create_model:
        :type news_create_model: NewsCreateModel
    ...
    def _create_news_serialize(
        ...
        if news_create_model is not None:
            _body_params = news_create_model
    ...
    def delete_news(
        self,
        id: Annotated[StrictInt, Field(description="News id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_news_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_news_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="News id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_news_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="News id")],
        _request_timeout: Union[
            None,
    ...
    def list_news(
        ...
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by news creation datetime")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + project_id: Filter news by project")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type page_size: int
        :param sort_by: JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by news creation datetime
        :type sort_by: str
        :param filters: JSON specifying filter conditions. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported filters are:  + project_id: Filter news by project
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_news_serialize(
            offset=offset,
            page_size=page_size,
            sort_by=sort_by,
            filters=filters,
    ...
    @validate_call
    def list_news_without_preload_content(
        self,
        offset: Annotated[Optional[StrictInt], Field(description="Page number inside the requested collection.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of elements to display per page.")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="JSON specifying sort criteria. Accepts the same format as returned by the [queries](https://www.openproject.org/docs/api/endpoints/queries/) endpoint. Currently supported sorts are:  + id: Sort by primary key  + created_at: Sort by news creation datetime")] = None,
    ...
    def update_news(
        ...
        _param = self._update_news_serialize(
            id=id,
            news_create_model=news_create_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_news_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="News id")],
        news_create_model: Optional[NewsCreateModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_news_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="News id")],
        news_create_model: Optional[NewsCreateModel] = None,
        _request_timeout: Union[
    ...
    def view_news(
        ...
        _param = self._view_news_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_news_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="news id")],
        _request_timeout: Union[
            None,
