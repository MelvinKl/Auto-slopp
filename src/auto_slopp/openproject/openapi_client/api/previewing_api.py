...
class PreviewingApi:
    ...
    @validate_call
    def preview_markdown_document(
        self,
        context: Annotated[Optional[StrictStr], Field(description="API-Link to the context in which the rendering occurs, for example a specific work package.  If left out only context-agnostic rendering takes place. Please note that OpenProject features markdown-extensions on top of the extensions GitHub Flavored Markdown (gfm) already provides that can only work given a context (e.g. display attached images).  **Supported contexts:**  * `/api/v3/work_packages/{id}` - an existing work package")] = None,
        ...
        _param = self._preview_markdown_document_serialize(
            context=context,
    ...
    @validate_call
    def preview_markdown_document_with_http_info(
        self,
        context: Annotated[Optional[StrictStr], Field(description="API-Link to the context in which the rendering occurs, for example a specific work package.  If left out only context-agnostic rendering takes place. Please note that OpenProject features markdown-extensions on top of the extensions GitHub Flavored Markdown (gfm) already provides that can only work given a context (e.g. display attached images).  **Supported contexts:**  * `/api/v3/work_packages/{id}` - an existing work package")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def preview_markdown_document_without_preload_content(
        self,
        context: Annotated[Optional[StrictStr], Field(description="API-Link to the context in which the rendering occurs, for example a specific work package.  If left out only context-agnostic rendering takes place. Please note that OpenProject features markdown-extensions on top of the extensions GitHub Flavored Markdown (gfm) already provides that can only work given a context (e.g. display attached images).  **Supported contexts:**  * `/api/v3/work_packages/{id}` - an existing work package")] = None,
        _request_timeout: Union[
            None,
    ...
    def _preview_markdown_document_serialize(
        self,
        context,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/render/markdown',
    ...
    def preview_plain_document(
        ...
        _param = self._preview_plain_document_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def preview_plain_document_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def preview_plain_document_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _preview_plain_document_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/render/plain',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
