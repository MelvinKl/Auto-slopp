...
class ViewsApi:
    ...
    def create_views(
        self,
        id: Annotated[StrictStr, Field(description="The view identifier")],
        create_views_request: Optional[CreateViewsRequest] = None,
        ...
        :param id: The view identifier (required)
        :type id: str
        :param create_views_request:
        :type create_views_request: CreateViewsRequest
        ...
        _param = self._create_views_serialize(
            id=id,
            create_views_request=create_views_request,
    ...
    def _create_views_serialize(
        ...
        if create_views_request is not None:
            _body_params = create_views_request
    ...
    def list_views(
        ...
        :param filters: JSON specifying filter conditions. Currently supported filters are:  + project: filters views by the project their associated query is assigned to. If the project filter is passed with the `!*` (not any) operator, global views are returned.  + id: filters views based on their id  + type: filters views based on their type
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def view_view(
        self,
        id: Annotated[StrictInt, Field(description="View id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._view_view_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_view_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="View id")],
        _request_timeout: Union[
            None,
