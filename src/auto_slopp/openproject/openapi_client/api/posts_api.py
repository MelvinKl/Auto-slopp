...
class PostsApi:
    ...
    def view_post(
        self,
        id: Annotated[StrictInt, Field(description="Post's identifier")],
        ...
        :param id: Post's identifier (required)
        :type id: int
        ...
        _param = self._view_post_serialize(
            id=id,
    ...
    @validate_call
    def view_post_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Post's identifier")],
        _request_timeout: Union[
            None,
