...
class BudgetsApi:
    ...
    def view_budget(
        self,
        id: Annotated[StrictInt, Field(description="Budget id")],
        ...
        _param = self._view_budget_serialize(
            id=id,
    ...
    @validate_call
    def view_budget_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Budget id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_budget_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Budget id")],
        _request_timeout: Union[
            None,
    ...
    def _view_budget_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/budgets/{id}',
    ...
    def view_budgets_of_a_project(
        ...
        _param = self._view_budgets_of_a_project_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def view_budgets_of_a_project_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_budgets_of_a_project_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Project id")],
        _request_timeout: Union[
            None,
    ...
    def _view_budgets_of_a_project_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/projects/{id}/budgets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
