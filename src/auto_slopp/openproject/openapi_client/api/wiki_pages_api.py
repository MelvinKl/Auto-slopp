...
class WikiPagesApi:
    ...
    def view_wiki_page(
        self,
        id: Annotated[StrictInt, Field(description="Wiki page identifier")],
        ...
        :param id: Wiki page identifier (required)
        :type id: int
        ...
        _param = self._view_wiki_page_serialize(
            id=id,
    ...
    @validate_call
    def view_wiki_page_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Wiki page identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def view_wiki_page_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Wiki page identifier")],
        _request_timeout: Union[
            None,
    ...
    def _view_wiki_page_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/wiki_pages/{id}',
