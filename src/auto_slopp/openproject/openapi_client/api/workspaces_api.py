...
class WorkspacesApi:
    ...
    def favorite_workspace(
        ...
        _param = self._favorite_workspace_serialize(
            id=id,
    ...
    @validate_call
    def favorite_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def favorite_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    def _favorite_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v3/workspaces/{id}/favorite',
    ...
    def unfavorite_workspace(
        ...
        _param = self._unfavorite_workspace_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def unfavorite_workspace_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def unfavorite_workspace_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Workspace id")],
        _request_timeout: Union[
            None,
    ...
    def _unfavorite_workspace_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def view_workspace_schema(
        ...
        _param = self._view_workspace_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def view_workspace_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def view_workspace_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _view_workspace_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v3/workspaces/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
