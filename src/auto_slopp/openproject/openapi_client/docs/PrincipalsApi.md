# auto_slopp.openproject.openapi_client.PrincipalsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.PrincipalsApi(api_client)
    placeholder_user_create_model = auto_slopp.openproject.openapi_client.PlaceholderUserCreateModel() # PlaceholderUserCreateModel |  (optional)
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = auto_slopp.openproject.openapi_client.PrincipalsApi(api_client)
    user_create_model = auto_slopp.openproject.openapi_client.UserCreateModel() # UserCreateModel |  (optional)
