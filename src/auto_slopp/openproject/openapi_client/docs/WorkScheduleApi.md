# auto_slopp.openproject.openapi_client.WorkScheduleApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.WorkScheduleApi(api_client)
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = auto_slopp.openproject.openapi_client.WorkScheduleApi(api_client)
    week_day_collection_write_model = auto_slopp.openproject.openapi_client.WeekDayCollectionWriteModel() # WeekDayCollectionWriteModel |  (optional)
