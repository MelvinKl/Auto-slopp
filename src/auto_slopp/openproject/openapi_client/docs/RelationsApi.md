# auto_slopp.openproject.openapi_client.RelationsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.RelationsApi(api_client)
    id = 1 # int | Work package id
    relation_write_model = auto_slopp.openproject.openapi_client.RelationWriteModel() # RelationWriteModel |  (optional)
