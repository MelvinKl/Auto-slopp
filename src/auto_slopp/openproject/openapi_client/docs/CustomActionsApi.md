# auto_slopp.openproject.openapi_client.CustomActionsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.CustomActionsApi(api_client)
    id = 1 # int | The id of the custom action to execute
    execute_custom_action_request = auto_slopp.openproject.openapi_client.ExecuteCustomActionRequest() # ExecuteCustomActionRequest |  (optional)
