# auto_slopp.openproject.openapi_client.ProjectPhaseDefinitionsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.ProjectPhaseDefinitionsApi(api_client)
