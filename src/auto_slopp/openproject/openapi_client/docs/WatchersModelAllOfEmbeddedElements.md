...
watchers_model_all_of_embedded_elements_instance = WatchersModelAllOfEmbeddedElements.from_json(json)
# print the JSON string representation of the object
print(WatchersModelAllOfEmbeddedElements.to_json())

# convert the object into a dict
watchers_model_all_of_embedded_elements_dict = watchers_model_all_of_embedded_elements_instance.to_dict()
# create an instance of WatchersModelAllOfEmbeddedElements from a dict
watchers_model_all_of_embedded_elements_from_dict = WatchersModelAllOfEmbeddedElements.from_dict(watchers_model_all_of_embedded_elements_dict)
```
