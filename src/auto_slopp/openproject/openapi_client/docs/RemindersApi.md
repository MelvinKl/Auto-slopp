# auto_slopp.openproject.openapi_client.RemindersApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.RemindersApi(api_client)
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.RemindersApi(api_client)
    id = 1 # int | Reminder ID
    update_reminder_request = auto_slopp.openproject.openapi_client.UpdateReminderRequest() # UpdateReminderRequest | 
