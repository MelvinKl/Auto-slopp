# auto_slopp.openproject.openapi_client.GridsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.GridsApi(api_client)
    grid_write_model = auto_slopp.openproject.openapi_client.GridWriteModel() # GridWriteModel |  (optional)
