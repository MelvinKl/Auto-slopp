# auto_slopp.openproject.openapi_client.NewsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.NewsApi(api_client)
    news_create_model = auto_slopp.openproject.openapi_client.NewsCreateModel() # NewsCreateModel |  (optional)
