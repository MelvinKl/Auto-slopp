# auto_slopp.openproject.openapi_client.ProgramsApi
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.ProgramsApi(api_client)
    id = 1 # int | Program id
...
with auto_slopp.openproject.openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = auto_slopp.openproject.openapi_client.ProgramsApi(api_client)
    id = 1 # int | Program id
    program_model = auto_slopp.openproject.openapi_client.ProgramModel() # ProgramModel |  (optional)
