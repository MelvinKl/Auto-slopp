...
def build_conservative_review_instructions(title: str, body: str, diff: str) -> str:
    ...
    return (
        ...
        f"comments over many. If the code is fine, output a single line starting with 'praise:' and stop "
        f"(the entire output should be just that one line, not multiple lines). "
