...
def run_slop_machine(
    ...
    """Execute the configured AI coding CLI with the specified parameters.

    This centralized utility handles AI coding CLI execution with consistent
    error handling, logging, and result formatting across all workers.

    Args:
        additional_instructions: Additional instructions to pass to the AI coding CLI
...
def run_opencode(
    ...
    """Backward compatible alias for run_slop_machine."""
