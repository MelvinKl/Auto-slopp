...
class NodeenvWorker(Worker):
    ...
    def _get_env_directory(self, repo_path: Path, task_path: Path) -> Path:
        ...
        """
        # Prefer task_path if it's a directory, otherwise use repo_path
    ...
    def _create_node_environment(self, env_dir: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            # Update result with the actual version being used
    ...
    def _install_nodejs(self, env_dir: Path, version: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Create lib directory and copy node_modules
            lib_dir = env_dir / "lib"
...
# Set new PATH with Node.js binaries first
export PATH="{bin_dir}:$PATH"

# Set NODE_PATH to point to environment modules
export NODE_PATH="{env_dir}/lib/node_modules"

# Set environment variable to indicate activation
export NODE_ENV_ACTIVE="{env_dir}"

# Store deactivate function
deactivate() {{
...
""")
        ...
        # Create Windows activation script (cmd)
...
""")
        ...
        # Create Windows activation script (PowerShell)
