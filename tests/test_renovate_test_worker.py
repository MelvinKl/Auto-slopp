...
class TestRenovateTestWorker:
    ...
    @patch.object(RenovateTestWorker, "_merge_main")
    @patch.object(RenovateTestWorker, "_checkout_branch")
    @patch.object(RenovateTestWorker, "_get_renovate_branches")
    def test_process_repository_success(self, mock_get_branches, mock_checkout, mock_merge, mock_tests, mock_fix):
    ...
    @patch.object(RenovateTestWorker, "_checkout_branch")
    @patch.object(RenovateTestWorker, "_get_renovate_branches")
    def test_process_repository_with_fix(self, mock_get_branches, mock_checkout, mock_merge, mock_tests, mock_fix):
