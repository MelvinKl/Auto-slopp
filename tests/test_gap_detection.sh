...
# Tests gap identification and reporting in numbering sequences

SCRIPT_NAME="test_gap_detection"
...
test_large_gaps() {
    ...
    # Assign first few numbers, then skip to create large gap scenario
