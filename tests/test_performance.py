...
class TestPerformanceBenchmarks:
    ...
    def test_directory_scanner_performance(self, temp_repo_dir, temp_task_dir):
        ...
        assert execution_time < 3.0, f"DirectoryScanner took {execution_time:.3f}s for complex structure, should be < 3.0s"
    ...
    def test_task_processor_performance(self, temp_repo_dir, temp_task_dir):
        ...
        assert result["total_files_processed"] >= 100, f"Expected >=100 files, processed {result['total_files_processed']}"
