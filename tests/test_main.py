...
class TestMainApplication:
    ...
    def test_setup_logging_debug_mode(self, mock_settings):
        ...
        with (
            patch("auto_slopp.main.settings", mock_settings),
            patch("auto_slopp.main.setup_telegram_logging") as mock_telegram,
        ):
    ...
    def test_main_function_with_keyboard_interrupt(self, mock_run_executor, mock_check_startup, mock_settings):
        ...
        with patch("auto_slopp.main.settings", mock_settings), patch("auto_slopp.main.parse_arguments") as mock_parse:
            mock_args = MagicMock()
            mock_args.repo_path = None
            mock_args.debug = False
            mock_parse.return_value = mock_args

            with patch("auto_slopp.main.setup_logging"), patch("auto_slopp.main.sys.exit") as mock_exit:
    ...
    def test_main_function_successful_execution(self, mock_run_executor, mock_check_startup, mock_settings):
        ...
        with patch("auto_slopp.main.settings", mock_settings), patch("auto_slopp.main.parse_arguments") as mock_parse:
            ...
            with patch("auto_slopp.main.setup_logging"), patch("auto_slopp.main.sys.exit"):
                from auto_slopp.main import main
